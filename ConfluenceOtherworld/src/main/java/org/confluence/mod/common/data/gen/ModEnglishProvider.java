...
//        add("bestiary.entity.terra_entity.bunny_xmas.desc", "Judging by the outfit, Santa appears to have recruited some bunnies to be his little helpers this year.");
        add("bestiary.entity.terra_entity.gold_bunny.desc", "Rarely, critters are found coated entirely in gold! Shopkeepers will pay handsomely for these, or you can show them off in cages!");
...
//        add("bestiary.entity.terra_entity.yellow_cockatiel.desc", "The distinct plumage of this bird's crest is a tell-tale sign of its emotional state, often raised when it is excited.");
        ...
        add("bestiary.entity.terra_entity.squirrel.desc", "Fast moving and erratic woodland creatures with grayish-brown fur. Got nuts?");
        add("bestiary.entity.terra_entity.red_squirrel.desc", "Rare, red-furred hyperactive rodents which scurry about the woods.");
        add("bestiary.entity.terra_entity.gold_squirrel.desc", "Rarely, critters are found coated entirely in gold! Shopkeepers will pay handsomely for these, or you can show them off in cages!");
...
//        add("bestiary.entity.terra_entity.gold_butterfly.desc", "Rarely, critters are found coated entirely in gold! They are worth great coin to shopkeepers and fish absolutely love golden bait!");
        add("bestiary.entity.terra_entity.worm.desc", "A slick, tubular invertebrate found hiding in rocks, dirt, and grass. Loves the rain. Fish are especially attracted to these.");
//        add("bestiary.entity.terra_entity.gold_worm.desc", "Rarely, critters are found coated entirely in gold! They are worth great coin to shopkeepers and fish absolutely love golden bait!");
...
//        add("bestiary.entity.terra_entity.stinkbug.desc", "These sneaky pests have a knack for invading even the most airtight of homes, projecting their cilantro-like stench everywhere if disturbed.");
        ...
        add("bestiary.entity.terra_entity.mallard_duck.desc", "A water fowl with beautiful plumage. Swims in the purest of water, quacking happily.");
        add("bestiary.entity.terra_entity.duck.desc", "A white feathered waterfowl that swims in pure water and basks in the warm sun.");
        ...
        add("bestiary.entity.terra_entity.enchanted_nightcrawler.desc", "Worms infused with fallen star magic glow with a glittering light. Fish are extremely attracted to these.");
        ...
        add("bestiary.entity.terra_entity.amethyst_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.entity.terra_entity.topaz_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.entity.terra_entity.sapphire_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.entity.terra_entity.emerald_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.entity.terra_entity.ruby_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.entity.terra_entity.diamond_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.entity.terra_entity.amber_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.entity.terra_entity.amethyst_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.entity.terra_entity.topaz_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.entity.terra_entity.sapphire_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.entity.terra_entity.emerald_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.entity.terra_entity.ruby_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.entity.terra_entity.diamond_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.entity.terra_entity.amber_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
