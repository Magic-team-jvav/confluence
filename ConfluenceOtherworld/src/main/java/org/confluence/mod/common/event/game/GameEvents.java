...
public final class GameEvents {
    public static void init() {
        ...
        PortEventHandler.addListener(GameEvents::villagerTrades);
    }
...
//            AchievementUtils.setData(sendTo);
    ...
    public static void villagerTrades(VillagerTradesEvent event) {
        ...
        if (type == ModVillagers.SKY_MILLER.get()) {
        ...
        } else if (type == ModVillagers.BANKER.get()) {
        ...
        } else if (type == ModVillagers.CHEF.get()) {
