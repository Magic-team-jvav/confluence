...
public final class FlailAuxiliaryProjectileRenderer<
    ...
    private static final ResourceLocation FLOWER =
            Confluence.asResource(
                    "textures/entity/projectile/flail/flower_power_petal.png");
    private static final ResourceLocation DRIPPLER =
            Confluence.asResource(
                    "textures/entity/projectile/flail/drippler_crippler.png");
    private static final ResourceLocation FLAIRON =
            Confluence.asResource(
                    "textures/entity/projectile/flail/flairon_bubble.png");

    public FlailAuxiliaryProjectileRenderer(
