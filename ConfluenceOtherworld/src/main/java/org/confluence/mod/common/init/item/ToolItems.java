...
public class ToolItems {
    ...
    public static final DeferredItem<TooltipItem> TEMPLE_KEY = ITEMS.register("temple_key", () -> new TooltipItem(new Item.Properties(), ModRarity.LIME, TooltipItem.getTooltipsFromString("temple_key", 1, ChatFormatting.WHITE)));
    public static final DeferredItem<TooltipItem> JUNGLE_KEY = ITEMS.register("jungle_key", () -> new TooltipItem(new Item.Properties(), ModRarity.YELLOW, TooltipItem.getTooltipsFromString("jungle_key", 1, ChatFormatting.WHITE)));
    public static final DeferredItem<TooltipItem> CORRUPTION_KEY = ITEMS.register("corruption_key", () -> new TooltipItem(new Item.Properties(), ModRarity.YELLOW, TooltipItem.getTooltipsFromString("corruption_key", 1, ChatFormatting.WHITE)));
    public static final DeferredItem<TooltipItem> CRIMSON_KEY = ITEMS.register("crimson_key", () -> new TooltipItem(new Item.Properties(), ModRarity.YELLOW, TooltipItem.getTooltipsFromString("crimson_key", 1, ChatFormatting.WHITE)));
    public static final DeferredItem<TooltipItem> HALLOWED_KEY = ITEMS.register("hallowed_key", () -> new TooltipItem(new Item.Properties(), ModRarity.YELLOW, TooltipItem.getTooltipsFromString("hallowed_key", 1, ChatFormatting.WHITE)));
    public static final DeferredItem<TooltipItem> FROZEN_KEY = ITEMS.register("frozen_key", () -> new TooltipItem(new Item.Properties(), ModRarity.YELLOW, TooltipItem.getTooltipsFromString("frozen_key", 1, ChatFormatting.WHITE)));
    public static final DeferredItem<TooltipItem> DESERT_KEY = ITEMS.register("desert_key", () -> new TooltipItem(new Item.Properties(), ModRarity.YELLOW, TooltipItem.getTooltipsFromString("desert_key", 1, ChatFormatting.WHITE)));
