...
public class ConsumableItems {
    ...
    public static final DeferredItem<BossSummoningItem> BLOODY_SPINE = ITEMS.register("bloody_spine", () -> new BossSummoningItem(player -> player.level().getBiome(player.blockPosition()).is(ModTags.Biomes.TR_CRIMSON), BrainOfCthulhu::new, TooltipItem.getTooltipsFromString("bloody_spine", 3, ChatFormatting.RED)));
    ...
    public static final DeferredItem<TooltipItem> GUIDE_VOODOO_DOLL = ITEMS.register("guide_voodoo_doll", () -> new TooltipItem(new Item.Properties(), ModRarity.WHITE, "tooltip.item.confluence.guide_voodoo_doll.0"));
