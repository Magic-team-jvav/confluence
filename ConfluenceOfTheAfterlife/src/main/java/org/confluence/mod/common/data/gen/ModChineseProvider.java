...
public class ModChineseProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ModEntities.STICKY_BOMB_ENTITY.get(), "粘性炸弹");
        add(ModEntities.STICKY_DIRT_BOMB.get(), "粘性泥土炸弹");
        add(ModEntities.STICKY_DYNAMITE.get(), "粘性炸药");
        add(ModEntities.STICKY_GRENADE.get(), "粘性手雷");
