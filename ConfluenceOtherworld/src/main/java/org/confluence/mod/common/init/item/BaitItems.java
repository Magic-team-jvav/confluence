...
public class BaitItems {
    ...
    public static final PortDeferredItem<BaitItem> APPRENTICE_BAIT = register("apprentice_bait", BLUE, 0.15F),
            ...
            BLACK_SCORPION = register("black_scorpion", BLUE, 0.15F, CritterEntities.SCORPION/*, entity -> entity.setVariant(0)*/),
            ...
            SCORPION = register("scorpion", WHITE, 0.1F, CritterEntities.SCORPION/*, entity -> entity.setVariant(1)*/),
