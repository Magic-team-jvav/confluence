...
public class ExtraInventoryDisabled extends ItemStackHandler implements Container {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ExtraInventoryDisabled> STREAM_CODEC = new StreamCodec<>() {
        @Override
        public ExtraInventoryDisabled decode(RegistryFriendlyByteBuf buffer) {
            ExtraInventoryDisabled extraInventory = new ExtraInventoryDisabled(false);
        ...
        @Override
        public void encode(RegistryFriendlyByteBuf buffer, ExtraInventoryDisabled extraInventory) {
    ...
    public ExtraInventoryDisabled(boolean init) {
    ...
    public void copyFrom(ExtraInventoryDisabled other) {
