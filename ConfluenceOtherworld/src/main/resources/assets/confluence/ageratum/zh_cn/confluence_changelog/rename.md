...
| `corruption_tr_amethyst_ore`     | `corruption_amethyst_ore`     |
| `fleshification_tr_amethyst_ore` | `fleshification_amethyst_ore` |
...
- `tr_emerald` → `jade`
- `emerald_whip` → `confluence:jade_whip`
...
| `cattails_head`                            | `cattail_block`                            |
| `cattails_body`                            | `cattail_block`                            |
| `jungle_cattails_head`                     | `jungle_cattail_block`                     |
| `jungle_cattails_body`                     | `jungle_cattail_block`                     |
| `glowing_mushroom_cattais_head`            | `glowing_mushroom_cattail_block`           |
| `glowing_mushroom_cattais_body`            | `glowing_mushroom_cattail_block`           |
| `hallow_cattails_head`                     | `hallow_cattail_block`                     |
| `hallow_cattails_body`                     | `hallow_cattail_block`                     |
| `ebony_cattails_head`                      | `ebony_cattail_block`                      |
| `ebony_cattails_body`                      | `ebony_cattail_block`                      |
| `crimson_cattails_head`                    | `crimson_cattail_block`                    |
| `crimson_cattails_body`                    | `crimson_cattail_block`                    |
