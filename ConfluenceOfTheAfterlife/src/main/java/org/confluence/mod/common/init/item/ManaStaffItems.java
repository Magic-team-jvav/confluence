...
import org.confluence.mod.common.item.mana.VilethronItem;
...
public class ManaStaffItems {
    ...
    public static final Supplier<ManaStaffItem> EMERALD_STAFF = ITEMS.register("emerald_staff", () -> new ManaStaffItem(ModRarity.BLUE, (player, level) -> new BaseManaStaffProjectileEntity(player, level, Variant.EMERALD), 6, 8.0F, 32, 0.04));
    public static final Supplier<ManaStaffItem> SAPPHIRE_STAFF = ITEMS.register("sapphire_staff", () -> new ManaStaffItem(ModRarity.BLUE, (player, level) -> new BaseManaStaffProjectileEntity(player, level, Variant.SAPPHIRE), 6, 7.5F, 34, 0.04));
    public static final Supplier<ManaStaffItem> AMETHYST_STAFF = ITEMS.register("amethyst_staff", () -> new ManaStaffItem(ModRarity.BLUE, (player, level) -> new BaseManaStaffProjectileEntity(player, level, Variant.AMETHYST), 5, 6.0F, 37, 0.04));
    public static final Supplier<ManaStaffItem> DIAMOND_STAFF = ITEMS.register("diamond_staff", () -> new ManaStaffItem(ModRarity.BLUE, (player, level) -> new BaseManaStaffProjectileEntity(player, level, Variant.DIAMOND), 8, 9.5F, 26, 0.04));
    public static final Supplier<VilethronItem> VILETHRON = ITEMS.register("vilethron", VilethronItem::new);
