...
public class ModEnglishProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("confluence.configuration.showWindParticles.tooltip", "Adjust the value to determine how many wind particles are visible");
        ...
        add("confluence.configuration.title", "Configuration Interface");
        add("confluence.configuration.section.confluence.client.toml.title", "Configuration Interface");
