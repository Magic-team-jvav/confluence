...
public class GungnirItem extends AbstractSpearItem {
    public GungnirItem() {
        super(new PortItem.PortProperties().attributes(attributes(6, 30F)), ModRarity.LIGHT_RED, 10, 3, createKeyframes(
    ...
    protected void onHitEntity(DamageSource damageSource, LivingEntity owner, Entity victim) {
        ...
        LibEntityUtils.knockBackA2B(owner, victim, 0.32, 0.2);
    }
}
