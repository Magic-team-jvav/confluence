...
public final class ModTiers {
    ...
    public static final Tier LEAD = new PoweredTier(43, ModTags.Blocks.NEEDS_3_LEVEL, 286, 6, 2, 14, () -> Ingredient.of(MaterialItems.LEAD_INGOT.get()));
    ...
    public static final Tier EBONY = new PoweredTier(71, ModTags.Blocks.NEEDS_6_LEVEL, 10000, 10, 4, 24, () -> Ingredient.of(MaterialItems.EBONY_INGOT.get()));
    public static final Tier TR_CRIMSON = new PoweredTier(73, ModTags.Blocks.NEEDS_6_LEVEL, 10000, 11, 4, 25, () -> Ingredient.of(MaterialItems.TR_CRIMSON_INGOT.get()));
    public static final Tier HELLSTONE = new PoweredTier(100, ModTags.Blocks.NEEDS_7_LEVEL, 10000, 14, 6, 27, () -> Ingredient.of(MaterialItems.HELLSTONE_INGOT.get()));
    public static final Tier COBALT = new PoweredTier(110, ModTags.Blocks.NEEDS_8_LEVEL, 10000, 4, 1, 5, () -> Ingredient.of(MaterialItems.COBALT_INGOT.get()));
    public static final Tier PALLADIUM = new PoweredTier(130, ModTags.Blocks.NEEDS_8_LEVEL, 10000, 4, 1, 5, () -> Ingredient.of(MaterialItems.PALLADIUM_INGOT.get()));
    public static final Tier MITHRIL = new PoweredTier(150, ModTags.Blocks.NEEDS_8_LEVEL, 10000, 4, 1, 5, () -> Ingredient.of(MaterialItems.MITHRIL_INGOT.get()));
    public static final Tier ORICHALCUM = new PoweredTier(165, ModTags.Blocks.NEEDS_8_LEVEL, 10000, 4, 1, 5, () -> Ingredient.of(MaterialItems.ORICHALCUM_INGOT.get()));
    public static final Tier ADAMANTITE = new PoweredTier(180, ModTags.Blocks.NEEDS_9_LEVEL, 10000, 4, 1, 5, () -> Ingredient.of(MaterialItems.ADAMANTITE_INGOT.get()));
    public static final Tier TITANIUM = new PoweredTier(190, ModTags.Blocks.NEEDS_9_LEVEL, 10000, 4, 1, 5, () -> Ingredient.of(MaterialItems.TITANIUM_INGOT.get()));
    // 幽灵镐 200 9
    // 叶绿镐 200 9
    ...
    public static boolean isCorrectToolForDrops(int power, ItemStack pickaxeItem, BlockState blockState) {
        ...
        if (power >= 40) return !blockState.is(ModTags.Blocks.NEEDS_3_LEVEL);
