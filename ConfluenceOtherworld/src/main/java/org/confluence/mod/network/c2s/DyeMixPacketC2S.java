...
public record DyeMixPacketC2S(ItemStack stack) implements IPortPacket.C2S {
    ...
    public static final PortStreamCodec<PortRegistryFriendlyByteBuf, DyeMixPacketC2S> STREAM_CODEC = ItemStack.OPTIONAL_STREAM_CODEC.map(DyeMixPacketC2S::new, DyeMixPacketC2S::stack);
    ...
    public void work(ServerPlayer player) {
        ...
        if (red.hasItem() && green.hasItem() && blue.hasItem()) {
            ...
            } else if (IPortItemStackExtension.isSameItemSameComponents(carried, stack) && carried.getCount() < carried.getMaxStackSize()) {
                carried.grow(1);
            }
        }
    }
