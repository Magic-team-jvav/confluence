...
public class BaitItems {
    ...
    public static final PortDeferredItem<BaitItem> APPRENTICE_BAIT = register("apprentice_bait", BLUE, 0.15F),
            ...
            BUGGY = register("buggy", GREEN, 0.4F, CritterEntities.BUGGY),
            ...
            FIREFLY = register("firefly", BLUE, 0.2F, CritterEntities.FIREFLY),
            ...
            LIGHTNING_BUG = register("lightning_bug", GREEN, 0.35F, CritterEntities.LIGHTNING_BUG),
            ...
            STINKBUG = register("stinkbug", WHITE, 0.1F, CritterEntities.STINKBUG),
            ...
            TRUFFLE_WORM = register("truffle_worm", ORANGE, 6.66F, CritterEntities.TRUFFLE_WORM),
