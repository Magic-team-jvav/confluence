...
public abstract class DynamiteEntityRenderer<E extends BaseDynamiteEntity> extends EntityRenderer<E> {
    public DynamiteEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
