...
public class StickyDirtBombEntityRenderer extends BombEntityRenderer<BaseDirtBombEntity> {
    private static final ResourceLocation TEXTURE = Confluence.asResource("textures/entity/bomb/sticky_dirt_bomb_entity.png");
    private final DirtBombEntityModel model;

    public StickyDirtBombEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
