...
public class StickyDynamiteEntityModel extends EntityModel<StickyDynamiteEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Confluence.asResource("sticky_dynamite"), "main");
    private final ModelPart root;

    public StickyDynamiteEntityModel(ModelPart root) {
        this.root = root;
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, 0.0F, -2.5F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, 0.0F, 2.0F));
