        ...
        return new BTRoot() {
            ...
            protected BTNode createTree() {
                return SelectorNode.of(
                        SequenceNode.of(new PlayerCloseCondition(Crab.this, 3.0), new PanicFleeAction(Crab.this, 0.6)),
                        SequenceNode.of(new WaitAction(30 + random.nextInt(60)), new RandomStrollAction(Crab.this, 0.3, 4)));
            }
        };
    }
