...
public class ModEnglishProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(AccessoryItems.WHITE_YOYO_STRING.get(), "White Yoyo String");
        add("prefix.confluence.legendary2", "Legendary");
        add(AccessoryItems.RED_YOYO_STRING.get(), "Red Yoyo String");
        add("tooltip.item.confluence.red_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.ORANGE_YOYO_STRING.get(), "Orange Yoyo String");
        add("tooltip.item.confluence.orange_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.YELLOW_YOYO_STRING.get(), "Yellow Yoyo String");
        add("tooltip.item.confluence.yellow_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.LIME_YOYO_STRING.get(), "Lime Yoyo String");
        add("tooltip.item.confluence.lime_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.GREEN_YOYO_STRING.get(), "Green Yoyo String");
        add("tooltip.item.confluence.green_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.TEAL_YOYO_STRING.get(), "Teal Yoyo String");
        add("tooltip.item.confluence.teal_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.CYAN_YOYO_STRING.get(), "Cyan Yoyo String");
        add("tooltip.item.confluence.cyan_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.SKY_BLUE_YOYO_STRING.get(), "Sky Blue Yoyo String");
        add("tooltip.item.confluence.sky_blue_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.BLUE_YOYO_STRING.get(), "Blue Yoyo String");
        add("tooltip.item.confluence.blue_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.PURPLE_YOYO_STRING.get(), "Purple Yoyo String");
        add("tooltip.item.confluence.purple_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.VIOLET_YOYO_STRING.get(), "Violet Yoyo String");
        add("tooltip.item.confluence.violet_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.PINK_YOYO_STRING.get(), "Pink Yoyo String");
        add("tooltip.item.confluence.pink_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.BROWN_YOYO_STRING.get(), "Brown Yoyo String");
        add("tooltip.item.confluence.brown_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.RAINBOW_YOYO_STRING.get(), "Rainbow Yoyo String");
        add("tooltip.item.confluence.rainbow_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add(AccessoryItems.BLACK_YOYO_STRING.get(), "Black Yoyo String");
        add("tooltip.item.confluence.black_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add("tooltip.item.confluence.white_string.0", "Increases yoyo range by 25% + 2 blocks and spin duration by 50%");
        add("tooltip.item.confluence.yoyo_glove.0", "Spawns a second yoyo on hit; the duplicate consumes spin duration faster");
        add("tooltip.item.confluence.black_counterweight.0", "Throws a counterweight on yoyo hits; counterweights do not stack");
        add("tooltip.item.confluence.blue_counterweight.0", "Throws a counterweight on yoyo hits; counterweights do not stack");
        add("tooltip.item.confluence.green_counterweight.0", "Throws a counterweight on yoyo hits; counterweights do not stack");
        add("tooltip.item.confluence.purple_counterweight.0", "Throws a counterweight on yoyo hits; counterweights do not stack");
        add("tooltip.item.confluence.red_counterweight.0", "Throws a counterweight on yoyo hits; counterweights do not stack");
        add("tooltip.item.confluence.yellow_counterweight.0", "Throws a counterweight on yoyo hits; counterweights do not stack");
        add("tooltip.item.confluence.strung_counterweight.0", "Combines the effects of a white yoyo string and a counterweight");
        add("tooltip.item.confluence.yoyo_bag.0", "Combines yoyo string, glove and counterweight effects");
        add("tooltip.item.confluence.magic_string.0", "Releases yoyos on letting go or expiry, retaining 75% damage and knockback");
        add("tooltip.item.confluence.magic_yoyo_bag.0", "Combines yoyo bag and magic yoyo string effects");
        add(YoyoItems.CHIK.get(), "Chik");
        add(YoyoItems.FORMAT_C.get(), "Format:C");
        add(YoyoItems.HEL_FIRE.get(), "Hel-Fire");
        add(YoyoItems.AMAROK.get(), "Amarok");
        add(YoyoItems.GRADIENT.get(), "Gradient");
        add(YoyoItems.CODE_2.get(), "Code 2");
        add(YoyoItems.YELETS.get(), "Yelets");
        add(YoyoItems.THE_EYE_OF_CTHULHU.get(), "The Eye of Cthulhu");
        add(YoyoItems.KRAKEN.get(), "Kraken");
        add(YoyoItems.TERRARIAN.get(), "Terrarian");
        add(AccessoryItems.YOYO_GLOVE.get(), "Yoyo Glove");
        add(AccessoryItems.BLACK_COUNTERWEIGHT.get(), "Black Counterweight");
        add(AccessoryItems.BLUE_COUNTERWEIGHT.get(), "Blue Counterweight");
        add(AccessoryItems.GREEN_COUNTERWEIGHT.get(), "Green Counterweight");
        add(AccessoryItems.PURPLE_COUNTERWEIGHT.get(), "Purple Counterweight");
        add(AccessoryItems.RED_COUNTERWEIGHT.get(), "Red Counterweight");
        add(AccessoryItems.YELLOW_COUNTERWEIGHT.get(), "Yellow Counterweight");
        add(AccessoryItems.STRUNG_COUNTERWEIGHT.get(), "Strung Counterweight");
        add(AccessoryItems.YOYO_BAG.get(), "Yoyo Bag");
        add(AccessoryItems.MAGIC_STRING.get(), "Magic Yoyo String");
        add(AccessoryItems.MAGIC_YOYO_BAG.get(), "Magic Yoyo Bag");
...
//        add("tooltip.item.confluence.fallen_soul_core.0", "Channel spirits through the celestial stars; right-click to switch magic types");
        ...
        add("gui.confluence.mood.value", "Happiness: %s");
        add("gui.confluence.mood.homeless", "Has no home");
        add("gui.confluence.mood.far_from_home", "Too far from home");
        add("gui.confluence.mood.evil_biome", "Cannot settle in Corruption or Crimson");
        add("gui.confluence.mood.solitude", "Enjoys the quiet");
        add("gui.confluence.mood.crowded", "Too crowded (%s extra neighbors)");
        add("gui.confluence.mood.neighbor.lover", "Loves neighbor %s");
        add("gui.confluence.mood.neighbor.like", "Likes neighbor %s");
        add("gui.confluence.mood.neighbor.dislike", "Dislikes neighbor %s");
        add("gui.confluence.mood.neighbor.hate", "Hates neighbor %s");
        add("gui.confluence.mood.biome.lover", "Loves the %s biome");
        add("gui.confluence.mood.biome.like", "Likes the %s biome");
        add("gui.confluence.mood.biome.dislike", "Dislikes the %s biome");
        add("gui.confluence.mood.biome.hate", "Hates the %s biome");
    ...
    private void addCreatureSoundTranslations() {
        ...
        add("confluence.subtitle.summon_hornet", "Hornet Minion: Appears");
        ...
        add("confluence.subtitle.antlion_swarmer_hurt", "Antlion Swarmer: Hurt");
        ...
        add("confluence.subtitle.abigail_attack", "Abigail: Attacks");
        add("confluence.subtitle.abigail_cry", "Abigail: Cries");
        add("confluence.subtitle.abigail_summon", "Abigail: Summons");
        add("confluence.subtitle.abigail_upgrade", "Abigail: Upgrades");
        add("confluence.subtitle.angry_nimbus_death", "Angry Nimbus: Death");
        add("confluence.subtitle.angry_nimbus_free", "Angry Nimbus: Calls");
        add("confluence.subtitle.angry_nimbus_hurt", "Angry Nimbus: Hurt");
        add("confluence.subtitle.bird_free", "Bird: Calls");
        add("confluence.subtitle.black_recluse_death", "Black Recluse: Death");
        add("confluence.subtitle.black_recluse_hurt", "Black Recluse: Hurt");
        add("confluence.subtitle.blizzard_inside_building_loop", "Blizzard");
        add("confluence.subtitle.blizzard_strong_loop", "Blizzard");
        add("confluence.subtitle.blood_crawler_death_0", "Blood Crawler: Death (variant)");
        add("confluence.subtitle.blood_jelly_hurt", "Blood Jellyfish: Hurt");
        add("confluence.subtitle.blood_zombie_death", "Blood Zombie: Death");
        add("confluence.subtitle.blood_zombie_free", "Blood Zombie: Calls");
        add("confluence.subtitle.blood_zombie_hurt", "Blood Zombie: Hurt");
        add("confluence.subtitle.brain_scrambler_death", "Brain Scrambler: Death");
        add("confluence.subtitle.brain_scrambler_hurt", "Brain Scrambler: Hurt");
        add("confluence.subtitle.bubble_shield_death", "Bubble Shield: Death");
        add("confluence.subtitle.bubble_shield_hurt", "Bubble Shield: Hurt");
        add("confluence.subtitle.burning_sphere_hurt", "Burning Sphere: Hurt");
        add("confluence.subtitle.butcher_death", "Butcher: Death");
        add("confluence.subtitle.butcher_hurt", "Butcher: Hurt");
        add("confluence.subtitle.camera", "Camera");
        add("confluence.subtitle.celestial_pillar_death", "Celestial Pillar: Death");
        add("confluence.subtitle.chat", "Chat");
        add("confluence.subtitle.chattering_teeth_free", "Chattering Teeth Bomb: Calls");
        add("confluence.subtitle.chester_close", "Chester: Closes");
        add("confluence.subtitle.chester_open", "Chester: Opens");
        add("confluence.subtitle.clown_free", "Clown: Calls");
        add("confluence.subtitle.cockatiel_free", "Cockatiel: Calls");
        add("confluence.subtitle.coin", "Coin");
        add("confluence.subtitle.crawdad_death", "Crawdad: Death");
        add("confluence.subtitle.crawdad_free", "Crawdad: Calls");
        add("confluence.subtitle.crawdad_hurt", "Crawdad: Hurt");
        add("confluence.subtitle.critter_free", "Critter: Calls");
        add("confluence.subtitle.dd2_ballista_tower_shot", "Ballista Tower: Shoots");
        add("confluence.subtitle.dd2_betsy_death", "Betsy: Death");
        add("confluence.subtitle.dd2_betsy_fireball_impact", "Betsy: Impact");
        add("confluence.subtitle.dd2_betsy_fireball_shot", "Betsy: Shoots");
        add("confluence.subtitle.dd2_betsy_flame_breath", "Betsy: Flame Breath");
        add("confluence.subtitle.dd2_betsy_flying_circle_attack", "Betsy: Attacks");
        add("confluence.subtitle.dd2_betsy_hurt", "Betsy: Hurt");
        add("confluence.subtitle.dd2_betsy_scream", "Betsy: Screams");
        add("confluence.subtitle.dd2_betsy_summon", "Betsy: Summons");
        add("confluence.subtitle.dd2_betsy_wind_attack", "Betsy: Attacks");
        add("confluence.subtitle.dd2_book_staff_cast", "Tome of Infinite Wisdom");
        add("confluence.subtitle.dd2_book_staff_twister_loop", "Tome of Infinite Wisdom");
        add("confluence.subtitle.dd2_crystal_cart_impact", "Eternia Crystal Cart: Impact");
        add("confluence.subtitle.dd2_dark_mage_attack", "Dark Mage: Attacks");
        add("confluence.subtitle.dd2_dark_mage_cast_heal", "Dark Mage: Cast Heal");
        add("confluence.subtitle.dd2_dark_mage_death", "Dark Mage: Death");
        add("confluence.subtitle.dd2_dark_mage_heal_impact", "Dark Mage: Impact");
        add("confluence.subtitle.dd2_dark_mage_hurt", "Dark Mage: Hurt");
        add("confluence.subtitle.dd2_dark_mage_summon_skeleton", "Dark Mage: Summons Skeleton");
        add("confluence.subtitle.dd2_defeat_scene", "Old One's Army");
        add("confluence.subtitle.dd2_defense_tower_spawn", "Old One's Army Sentry");
        add("confluence.subtitle.dd2_drakin_breath_in", "Drakin: Breathes In");
        add("confluence.subtitle.dd2_drakin_death", "Drakin: Death");
        add("confluence.subtitle.dd2_drakin_hurt", "Drakin: Hurt");
        add("confluence.subtitle.dd2_drakin_shot", "Drakin: Shoots");
        add("confluence.subtitle.dd2_etherian_portal_dryad_touch", "Mysterious Portal");
        add("confluence.subtitle.dd2_etherian_portal_idle_loop", "Mysterious Portal");
        add("confluence.subtitle.dd2_etherian_portal_open", "Mysterious Portal: Opens");
        add("confluence.subtitle.dd2_etherian_portal_spawn_enemy", "Mysterious Portal: Spawns Enemy");
        add("confluence.subtitle.dd2_explosive_trap_explode", "Explosive Trap");
        add("confluence.subtitle.dd2_flameburst_tower_shot", "Flameburst Tower: Shoots");
        add("confluence.subtitle.dd2_ghastly_glaive_impact_ghost", "Ghastly Glaive");
        add("confluence.subtitle.dd2_ghastly_glaive_pierce", "Ghastly Glaive");
        add("confluence.subtitle.dd2_goblin_bomber_death", "Etherian Goblin Bomber: Death");
        add("confluence.subtitle.dd2_goblin_bomber_hurt", "Etherian Goblin Bomber: Hurt");
        add("confluence.subtitle.dd2_goblin_bomber_scream", "Etherian Goblin Bomber: Screams");
        add("confluence.subtitle.dd2_goblin_bomber_throw", "Etherian Goblin Bomber: Throws");
        add("confluence.subtitle.dd2_goblin_death", "Etherian Goblin: Death");
        add("confluence.subtitle.dd2_goblin_hurt", "Etherian Goblin: Hurt");
        add("confluence.subtitle.dd2_goblin_scream", "Etherian Goblin: Screams");
        add("confluence.subtitle.dd2_javelin_throwers_attack", "Etherian Javelin Thrower: Attacks");
        add("confluence.subtitle.dd2_javelin_throwers_death", "Etherian Javelin Thrower: Death");
        add("confluence.subtitle.dd2_javelin_throwers_hurt", "Etherian Javelin Thrower: Hurt");
        add("confluence.subtitle.dd2_javelin_throwers_taunt", "Etherian Javelin Thrower: Taunts");
        add("confluence.subtitle.dd2_kobold_death", "Kobold: Death");
        add("confluence.subtitle.dd2_kobold_explosion", "Kobold: Explodes");
        add("confluence.subtitle.dd2_kobold_flyer_charge_scream", "Kobold Glider: Screams");
        add("confluence.subtitle.dd2_kobold_flyer_death", "Kobold Glider: Death");
        add("confluence.subtitle.dd2_kobold_flyer_hurt", "Kobold Glider: Hurt");
        add("confluence.subtitle.dd2_kobold_hurt", "Kobold: Hurt");
        add("confluence.subtitle.dd2_kobold_ignite", "Kobold: Ignites");
        add("confluence.subtitle.dd2_kobold_ignite_loop", "Kobold: Ignite Loop");
        add("confluence.subtitle.dd2_kobold_scream_charge_loop", "Kobold: Charge Loop");
        add("confluence.subtitle.dd2_lightning_aura_zap", "Lightning Aura: Zaps");
        add("confluence.subtitle.dd2_lightning_bug_death", "Etherian Lightning Bug: Death");
        add("confluence.subtitle.dd2_lightning_bug_hurt", "Etherian Lightning Bug: Hurt");
        add("confluence.subtitle.dd2_lightning_bug_zap", "Etherian Lightning Bug: Zaps");
        add("confluence.subtitle.dd2_monk_staff_ground_impact", "Sleepy Octopod");
        add("confluence.subtitle.dd2_monk_staff_ground_miss", "Sleepy Octopod");
        add("confluence.subtitle.dd2_monk_staff_swing", "Sleepy Octopod: Swings");
        add("confluence.subtitle.dd2_ogre_attack", "Ogre: Attacks");
        add("confluence.subtitle.dd2_ogre_death", "Ogre: Death");
        add("confluence.subtitle.dd2_ogre_ground_pound", "Ogre: Pounds");
        add("confluence.subtitle.dd2_ogre_hurt", "Ogre: Hurt");
        add("confluence.subtitle.dd2_ogre_roar", "Ogre: Roars");
        add("confluence.subtitle.dd2_ogre_spit", "Ogre: Spits");
        add("confluence.subtitle.dd2_phantom_phoenix_shot", "Phantom Phoenix: Shoots");
        add("confluence.subtitle.dd2_skeleton_death", "Old One's Skeleton: Death");
        add("confluence.subtitle.dd2_skeleton_hurt", "Old One's Skeleton: Hurt");
        add("confluence.subtitle.dd2_skeleton_summoned", "Old One's Skeleton: Appears");
        add("confluence.subtitle.dd2_sky_dragons_fury_circle", "Sky Dragon's Fury: Circles");
        add("confluence.subtitle.dd2_sky_dragons_fury_shot", "Sky Dragon's Fury: Shoots");
        add("confluence.subtitle.dd2_sky_dragons_fury_swing", "Sky Dragon's Fury: Swings");
        add("confluence.subtitle.dd2_sonic_boom_blade_slash", "Flying Dragon: Slashes");
        add("confluence.subtitle.dd2_win_scene", "Old One's Army");
        add("confluence.subtitle.dd2_wither_beast_aura_pulse", "Wither Beast: Aura Pulse");
        add("confluence.subtitle.dd2_wither_beast_crystal_impact", "Wither Beast: Impact");
        add("confluence.subtitle.dd2_wither_beast_death", "Wither Beast: Death");
        add("confluence.subtitle.dd2_wither_beast_hurt", "Wither Beast: Hurt");
        add("confluence.subtitle.dd2_wyvern_death", "Etherian Wyvern: Death");
        add("confluence.subtitle.dd2_wyvern_dive_down", "Etherian Wyvern: Dives Down");
        add("confluence.subtitle.dd2_wyvern_hurt", "Etherian Wyvern: Hurt");
        add("confluence.subtitle.dd2_wyvern_scream", "Etherian Wyvern: Screams");
        add("confluence.subtitle.deadly_sphere_death", "Deadly Sphere: Death");
        add("confluence.subtitle.deadly_sphere_free", "Deadly Sphere: Calls");
        add("confluence.subtitle.deadly_sphere_hurt", "Deadly Sphere: Hurt");
        add("confluence.subtitle.deerclops_death", "Deerclops: Death");
        add("confluence.subtitle.deerclops_hit", "Deerclops: Hit");
        add("confluence.subtitle.deerclops_ice_attack", "Deerclops: Attacks");
        add("confluence.subtitle.deerclops_rubble_attack", "Deerclops: Attacks");
        add("confluence.subtitle.deerclops_scream", "Deerclops: Screams");
        add("confluence.subtitle.deerclops_step", "Deerclops: Steps");
        add("confluence.subtitle.derpling_death", "Derpling: Death");
        add("confluence.subtitle.derpling_free", "Derpling: Calls");
        add("confluence.subtitle.derpling_hurt", "Derpling: Hurt");
        add("confluence.subtitle.dig", "Blocks");
        add("confluence.subtitle.dolphin_free", "Dolphin: Calls");
        add("confluence.subtitle.door_close", "Door");
        add("confluence.subtitle.door_open", "Door");
        add("confluence.subtitle.double_jump", "Double Jump");
        add("confluence.subtitle.dr_man_fly_death", "Dr. Man Fly: Death");
        add("confluence.subtitle.dr_man_fly_free", "Dr. Man Fly: Calls");
        add("confluence.subtitle.dr_man_fly_hurt", "Dr. Man Fly: Hurt");
        add("confluence.subtitle.drip", "Dripping Water");
        add("confluence.subtitle.drone", "Drone");
        add("confluence.subtitle.drown", "Drowning");
        add("confluence.subtitle.dst_female_hit", "Female Player (Constant): Hit");
        add("confluence.subtitle.dst_male_hit", "Male Player (Constant): Hit");
        add("confluence.subtitle.duck_free", "Duck: Calls");
        add("confluence.subtitle.duke_fishron_death", "Duke Fishron: Death");
        add("confluence.subtitle.duke_fishron_free", "Duke Fishron: Calls");
        add("confluence.subtitle.duke_fishron_hurt", "Duke Fishron: Hurt");
        add("confluence.subtitle.empress_of_light_death", "Empress of Light: Death");
        add("confluence.subtitle.female_hit", "Female Player");
        add("confluence.subtitle.flying_snake_death", "Flying Snake: Death");
        add("confluence.subtitle.flying_snake_free", "Flying Snake: Calls");
        add("confluence.subtitle.frankenstein_free", "Frankenstein: Calls");
        add("confluence.subtitle.frog_free", "Frog: Calls");
        add("confluence.subtitle.ghoul_death", "Ghoul: Death");
        add("confluence.subtitle.ghoul_free", "Ghoul: Calls");
        add("confluence.subtitle.ghoul_hurt", "Ghoul: Hurt");
        add("confluence.subtitle.giant_tortoise_death", "Giant Tortoise: Death");
        add("confluence.subtitle.giant_tortoise_free", "Giant Tortoise: Calls");
        add("confluence.subtitle.giant_tortoise_hurt", "Giant Tortoise: Hurt");
        add("confluence.subtitle.gigazapper_free", "Gigazapper: Calls");
        add("confluence.subtitle.glommer_bounce", "Glommer: Bounces");
        add("confluence.subtitle.goblin_warlock_death", "Goblin Warlock: Death");
        add("confluence.subtitle.goblin_warlock_free", "Goblin Warlock: Calls");
        add("confluence.subtitle.goblin_warlock_hurt", "Goblin Warlock: Hurt");
        add("confluence.subtitle.grab", "Pick Up");
        add("confluence.subtitle.grass", "Plants");
        add("confluence.subtitle.item_ammo_box", "Ammo Box: Use");
        add("confluence.subtitle.item_axe_guitar", "The Axe: Use");
        add("confluence.subtitle.item_bees_knees", "The Bee's Knees: Use");
        add("confluence.subtitle.item_bell", "Bell: Use");
        add("confluence.subtitle.item_blowgun", "Blowgun: Use");
        add("confluence.subtitle.item_boomerang_throw", "Boomerang: Throws");
        add("confluence.subtitle.item_boot_hover", "Boots Hover: Use");
        add("confluence.subtitle.item_boulder_impact", "Boulder: Impact");
        add("confluence.subtitle.item_brain_scrambler", "Brain Scrambler");
        add("confluence.subtitle.item_bubble_gun", "Bubble Gun: Use");
        add("confluence.subtitle.item_bubble_pop", "Bubble Pop: Use");
        add("confluence.subtitle.item_celebration", "Celebration: Use");
        add("confluence.subtitle.item_chainsaw", "Chainsaw: Use");
        add("confluence.subtitle.item_clinger_staff", "Clinger Staff: Use");
        add("confluence.subtitle.item_cracked_dungeon_brick", "Cracked Dungeon Brick: Use");
        add("confluence.subtitle.item_crystal_charge_impact", "Crystal Charge: Impact");
        add("confluence.subtitle.item_crystal_serpent", "Crystal Serpent: Use");
        add("confluence.subtitle.item_deadly_sphere_staff", "Deadly Sphere Staff: Use");
        add("confluence.subtitle.item_death_laser", "Death Laser: Use");
        add("confluence.subtitle.item_death_sickle", "Death Sickle: Use");
        add("confluence.subtitle.item_dreadnautilus", "Dreadnautilus: Use");
        add("confluence.subtitle.item_drill", "Drill: Use");
        add("confluence.subtitle.item_drum_closed_hihat", "Drum Closed Hi-Hat: Use");
        add("confluence.subtitle.item_drum_cymbal", "Drum Cymbal: Use");
        add("confluence.subtitle.item_drum_floor_tom", "Drum Floor Tom: Use");
        add("confluence.subtitle.item_drum_hihat", "Drum Hi-Hat: Use");
        add("confluence.subtitle.item_drum_kick", "Drum Kick: Use");
        add("confluence.subtitle.item_drum_snare", "Drum Snare: Use");
        add("confluence.subtitle.item_drum_tom_high", "Drum Tom High: Use");
        add("confluence.subtitle.item_drum_tom_low", "Drum Tom Low: Use");
        add("confluence.subtitle.item_drum_tom_mid", "Drum Tom Mid: Use");
        add("confluence.subtitle.item_electrosphere_impact", "Electrosphere: Impact");
        add("confluence.subtitle.item_empress_of_light", "Empress of Light: Use");
        add("confluence.subtitle.item_fart", "Fart: Use");
        add("confluence.subtitle.item_fireball_impact", "Fireball: Impact");
        add("confluence.subtitle.item_flame_cast", "Flame: Casts");
        add("confluence.subtitle.item_frost_impact", "Frost: Impact");
        add("confluence.subtitle.item_fuzzy_carrot", "Fuzzy Carrot: Use");
        add("confluence.subtitle.item_golf_ball_sunk", "Golf Ball Sunk: Use");
        add("confluence.subtitle.item_golf_club_swing", "Golf Club: Swings");
        add("confluence.subtitle.item_golf_whistle", "Golf Whistle: Use");
        add("confluence.subtitle.item_grenade_explode", "Grenade Explodes: Use");
        add("confluence.subtitle.item_grenade_launch", "Grenade Launched: Use");
        add("confluence.subtitle.item_guitar_am", "Guitar Am: Use");
        add("confluence.subtitle.item_guitar_bm", "Guitar Bm: Use");
        add("confluence.subtitle.item_guitar_c", "Guitar C: Use");
        add("confluence.subtitle.item_guitar_d", "Guitar D: Use");
        add("confluence.subtitle.item_guitar_em", "Guitar Em: Use");
        add("confluence.subtitle.item_guitar_g", "Guitar G: Use");
        add("confluence.subtitle.item_harp", "Harp: Use");
        add("confluence.subtitle.item_hornet_shoot", "Hornet: Shoots");
        add("confluence.subtitle.item_ice_block_place", "Ice Block Placed: Use");
        add("confluence.subtitle.item_ice_break", "Ice: Breaks");
        add("confluence.subtitle.item_ice_mist_summon", "Ice Mist: Summons");
        add("confluence.subtitle.item_inferno_bolt_impact", "Inferno Bolt: Impact");
        add("confluence.subtitle.item_inferno_fork", "Inferno Fork: Use");
        add("confluence.subtitle.item_ko_cannon", "KO Cannon: Use");
        add("confluence.subtitle.item_larva_break", "Larva");
        add("confluence.subtitle.item_laser_drill", "Laser Drill: Use");
        add("confluence.subtitle.item_laser_machinegun", "Laser Machinegun: Use");
        add("confluence.subtitle.item_laser_shoot", "Laser: Shoots");
        add("confluence.subtitle.item_life_crystal", "Life Crystal: Use");
        add("confluence.subtitle.item_lightning_orb_summon", "Lightning Orb: Summons");
        add("confluence.subtitle.item_lightning_ritual_summon", "Lightning Ritual: Summons");
        add("confluence.subtitle.item_magic_missile", "Magic Missile: Use");
        add("confluence.subtitle.item_mana_crystal", "Mana Crystal: Use");
        add("confluence.subtitle.item_meowmere_impact", "Meowmere: Impact");
        add("confluence.subtitle.item_meteor_impact", "Meteor: Impact");
        add("confluence.subtitle.item_meteor_staff", "Meteor Staff: Use");
        add("confluence.subtitle.item_minecart_bounce", "Minecart: Bounces");
        add("confluence.subtitle.item_minecart_ride", "Minecart Rides: Use");
        add("confluence.subtitle.item_minecart_slow", "Minecart Slows: Use");
        add("confluence.subtitle.item_minecart_track", "Minecart Track: Use");
        add("confluence.subtitle.item_missile_launch", "Missile Launched: Use");
        add("confluence.subtitle.item_music_box", "Music Box: Use");
        add("confluence.subtitle.item_nebula_arcanum", "Nebula Arcanum: Use");
        add("confluence.subtitle.item_nimbus_rain", "Nimbus Rain: Use");
        add("confluence.subtitle.item_pet_summon", "Pet: Summons");
        add("confluence.subtitle.item_phantasm_dragon_summon", "Phantasm Dragon: Summons");
        add("confluence.subtitle.item_phantasmal_bolt", "Phantasmal Bolt: Use");
        add("confluence.subtitle.item_phaseblade", "Phaseblade: Use");
        add("confluence.subtitle.item_pogo_stick", "Pogo Stick: Use");
        add("confluence.subtitle.item_poo", "Poo: Use");
        add("confluence.subtitle.item_portal_gun", "Portal Gun: Use");
        add("confluence.subtitle.item_potion_drink", "Potion Drink: Use");
        add("confluence.subtitle.item_projectile_reflect", "Projectile Reflect: Use");
        add("confluence.subtitle.item_pulse_bow", "Pulse Bow: Use");
        add("confluence.subtitle.item_queen_slime", "Queen Slime: Use");
        add("confluence.subtitle.item_rainbow_gun", "Rainbow Gun: Use");
        add("confluence.subtitle.item_razorblade_typhoon", "Razorblade Typhoon: Use");
        add("confluence.subtitle.item_reforge", "Reforge: Use");
        add("confluence.subtitle.item_scaly_truffle", "Scaly Truffle: Use");
        add("confluence.subtitle.item_sentry_beam", "Sentry Beam: Use");
        add("confluence.subtitle.item_sentry_summon", "Sentry: Summons");
        add("confluence.subtitle.item_shadowbeam", "Shadowbeam: Use");
        add("confluence.subtitle.item_shadowflame_bow", "Shadowflame Bow: Use");
        add("confluence.subtitle.item_shadowflame_hex", "Shadowflame Hex: Use");
        add("confluence.subtitle.item_shimmer_use_2", "Shimmer Use: Use");
        add("confluence.subtitle.item_slap_hand", "Slap Hand: Use");
        add("confluence.subtitle.item_slimy_saddle", "Slimy Saddle: Use");
        add("confluence.subtitle.item_snake_charmer_flute", "Snake Charmer's Flute: Use");
        add("confluence.subtitle.item_snow_break", "Snow: Breaks");
        add("confluence.subtitle.item_snowball_impact", "Snowball: Impact");
        add("confluence.subtitle.item_solar_eruption", "Solar Eruption: Use");
        add("confluence.subtitle.item_spider_staff", "Spider Staff: Use");
        add("confluence.subtitle.item_staff_of_earth", "Staff of Earth: Use");
        add("confluence.subtitle.item_star_wrath", "Star Wrath: Use");
        add("confluence.subtitle.item_swing", "Swing");
        add("confluence.subtitle.item_terra_blade", "Terra Blade: Use");
        add("confluence.subtitle.item_toxic_flask", "Toxic Flask: Use");
        add("confluence.subtitle.item_toxic_flask_impact", "Toxic Flask: Impact");
        add("confluence.subtitle.item_vampire_knives", "Vampire Knives: Use");
        add("confluence.subtitle.item_void_bag", "Void Bag: Use");
        add("confluence.subtitle.item_waffle_iron", "Waffle's Iron: Use");
        add("confluence.subtitle.item_water_bolt", "Water Bolt: Use");
        add("confluence.subtitle.item_whip_attack_0", "Whip: Attacks");
        add("confluence.subtitle.item_wings", "Wings: Use");
        add("confluence.subtitle.item_zapinator", "Zapinator: Use");
        add("confluence.subtitle.lavafall", "Lavafall");
        add("confluence.subtitle.lihzahrd_death", "Lihzahrd: Death");
        add("confluence.subtitle.lihzahrd_free", "Lihzahrd: Calls");
        add("confluence.subtitle.lihzahrd_hurt", "Lihzahrd: Hurt");
        add("confluence.subtitle.liquids_honey_lava", "Liquid: Honey and Lava");
        add("confluence.subtitle.liquids_honey_water", "Liquid: Honey and Water");
        add("confluence.subtitle.liquids_water_lava", "Liquid: Water and Lava");
        add("confluence.subtitle.lunatic_cultist_death", "Lunatic Cultist: Death");
        add("confluence.subtitle.lunatic_cultist_free", "Lunatic Cultist: Calls");
        add("confluence.subtitle.lunatic_cultist_hurt", "Lunatic Cultist: Hurt");
        add("confluence.subtitle.lunatic_cultist_summoned_free", "Lunatic Cultist: Calls");
        add("confluence.subtitle.macaw_free", "Macaw: Calls");
        add("confluence.subtitle.martian_drone_death", "Martian Drone: Death");
        add("confluence.subtitle.martian_drone_free", "Martian Drone: Calls");
        add("confluence.subtitle.martian_drone_hurt", "Martian Drone: Hurt");
        add("confluence.subtitle.martian_walker_free", "Martian Walker: Calls");
        add("confluence.subtitle.max_mana", "Mana");
        add("confluence.subtitle.mech", "Mechanism");
        add("confluence.subtitle.menu_close", "Menu");
        add("confluence.subtitle.menu_open", "Menu");
        add("confluence.subtitle.menu_tick", "Menu");
        add("confluence.subtitle.mister_stabby_death", "Mister Stabby: Death");
        add("confluence.subtitle.mister_stabby_hurt", "Mister Stabby: Hurt");
        add("confluence.subtitle.moon_lord_death", "Moon Lord: Death");
        add("confluence.subtitle.moon_lord_free", "Moon Lord: Calls");
        add("confluence.subtitle.moon_lord_hurt", "Moon Lord: Hurt");
        add("confluence.subtitle.moon_lord_summoned_free", "Moon Lord: Calls");
        add("confluence.subtitle.mothron_death", "Mothron: Death");
        add("confluence.subtitle.mothron_free", "Mothron: Calls");
        add("confluence.subtitle.mothron_hurt", "Mothron: Hurt");
        add("confluence.subtitle.mummy_free", "Mummy: Calls");
        add("confluence.subtitle.mushi_ladybug_death", "Mushi Ladybug: Death");
        add("confluence.subtitle.mushi_ladybug_free", "Mushi Ladybug: Calls");
        add("confluence.subtitle.mushi_ladybug_hurt", "Mushi Ladybug: Hurt");
        add("confluence.subtitle.npc_hurt_unused", "Mob: Sound");
        add("confluence.subtitle.owl_free", "Owl: Calls");
        add("confluence.subtitle.parrot_death", "Parrot: Death");
        add("confluence.subtitle.parrot_free", "Parrot: Calls");
        add("confluence.subtitle.parrot_hurt", "Parrot: Hurt");
        add("confluence.subtitle.phantasm_dragon_death", "Phantasm Dragon: Death");
        add("confluence.subtitle.phantasm_dragon_hurt", "Phantasm Dragon: Hurt");
        add("confluence.subtitle.phantasmal_deathray_free", "Phantasmal Deathray: Calls");
        add("confluence.subtitle.phantasmal_eye_free", "Phantasmal Eye: Calls");
        add("confluence.subtitle.phantasmal_sphere_free", "Phantasmal Sphere: Calls");
        add("confluence.subtitle.pigron_death", "Pigron: Death");
        add("confluence.subtitle.pigron_free", "Pigron: Calls");
        add("confluence.subtitle.pigron_hurt", "Pigron: Hurt");
        add("confluence.subtitle.player_death", "Player");
        add("confluence.subtitle.player_hit", "Male Player");
        add("confluence.subtitle.psycho_death", "Psycho: Death");
        add("confluence.subtitle.psycho_hurt", "Psycho: Hurt");
        add("confluence.subtitle.queen_bee_death", "Queen Bee: Death");
        add("confluence.subtitle.queen_bee_free", "Queen Bee: Calls");
        add("confluence.subtitle.queen_slime_death", "Queen Slime: Death");
        add("confluence.subtitle.queen_slime_free", "Queen Slime: Calls");
        add("confluence.subtitle.reaper_death", "Reaper: Death");
        add("confluence.subtitle.reaper_hurt", "Reaper: Hurt");
        add("confluence.subtitle.research", "Research: Sound");
        add("confluence.subtitle.research_complete", "Research");
        add("confluence.subtitle.roar_2", "Boss");
        add("confluence.subtitle.run", "Running");
        add("confluence.subtitle.salamander_death", "Salamander: Death");
        add("confluence.subtitle.salamander_free", "Salamander: Calls");
        add("confluence.subtitle.salamander_hurt", "Salamander: Hurt");
        add("confluence.subtitle.scutlix_death", "Scutlix: Death");
        add("confluence.subtitle.scutlix_free", "Scutlix: Calls");
        add("confluence.subtitle.scutlix_hurt", "Scutlix: Hurt");
        add("confluence.subtitle.seagull_free", "Seagull: Calls");
        add("confluence.subtitle.shadowflame_apparition_death", "Shadowflame Apparition: Death");
        add("confluence.subtitle.shadowflame_apparition_hurt", "Shadowflame Apparition: Hurt");
        add("confluence.subtitle.shatter", "Glass");
        add("confluence.subtitle.splash", "Splash");
        add("confluence.subtitle.target_dummy_hurt", "Target Dummy: Hurt");
        add("confluence.subtitle.tesla_turret_death", "Tesla Turret: Death");
        add("confluence.subtitle.tesla_turret_hurt", "Tesla Turret: Hurt");
        add("confluence.subtitle.the_possessed_death", "The Possessed: Death");
        add("confluence.subtitle.the_possessed_free", "The Possessed: Calls");
        add("confluence.subtitle.the_possessed_hurt", "The Possessed: Hurt");
        add("confluence.subtitle.thunder", "Thunderstorm");
        add("confluence.subtitle.tink", "Stone");
        add("confluence.subtitle.toucan_free", "Toucan: Calls");
        add("confluence.subtitle.true_eye_of_cthulhu_free", "True Eye of Cthulhu: Calls");
        add("confluence.subtitle.unlock", "Chest");
        add("confluence.subtitle.vampire_free", "Vampire: Calls");
        add("confluence.subtitle.vile_spit_death", "Vile Spit: Death");
        add("confluence.subtitle.vulture_death", "Vulture: Death");
        add("confluence.subtitle.vulture_hurt", "Vulture: Hurt");
        add("confluence.subtitle.waterfall", "Waterfall");
        add("confluence.subtitle.werewolf_hurt", "Werewolf: Hurt");
        add("confluence.subtitle.windy_balloon_death", "Windy Balloon: Death");
        add("confluence.subtitle.wraith_death", "Wraith: Death");
        add("confluence.subtitle.wraith_free", "Wraith: Calls");
        add("confluence.subtitle.wraith_hurt", "Wraith: Hurt");
        add("confluence.subtitle.zombie5_free", "Zombie: Calls");
        add("confluence.subtitle.zombie87_free", "Zombie: Calls");
