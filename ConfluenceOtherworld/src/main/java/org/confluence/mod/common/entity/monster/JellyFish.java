...
public class JellyFish extends BaseMonster {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return BaseMonster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, 20.0).add(Attributes.ATTACK_DAMAGE, 6.0);
    }
        ...
        return new BTRoot() {
            ...
            protected BTNode createTree() {
                return SelectorNode.of(
                        SequenceNode.of(new HasTargetCondition(JellyFish.this),
                                new MoveToTargetAction(JellyFish.this, 0.4, 2.0),
                                new WaitAction(15)),
                        SequenceNode.of(new WaitAction(20 + random.nextInt(40)),
                                new RandomStrollAction(JellyFish.this, 0.2, 5)));
            }
        };
    }
}
