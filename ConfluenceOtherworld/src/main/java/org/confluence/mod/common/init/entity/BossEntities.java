...
public class BossEntities {
    ...
    public static final RegistryObject<EntityType<BossWormPart>> WORM_SEGMENT = registerEntity("boss_worm_segment", EntityType.Builder.of(BossWormPart::new, MobCategory.MISC).sized(2.0F, 2.0F).clientTrackingRange(10).updateInterval(1).noSave());
    ...
    public static final RegistryObject<EntityType<EaterOfWorlds>> EATER_OF_WORLDS = registerEntity("eater_of_worlds", EntityType.Builder.of(EaterOfWorlds::new, MobCategory.MONSTER).sized(3.0F, 2.0F).clientTrackingRange(10));
    ...
    public static final RegistryObject<EntityType<BrainOfCthulhu>> BRAIN_OF_CTHULHU = registerEntity("brain_of_cthulhu", EntityType.Builder.of(BrainOfCthulhu::new, MobCategory.MONSTER).sized(4.0F, 4.0F).clientTrackingRange(10));
    ...
    public static final RegistryObject<EntityType<TheDestroyer>> THE_DESTROYER = registerEntity("the_destroyer", EntityType.Builder.of(TheDestroyer::new, MobCategory.MONSTER).sized(3.0F, 3.0F).clientTrackingRange(10));
