...
public final class ModDataComponentTypes {
    ...
    public static final Supplier<DataComponentType<RepeaterItemContainerContents>> REPEATER_CONTAINER = TYPES.registerComponentType("repeater_container", builder -> builder.persistent(RepeaterItemContainerContents.CODEC).networkSynchronized(RepeaterItemContainerContents.STREAM_CODEC));
}
