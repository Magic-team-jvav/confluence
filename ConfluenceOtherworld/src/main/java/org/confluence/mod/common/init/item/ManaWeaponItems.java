...
public class ManaWeaponItems {
    ...
    public static final PortDeferredItem<CloudRodItem> CRIMSON_ROD = ITEMS.register("crimson_rod", () -> new CloudRodItem(ModRarity.BLUE, player -> new CloudProjectile(ModEntities.BLOOD_CLOUD.get(), ModEntities.BLOOD_RAIN.get(), player, 3, 2), 8, 30, 12, 3, 0.04));
    ...
    public static final PortDeferredItem<CloudRodItem> NIMBUS_ROD = ITEMS.register("nimbus_rod", () -> new CloudRodItem(ModRarity.LIGHT_PURPLE, player -> new CloudProjectile(ModEntities.RAIN_CLOUD.get(), ModEntities.RAIN.get(), player, 2, 5), 15, 30, 16, 3, 0.04).setMaxCloud(2));
