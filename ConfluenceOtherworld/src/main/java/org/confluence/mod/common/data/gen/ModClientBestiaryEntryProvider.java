...
import static org.confluence.mod.client.handler.bestiary.ClientBestiaryEntry.CAVE;
...
// todo datagen       FilterEntry[] surfaceDaytime = {FilterEntry.SURFACE, FilterEntry.DAYTIME};
...
//                .add(BossEntities.CREEPER_OF_CTHULHU, builder -> builder.order(50900).rarity(2).background(THE_CRIMSON).filters(FilterEntry.THE_CRIMSON))
