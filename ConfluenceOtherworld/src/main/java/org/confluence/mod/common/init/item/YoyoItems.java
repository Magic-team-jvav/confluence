...
public class YoyoItems {
    ...
    // 取一半数值-2
    public static final PortDeferredItem<YoyoItem> AMAZON = register("amazon", ModRarity.ORANGE, 7F, 13.4375F, 0xFFC896, 8, 3.75F);
    public static final PortDeferredItem<YoyoItem> ARTERY = register("artery", ModRarity.BLUE, 6.5F, 12.9375F, 0x9696FF, 6, 4F);
    public static final PortDeferredItem<YoyoItem> CASCADE = ITEMS.register("cascade", CascadeYoyoItem::new);
    public static final PortDeferredItem<YoyoItem> CODE_1 = register("code_1", ModRarity.GREEN, 8F, 13.75F, 0x96FF96, 9, 3.25F);
    public static final PortDeferredItem<YoyoItem> HIVE_FIVE = ITEMS.register("hive_five", HiveFiveYoyoItem::new);
    public static final PortDeferredItem<YoyoItem> MALAISE = register("malaise", ModRarity.BLUE, 7F, 12.1875F, 0x9696FF, 7, 4.5F);
    public static final PortDeferredItem<YoyoItem> RALLY = register("rally", ModRarity.BLUE, 5F, 10.625F, 0x9696FF, 5, 3.5F);
    public static final PortDeferredItem<YoyoItem> VALOR = register("valor", ModRarity.ORANGE, 12F, 14.0625F, 0xFFC896, 11, 3.85F);
    public static final PortDeferredItem<YoyoItem> WOODEN_YOYO = register("wooden_yoyo", ModRarity.WHITE, 2.3F, 8.125F, 0x00FF00, 3, 2.5F);
