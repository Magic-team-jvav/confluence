...
public final class ModEntities {
    ...
    public static final Supplier<EntityType<ThrowableDropSelfProjectile>> MAGIC_DAGGER_PROJECTILE = ENTITIES.register("magic_dagger_projectile", () -> EntityType.Builder.of(ThrowableDropSelfProjectile::new, MobCategory.MISC).sized(0.5F, 0.5F).build("confluence:magic_dagger_projectile"));
