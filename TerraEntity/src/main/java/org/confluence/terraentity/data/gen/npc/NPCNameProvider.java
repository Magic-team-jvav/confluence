    ...
    protected void run(HolderLookup.Provider provider) {
        gen(TerraEntity.space("npc/names"), ImmutableMap.<EntityType<?>, NPCNames>builder()
                ...
                .put(TENpcEntities.MECHANIC.get(), NPCNames.of(ImmutableMap.<String, Float>builder()
                        ...
                        .put("Trisha", 1f)
                        .build()))
                .put(TENpcEntities.TRAVELING_MERCHANT.get(), NPCNames.of(ImmutableMap.<String, Float>builder()
                        .put("Abraham", 1f)
                        .put("Aedan", 1f)
                        .put("Aphraim", 1f)
                        .put("Bohemas", 1f)
                        ...
                        .put("Willy", 1f)
                        .build()))
                .put(TENpcEntities.WITCH_DOCTOR.get(), NPCNames.of(ImmutableMap.<String, Float>builder()
                        .put("Abibe", 1f)
                        .put("Gboto", 1f)
                        .put("Jamundi", 1f)
                        .put("Kogi-ghi", 1f)
                        ...
                        .put("Zop'a", 1f)
                        .build()))
                .put(TENpcEntities.PARTY_GIRL.get(), NPCNames.of(ImmutableMap.<String, Float>builder()
                        .put("Amanda", 1f)
                        .put("Bailey", 1f)
                        .put("Bambi", 1f)
                        .put("Bunny", 1f)
                        ...
                        .put("Trixy", 1f)
                        .build()))
                .put(TENpcEntities.CLOTHIER.get(), NPCNames.of(ImmutableMap.<String, Float>builder()
                        .put("Alfred", 1f)
                        .put("Arthur", 1f)
                        .put("Benjamin", 1f)
                        .put("Cedric", 1f)
                        ...
                        .put("Sebastian", 1f)
                        .build()))
                .put(TENpcEntities.ZOOLOGIST.get(), NPCNames.of(ImmutableMap.<String, Float>builder()
                        .put("Arien", 1f)
                        .put("Astra", 1f)
                        .put("Azaria", 1f)
                        .put("Becca", 1f)
                        ...
                        .put("Veronica", 1f)
                        .build()))
                .put(TENpcEntities.TRUFFLE.get(), NPCNames.of(ImmutableMap.<String, Float>builder()
                        .put("Agaric", 1f)
                        .put("Amanita", 1f)
                        .put("Chanterelle", 1f)
                        .put("Cremini", 1f)
