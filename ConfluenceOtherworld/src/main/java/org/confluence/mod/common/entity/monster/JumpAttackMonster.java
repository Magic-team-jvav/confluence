...
import org.confluence.mod.common.entity.ai.goal.behavior.leaf.AnimTriggerAction;
import org.confluence.mod.common.entity.ai.goal.behavior.leaf.JumpForwardAction;
import org.confluence.mod.common.entity.ai.goal.behavior.leaf.LookAtTargetAction;
import org.confluence.mod.common.entity.ai.goal.behavior.leaf.RandomLookAction;
...
public class JumpAttackMonster extends AbstractMonster {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<GeoAnimatable>(this, "Controller", 5, state -> state.setAndContinue(idle)).triggerableAnim("jump", jump)
        );
    }
}
