...
public final class SwordProjectileDefinitions {
    ...
    public static final SwordProjectileComponent STARFURY = new SwordProjectileComponent(1.5F, 1.5F, 0.9F, 100, 0.0F, 15,
            ...
            new SwordProjectileAppearance.Cross(Confluence.asResource("textures/entity/star_fury_projectile.png"), 0xFFFF9696, 2.0F, 18.0F, 10));
    ...
    public static final SwordProjectileComponent LIGHTS_BANE = new SwordProjectileComponent(1.0F, 0.8F, 0.9F, 100, 0.0F, 20,
            ...
            new SwordProjectileAppearance.Model(Confluence.asResource("enchanted_sword_projectile"), Confluence.asResource("textures/entity/lights_bane.png"),
                    1.0F, 0.125F, -0.125F, 0.0F, SwordProjectileAppearance.Lifecycle.GROW_FADE, SwordProjectileAppearance.Material.ENERGY_SWIRL));
    ...
    private static SwordProjectileAppearance.Model model(String model, String texture, float scale, float offsetY, float rollSpeed) {
        return new SwordProjectileAppearance.Model(Confluence.asResource(model), Confluence.asResource("textures/entity/" + texture), scale, offsetY, 0.0F, rollSpeed,
