...
public final class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MushroomProjectile>> MUSHROOM_PROJECTILE = ENTITIES.register("mushroom_projectile", id -> EntityType.Builder.of(MushroomProjectile::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(6).fireImmune().build(id.toString()));
