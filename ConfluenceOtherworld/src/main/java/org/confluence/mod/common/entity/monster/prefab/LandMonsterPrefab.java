...
public class LandMonsterPrefab extends AbstractPrefab {
    ...
    public static Supplier<AttributeBuilder> FACE_MONSTER_BUILDER =
            ()->new LandMonsterPrefab().getPrefab()
                    ...
                    .setAmbientSound(ModSoundEvents.FACE_HOOT)
                    .setHurtSound(ModSoundEvents.ROUTINE_HURT)
                    .setDeathSound(ModSoundEvents.TR_ZOMBIE_DEATH)
    ...
    public static Supplier<AttributeBuilder> SPORE_ZOMBIE_BUILDER =
            ()->new LandMonsterPrefab().getPrefab()
                    .setSpawnWithoutLight()
                    .setAmbientSound(ModSoundEvents.TR_ZOMBIE_FREE)
                    .setHurtSound(ModSoundEvents.ROUTINE_HURT)
                    .setDeathSound(ModSoundEvents.TR_ZOMBIE_DEATH)
                    .addTarget((t,e)-> {
                    ...
                    .setController((c,e)->{
                        ...
                        c.add(new AnimationController<GeoAnimatable>(e, "Attack", 0, state -> {
                            if (e.swinging) {
            ...
            ()->new LandMonsterPrefab().getPrefab()
                    ...
                    .setTicker(e->{
                        if(!e.level().isClientSide && e.isAlive() && e.tickCount == 60 + e.getId() % 40){
                            List<EntityType<? extends Entity>> entities = List.of(MonstersEntities.BLOOD_CRAWLER.get(), MonstersEntities.FACE_MONSTER.get(), MonstersEntities.CRIMERA.get());
    ...
    public static Supplier<AttributeBuilder> MUMMY_BUILDER =
            ()->new LandMonsterPrefab().getPrefab()
                    .setSpawnWithoutLight()
                    .setHurtSound(ModSoundEvents.ROUTINE_HURT)
                    .setDeathSound(ModSoundEvents.ROUTINE_DEATH)
                    .addTarget((t,e)-> t.addGoal(1, new NearestAttackableTargetGoal<>(e, Player.class,false, LivingEntity::canBeSeenAsEnemy)))
                    .addGoal((g,e)-> {
