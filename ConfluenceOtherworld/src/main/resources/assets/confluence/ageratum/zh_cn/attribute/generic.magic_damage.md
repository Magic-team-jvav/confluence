...
该属性会影响攻击者的魔法伤害。当攻击者造成的伤害源类型为`#neoforge:is_magic`时，最终伤害如下：
...
|          |                                                                                |
|:--------:|:------------------------------------------------------------------------------:|
|   内部键    | <confluence_hover>confluence_magic_lib:generic.magic_damage</confluence_hover> |
|   翻译键    |    <confluence_hover>attribute.name.generic.magic_damage</confluence_hover>    |
|   默认值    |                                      1.0                                       |
|   最小值    |                                      0.0                                       |
|   最大值    |                                      10.0                                      |
