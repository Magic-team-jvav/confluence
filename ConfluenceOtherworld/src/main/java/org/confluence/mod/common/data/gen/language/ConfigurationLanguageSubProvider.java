...
public class ConfigurationLanguageSubProvider implements LanguageSubProvider {
    ...
    public void english() {
        ...
        add("confluence.configuration.MonsterAttributes", "Monster Attribute Multipliers");
        add("confluence.configuration.MonsterAttributes.button", "Monster Attribute Multipliers");
        add("confluence.configuration.MonsterAttributes.tooltip", "Global multipliers for non-boss hostile mobs; defaults leave attributes unchanged.");
        add("confluence.configuration.enhanceAllMonster", "Include All Mods' Enemies");
        add("confluence.configuration.enhanceAllMonster.tooltip", "Off: only Confluence enemies. On: also vanilla and other mods' hostile mobs. Bosses, summons and friendly creatures are excluded.");
        add("confluence.configuration.monsterAttributesMultiplierHealth", "Enemy Max Health Multiplier");
        add("confluence.configuration.monsterAttributesMultiplierHealth.tooltip", "Multiplies maximum health. Reloading does not heal wounded enemies; health above a reduced maximum is clamped.");
        add("confluence.configuration.monsterAttributesMultiplierDamage", "Enemy Attack Damage Multiplier");
        add("confluence.configuration.monsterAttributesMultiplierDamage.tooltip", "Multiplies the attack damage attribute. Projectiles based on this attribute inherit the multiplier once; independently configured projectile damage is unchanged.");
        add("confluence.configuration.monsterAttributesMultiplierArmor", "Enemy Armor Multiplier");
        add("confluence.configuration.monsterAttributesMultiplierArmor.tooltip", "Multiplies armor after state and stage modifiers. Zero armor remains zero.");
        add("confluence.configuration.monsterAttributesMultiplierArmorToughness", "Enemy Armor Toughness Multiplier");
        add("confluence.configuration.monsterAttributesMultiplierArmorToughness.tooltip", "Multiplies armor toughness; zero remains zero, and missing attributes are not added.");
        add("confluence.configuration.monsterAttributesMultiplierMovementSpeed", "Enemy Movement Speed Multiplier");
        add("confluence.configuration.monsterAttributesMultiplierMovementSpeed.tooltip", "Multiplies movement speed. Does not alter fixed-velocity AI movement.");
        add("confluence.configuration.monsterAttributesMultiplierFlyingSpeed", "Enemy Flying Speed Multiplier");
        add("confluence.configuration.monsterAttributesMultiplierFlyingSpeed.tooltip", "Multiplies flying speed for mobs whose AI uses this attribute.");
        add("confluence.configuration.monsterAttributesMultiplierKnockbackResistance", "Enemy Knockback Resistance Multiplier");
        add("confluence.configuration.monsterAttributesMultiplierKnockbackResistance.tooltip", "Multiplies knockback resistance, respecting its attribute limits. Zero remains zero.");
        add("confluence.configuration.monsterAttributesMultiplierFollowRange", "Enemy Follow Range Multiplier");
        add("confluence.configuration.monsterAttributesMultiplierFollowRange.tooltip", "Multiplies follow range. Line-of-sight requirements and AI-specific distance limits still apply.");
...
// 设置
        ...
        add("confluence.configuration.MonsterAttributes", "敌怪属性倍率");
        add("confluence.configuration.MonsterAttributes.button", "敌怪属性倍率");
        add("confluence.configuration.MonsterAttributes.tooltip", "统一调整非 Boss 敌怪的属性；默认倍率为 1，不改变原有数值。");
        add("confluence.configuration.enhanceAllMonster", "同时调整所有模组的敌怪");
        add("confluence.configuration.enhanceAllMonster.tooltip", "关闭时仅影响汇流来世敌怪；开启时也影响原版及其他模组的敌怪。不影响 Boss、召唤物、NPC 和小动物。");
        add("confluence.configuration.monsterAttributesMultiplierHealth", "敌怪生命倍率");
        add("confluence.configuration.monsterAttributesMultiplierHealth.tooltip", "调整最大生命。重载不会治疗受伤敌怪；降低上限时仅截断超出的生命。");
        add("confluence.configuration.monsterAttributesMultiplierDamage", "敌怪攻击伤害倍率");
        add("confluence.configuration.monsterAttributesMultiplierDamage.tooltip", "调整攻击伤害属性。读取该属性的射弹继承一次倍率；独立配置的射弹伤害不变。");
        add("confluence.configuration.monsterAttributesMultiplierArmor", "敌怪防御倍率");
        add("confluence.configuration.monsterAttributesMultiplierArmor.tooltip", "对阶段、状态调整后的防御进行乘算；原本为 0 的防御仍为 0。");
        add("confluence.configuration.monsterAttributesMultiplierArmorToughness", "敌怪护甲韧性倍率");
        add("confluence.configuration.monsterAttributesMultiplierArmorToughness.tooltip", "调整护甲韧性；原本为 0 时仍为 0，不会为缺少该属性的敌怪添加属性。");
        add("confluence.configuration.monsterAttributesMultiplierMovementSpeed", "敌怪移动速度倍率");
        add("confluence.configuration.monsterAttributesMultiplierMovementSpeed.tooltip", "调整移动速度属性，不改变 AI 中独立指定的固定运动速度。");
        add("confluence.configuration.monsterAttributesMultiplierFlyingSpeed", "敌怪飞行速度倍率");
        add("confluence.configuration.monsterAttributesMultiplierFlyingSpeed.tooltip", "调整飞行速度属性，仅影响使用此属性的飞行 AI。");
        add("confluence.configuration.monsterAttributesMultiplierKnockbackResistance", "敌怪击退抗性倍率");
        add("confluence.configuration.monsterAttributesMultiplierKnockbackResistance.tooltip", "调整击退抗性，结果仍受属性自身上限约束；原本为 0 时仍为 0。");
        add("confluence.configuration.monsterAttributesMultiplierFollowRange", "敌怪索敌范围倍率");
        add("confluence.configuration.monsterAttributesMultiplierFollowRange.tooltip", "调整索敌范围属性；视线要求及 AI 独立设置的距离限制仍然有效。");
