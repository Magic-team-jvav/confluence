...
public class Shark extends BaseMonster {
        ...
        return new BTRoot() {
            ...
            protected BTNode createTree() {
                return SelectorNode.of(
                        SequenceNode.of(new HasTargetCondition(Shark.this),
                                new MoveToTargetAction(Shark.this, 0.9, 3.0),
                                new WaitAction(10)),
                        SequenceNode.of(new WaitAction(20 + random.nextInt(40)),
                                new RandomStrollAction(Shark.this, 0.5, 8)));
            }
        };
    }
}
