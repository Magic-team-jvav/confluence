...
public final class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CloudProjectile>> BLOOD_CLOUD_PROJECTILE = ENTITIES.register("blood_cloud_projectile", () -> EntityType.Builder.<CloudProjectile>of(CloudProjectile::new, MobCategory.MISC).sized(2, 0.8F).build("confluence:blood_cloud_projectile"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<BouncyBoulderEntity>> BOUNCY_BOULDER = ENTITIES.register("bouncy_boulder", () -> EntityType.Builder.<BouncyBoulderEntity>of(BouncyBoulderEntity::new, MobCategory.MISC).sized(1, 1).clientTrackingRange(6).build("confluence:bouncy_boulder"));
    public static final DeferredHolder<EntityType<?>, EntityType<GhoulderEntity>> GHOULDER = ENTITIES.register("ghoulder", () -> EntityType.Builder.<GhoulderEntity>of(GhoulderEntity::new, MobCategory.MISC).sized(1, 1).clientTrackingRange(6).build("confluence:ghoulder"));
    public static final DeferredHolder<EntityType<?>, EntityType<LavaBoulderEntity>> LAVA_BOULDER = ENTITIES.register("lava_boulder", () -> EntityType.Builder.<LavaBoulderEntity>of(LavaBoulderEntity::new, MobCategory.MISC).sized(1, 1).clientTrackingRange(6).build("confluence:lava_boulder"));
    public static final DeferredHolder<EntityType<?>, EntityType<PooBoulderEntity>> POO_BOULDER = ENTITIES.register("poo_boulder", () -> EntityType.Builder.<PooBoulderEntity>of(PooBoulderEntity::new, MobCategory.MISC).sized(1, 1).clientTrackingRange(6).build("confluence:poo_boulder"));
    public static final DeferredHolder<EntityType<?>, EntityType<SpiderBoulderEntity>> SPIDER_BOULDER = ENTITIES.register("spider_boulder", () -> EntityType.Builder.<SpiderBoulderEntity>of(SpiderBoulderEntity::new, MobCategory.MISC).sized(1, 1).clientTrackingRange(6).build("confluence:spider_boulder"));
    public static final DeferredHolder<EntityType<?>, EntityType<RainbowBoulderEntity>> RAINBOW_BOULDER = ENTITIES.register("rainbow_boulder", () -> EntityType.Builder.<RainbowBoulderEntity>of(RainbowBoulderEntity::new, MobCategory.MISC).sized(1, 1).clientTrackingRange(6).build("confluence:rainbow_boulder"));
    public static final DeferredHolder<EntityType<?>, EntityType<LifecrystalBoulderEntity>> LIFECRYSTAL_BOULDER = ENTITIES.register("lifecrystal_boulder", () -> EntityType.Builder.<LifecrystalBoulderEntity>of(LifecrystalBoulderEntity::new, MobCategory.MISC).sized(1, 1).clientTrackingRange(6).build("confluence:lifecrystal_boulder"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<StormSpearShotProjectile>> STORM_SPEAR_SHOT_PROJECTILE = ENTITIES.register("storm_spear_shot_projectile", () -> EntityType.Builder.of(StormSpearShotProjectile::new, MobCategory.MISC).sized(0.75F, 0.75F).clientTrackingRange(6).fireImmune().build("confluence:storm_spear_shot_projectile"));
    ...
    private static <E extends AbstractHookEntity> DeferredHolder<EntityType<?>, EntityType<E>> registerHook(String id, EntityType.EntityFactory<E> supplier) {
        return ENTITIES.register(id, () -> EntityType.Builder.of(supplier, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20).build(Confluence.asPlainId(id)));
    }
    ...
    private static <E extends BaseBombEntity> DeferredHolder<EntityType<?>, EntityType<E>> registerBomb(String id, EntityType.EntityFactory<E> supplier, float size) {
        return ENTITIES.register(id, () -> EntityType.Builder.of(supplier, MobCategory.MISC).sized(size, size).clientTrackingRange(4).updateInterval(10).fireImmune().build(Confluence.asPlainId(id)));
    }
}
