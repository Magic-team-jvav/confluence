...
/**
 * Fast Link:
 * 渲染器 {@link ModClientEvents#registerEntityRenderers}
...
public final class ModEntities {
    ...
    public static final Supplier<EntityType<BaseDynamiteEntity>> DYNAMITE = ENTITIES.register("dynamite", () -> EntityType.Builder.<BaseDynamiteEntity>of(BaseDynamiteEntity::new, MobCategory.MISC).sized(BaseGrenadeEntity.DIAMETER, BaseGrenadeEntity.DIAMETER).clientTrackingRange(4).updateInterval(10).fireImmune().build("confluence:dynamite"));
    public static final Supplier<EntityType<BouncyDynamiteEntity>> BOUNCY_DYNAMITE = ENTITIES.register("bouncy_dynamite", () -> EntityType.Builder.<BouncyDynamiteEntity>of(BouncyDynamiteEntity::new, MobCategory.MISC).sized(BaseGrenadeEntity.DIAMETER, BaseGrenadeEntity.DIAMETER).clientTrackingRange(4).updateInterval(10).fireImmune().build("confluence:bouncy_dynamite"));
    public static final Supplier<EntityType<StickyDynamiteEntity>> STICKY_DYNAMITE = ENTITIES.register("sticky_dynamite", () -> EntityType.Builder.<StickyDynamiteEntity>of(StickyDynamiteEntity::new, MobCategory.MISC).sized(BaseGrenadeEntity.DIAMETER, BaseGrenadeEntity.DIAMETER).clientTrackingRange(4).updateInterval(10).fireImmune().build("confluence:sticky_dynamite"));
