...
public class JungleSet extends EquipmentSet {
    ...
    protected void init(HookMap.Builder hook, EquippableGroup.Builder equippableGroup) {
        equippableGroup.addEquippableSet("helmet", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaEquippable.HEAD, ArmorItems.JUNGLE_HELMET)
        ...
        equippableGroup.addEquippableSet("chestplate", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaEquippable.CHEST, ArmorItems.JUNGLE_CHESTPLATE)
        ...
        equippableGroup.addEquippableSet("leggings", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaEquippable.LEGS, ArmorItems.JUNGLE_LEGGINGS)
        ...
        equippableGroup.addEquippableSet("boots", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaEquippable.FEET, ArmorItems.JUNGLE_BOOTS)
                .bindHook(ModHookTypes.ADDITIONAL_MANA.get(), (owner, player, original) -> original + 10)
        ...
        equippableGroup.addEquippableSet("full_set", new EquipmentSetBranch.Builder()
                .addEquippable(
                        VanillaEquippable.HEAD, ArmorItems.JUNGLE_HELMET,
                        VanillaEquippable.CHEST, ArmorItems.JUNGLE_CHESTPLATE,
                        VanillaEquippable.LEGS, ArmorItems.JUNGLE_LEGGINGS,
                        VanillaEquippable.FEET, ArmorItems.JUNGLE_BOOTS
                )
                .bindHook(ModHookTypes.MANA_CONSUME.get(), (owner, itemStack, original) -> () -> (int) (original.getAsInt() * 0.84F))
                .build());
    }
}
