package org.confluence.mod.common.entity.ai.keyframe.animation;

import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import net.minecraft.client.animation.AnimationChannel;
import net.minecraft.world.phys.Vec3;
import org.confluence.mod.api.entity.animation.IKeyframeAnimation;
...
public class Vec3KeyframeAnimation implements IKeyframeAnimation<Vec3> {
    ...
    private final List<Keyframe> x;
    private final List<Keyframe> y;
    private final List<Keyframe> z;

    private final KeyframeAnimation xInterpolator;
    private final KeyframeAnimation yInterpolator;
    private final KeyframeAnimation zInterpolator;

    private final Map<Double, Vec3> cache;
