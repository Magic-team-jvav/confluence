...
public class Nymph extends BaseMonster {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return BaseMonster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, 35.0).add(Attributes.ATTACK_DAMAGE, 6.0);
    }
        ...
        return new BTRoot() {
            ...
            protected BTNode createTree() {
                return SelectorNode.of(
                        SequenceNode.of(new HasTargetCondition(Nymph.this),
                                new MoveToTargetAction(Nymph.this, 0.5, 2.0),
                                new WaitAction(20)),
                        SequenceNode.of(new WaitAction(20 + random.nextInt(40)),
                                new RandomStrollAction(Nymph.this, 0.3, 6)));
            }
        };
    }
}
