...
public class FoodType {
    ...
    public static FoodProperties WellFedPropertiesDuration(int duration) {
        return new FoodProperties.Builder().nutrition(2).saturationModifier(1.5f).fast().alwaysEdible()
    ...
    public static FoodProperties PlentySatisfiedPropertiesDuration(int duration) {
        return new FoodProperties.Builder().nutrition(3).saturationModifier(2.5f).fast().alwaysEdible()
    ...
    public static FoodProperties ExquisitelyStuffedPropertiesDuration(int duration) {
        return new FoodProperties.Builder().nutrition(6).saturationModifier(4.5f).fast().alwaysEdible()
