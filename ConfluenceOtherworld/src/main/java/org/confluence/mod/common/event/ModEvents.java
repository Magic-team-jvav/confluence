...
//            CompatibilitySyncPacketS2c.sendToAll();
    ...
    private static void entityAttributeCreation(EntityAttributeCreationEvent event) {
        ...
        event.put(ModEntities.SUMMONED_IRON_GOLEM.get(), IronGolem.createAttributes().build());

        // 小动物
        event.put(CritterEntities.BUNNY.get(), CreatureAttributeBuilder.rabbit().jumpStrength(0.6).safeFallDistance(6).build());
        event.put(CritterEntities.PENGUIN.get(), CreatureAttributeBuilder.critter().maxHealth(5).movementSpeed(0.2).build());
        event.put(CritterEntities.MYSTIC_FROG.get(), Frog.createAttributes().add(net.minecraft.world.entity.ai.attributes.Attributes.MAX_HEALTH, 5).build());
        event.put(CritterEntities.GOLDFISH.get(), CreatureAttributeBuilder.critter().maxHealth(5).movementSpeed(0.2).build());
        ...
        event.put(CritterEntities.HOSTILE_BUNNY.get(), CreatureAttributeBuilder.rabbit().maxHealth(70).armor(4).jumpStrength(0.6).safeFallDistance(6).attackDamage(20).followRange(16).build());
        ...
        event.put(CritterEntities.GLOWING_MOOSHROOM.get(), Cow.createAttributes().build());
        event.put(CritterEntities.CLOUD_SHEEP.get(), Sheep.createAttributes().build());
        event.put(CritterEntities.CLUCKSHROOM.get(), Chicken.createAttributes().build());
        event.put(CritterEntities.GLOWING_CLUCKSHROOM.get(), Chicken.createAttributes().build());
        event.put(CritterEntities.FIREFLY.get(), CreatureAttributeBuilder.flyingCritter().build());
        event.put(CritterEntities.LIGHTNING_BUG.get(), CreatureAttributeBuilder.flyingCritter().build());
        event.put(CritterEntities.TRUFFLE_WORM.get(), CreatureAttributeBuilder.insect().build());
        ...
        event.put(CritterEntities.BUGGY.get(), CreatureAttributeBuilder.insect().maxHealth(5).build());
        ...
        event.put(CritterEntities.STINKBUG.get(), CreatureAttributeBuilder.flyingCritter().maxHealth(5).build());
        ...
        event.put(MonsterEntities.FUNGI_BULB.get(), CreatureAttributeBuilder.creature().maxHealth(47).armor(4).attackDamage(13).followRange(20).knockbackResistance(1).build());
        event.put(MonsterEntities.GIANT_FUNGI_BULB.get(), CreatureAttributeBuilder.creature().maxHealth(156).armor(20).attackDamage(37).followRange(40).knockbackResistance(1).build());
        event.put(MonsterEntities.CLINGER.get(), CreatureAttributeBuilder.creature().maxHealth(167).armor(30).attackDamage(37).followRange(32).knockbackResistance(0.82).build());
        ...
        event.put(MonsterEntities.ARMORED_VIKING.get(), CreatureAttributeBuilder.creature().maxHealth(146).armor(28).attackDamage(26).knockbackResistance(0.6).movementSpeed(0.23).followRange(32).build());
        event.put(MonsterEntities.ARMORED_SKELETON.get(), CreatureAttributeBuilder.creature().maxHealth(136).armor(28).attackDamage(21).knockbackResistance(0.64).movementSpeed(0.23).followRange(32).build());
        event.put(MonsterEntities.ICE_ELEMENTAL.get(), CreatureAttributeBuilder.creature().maxHealth(104).armor(20).attackDamage(29).knockbackResistance(0.46).movementSpeed(0.18).followRange(40).build());
        event.put(MonsterEntities.ICY_MERMAN.get(), CreatureAttributeBuilder.creature().maxHealth(146).armor(30).attackDamage(32).knockbackResistance(0.55).movementSpeed(0.23).followRange(32).build());
        event.put(MonsterEntities.ICE_GOLEM.get(), CreatureAttributeBuilder.creature().maxHealth(2080).armor(32).attackDamage(32).knockbackResistance(0.96).movementSpeed(0.2).followRange(48).build());
        event.put(MonsterEntities.ROCK_GOLEM.get(), CreatureAttributeBuilder.creature().maxHealth(520).armor(35).attackDamage(45).knockbackResistance(0.91).movementSpeed(0.2).followRange(32).build());
        event.put(MonsterEntities.ICE_TORTOISE.get(), CreatureAttributeBuilder.creature().maxHealth(208).armor(28).attackDamage(29).followRange(48).attackKnockback(1).knockbackResistance(0.73).movementSpeed(0.2).build());
        ...
        event.put(MonsterEntities.WORLD_FEEDER.get(), CreatureAttributeBuilder.creature().maxHealth(260).armor(36).attackDamage(37).knockbackResistance(1.0).followRange(32).build());
        ...
        event.put(MonsterEntities.DIGGER.get(), CreatureAttributeBuilder.creature().maxHealth(104).armor(10).attackDamage(24).knockbackResistance(1.0).followRange(32).build());
        ...
        event.put(MonsterEntities.WATER_BOLT_MIMIC.get(), CreatureAttributeBuilder.creature().maxHealth(32).armor(4).attackDamage(11).followRange(32).knockbackResistance(0.82).build());
        event.put(MonsterEntities.TIM.get(), CreatureAttributeBuilder.creature().maxHealth(104).armor(4).attackDamage(11).knockbackResistance(0.46).followRange(32).build());
        event.put(MonsterEntities.RUNE_WIZARD.get(), CreatureAttributeBuilder.creature().maxHealth(312).armor(30).attackDamage(104).knockbackResistance(0.73).followRange(32).build());
        event.put(MonsterEntities.DOCTOR_BONES.get(), CreatureAttributeBuilder.creature().maxHealth(260).armor(10).attackDamage(11).knockbackResistance(0.55).followRange(32).build());
        event.put(MonsterEntities.THE_GROOM.get(), CreatureAttributeBuilder.creature().maxHealth(104).armor(8).attackDamage(8).knockbackResistance(0.55).followRange(32).build());
        event.put(MonsterEntities.THE_BRIDE.get(), CreatureAttributeBuilder.creature().maxHealth(104).armor(8).attackDamage(8).knockbackResistance(0.55).followRange(32).build());
        ...
        event.put(MonsterEntities.GOBLIN_WARLOCK.get(), CreatureAttributeBuilder.creature().maxHealth(884).armor(26).attackDamage(42).movementSpeed(0.3).followRange(48).knockbackResistance(0.87).build());
        event.put(MonsterEntities.PIRATE_DECKHAND.get(), CreatureAttributeBuilder.creature().maxHealth(156).armor(17).attackDamage(19).movementSpeed(0.3).followRange(40).knockbackResistance(0.64).build());
        event.put(MonsterEntities.PIRATE_DEADEYE.get(), CreatureAttributeBuilder.creature().maxHealth(117).armor(14).attackDamage(16).movementSpeed(0.3).followRange(40).knockbackResistance(0.73).build());
        event.put(MonsterEntities.PIRATE_CROSSBOWER.get(), CreatureAttributeBuilder.creature().maxHealth(182).armor(20).attackDamage(19).movementSpeed(0.3).followRange(40).knockbackResistance(0.69).build());
        event.put(MonsterEntities.PIRATE_CORSAIR.get(), CreatureAttributeBuilder.creature().maxHealth(234).armor(22).attackDamage(26).movementSpeed(0.3).followRange(40).knockbackResistance(0.82).build());
        event.put(MonsterEntities.PIRATE_CAPTAIN.get(), CreatureAttributeBuilder.creature().maxHealth(1560).armor(30).attackDamage(37).movementSpeed(0.15).followRange(40).knockbackResistance(1).build());
        event.put(MonsterEntities.PIRATE_PARROT.get(), CreatureAttributeBuilder.creature().maxHealth(52).armor(12).attackDamage(42).movementSpeed(0.3).followRange(40).knockbackResistance(0.37).build());
        event.put(MonsterEntities.PIRATES_CURSE.get(), CreatureAttributeBuilder.creature().maxHealth(260).armor(22).attackDamage(39).movementSpeed(0.3).followRange(40).knockbackResistance(0.82).build());
        event.put(MonsterEntities.SHADOWFLAME_APPARITION.get(), CreatureAttributeBuilder.creature().maxHealth(80).armor(18).attackDamage(21).followRange(48).knockbackResistance(1).build());
        event.put(MonsterEntities.CHAOS_ELEMENTAL.get(), CreatureAttributeBuilder.creature().maxHealth(193).armor(30).attackDamage(21).followRange(48).attackKnockback(1).knockbackResistance(0.64).build());
        event.put(MonsterEntities.NECROMANCER.get(), CreatureAttributeBuilder.creature().maxHealth(156).armor(18).attackDamage(26).followRange(48).attackKnockback(1).knockbackResistance(0.51).build());
        ...
        event.put(MonsterEntities.GIANT_BAT.get(), CreatureAttributeBuilder.creature().maxHealth(52).armor(16).attackDamage(24).followRange(32).attackKnockback(0.2).knockbackResistance(0.33).build());
        ...
        event.put(MonsterEntities.LAVA_BAT.get(), CreatureAttributeBuilder.creature().maxHealth(84).armor(16).attackDamage(26).followRange(32).attackKnockback(0.2).knockbackResistance(0.46).build());
        event.put(MonsterEntities.RED_DEVIL.get(), CreatureAttributeBuilder.creature().maxHealth(312).armor(40).attackDamage(26).followRange(32).knockbackResistance(0.55).build());
        event.put(MonsterEntities.ILLUMINANT_BAT.get(), CreatureAttributeBuilder.creature().maxHealth(104).armor(30).attackDamage(39).followRange(32).attackKnockback(0.2).knockbackResistance(0.33).build());
        ...
        event.put(MonsterEntities.ZOMBIE_MERMAN.get(), CreatureAttributeBuilder.creature().maxHealth(208).armor(20).attackDamage(21).followRange(48).knockbackResistance(1).movementSpeed(0.2).build());
        ...
        event.put(MonsterEntities.MOSS_HORNET.get(), CreatureAttributeBuilder.creature().maxHealth(115).armor(22).attackDamage(37).followRange(32).attackKnockback(0).knockbackResistance(0.55).movementSpeed(0.5).build());
        event.put(MonsterEntities.JUNGLE_CREEPER.get(), CreatureAttributeBuilder.creature().maxHealth(208).armor(28).attackDamage(52).followRange(32).knockbackResistance(0.78).movementSpeed(0.28).build());
        event.put(MonsterEntities.WALL_CREEPER.get(), CreatureAttributeBuilder.creature().maxHealth(42).armor(10).attackDamage(16).followRange(32).knockbackResistance(0.78).movementSpeed(0.23).build());
        event.put(MonsterEntities.BLACK_RECLUSE.get(), CreatureAttributeBuilder.creature().maxHealth(182).armor(40).attackDamage(47).followRange(32).knockbackResistance(0.78).movementSpeed(0.28).build());
        ...
        event.put(MonsterEntities.DUNGEON_SPIRIT.get(), CreatureAttributeBuilder.creature().maxHealth(200).armor(30).attackDamage(70).movementSpeed(0.35).followRange(32).knockbackResistance(0.8).gravity(0).build());
        ...
        event.put(MonsterEntities.GRANITE_GOLEM.get(), CreatureAttributeBuilder.creature().maxHealth(58).armor(18).attackDamage(16).knockbackResistance(0.69).movementSpeed(0.2).build());
        event.put(MonsterEntities.HOPLITE.get(), CreatureAttributeBuilder.creature().maxHealth(37).armor(10).attackDamage(12).knockbackResistance(0.64).movementSpeed(0.23).followRange(32).build());
        event.put(MonsterEntities.ANGRY_DANDELION.get(), CreatureAttributeBuilder.creature().maxHealth(26).armor(0).attackDamage(8).knockbackResistance(1.0).movementSpeed(0.0).followRange(32).build());
        event.put(MonsterEntities.WINDY_BALLOON.get(), CreatureAttributeBuilder.creature().maxHealth(1).armor(0).attackDamage(0).knockbackResistance(0.7).followRange(16).build());
        event.put(MonsterEntities.OLD_SHAKING_CHEST.get(), CreatureAttributeBuilder.creature().maxHealth(250).armor(10).attackDamage(0).movementSpeed(0.2).knockbackResistance(0.3).build());
        event.put(MonsterEntities.CLUMSY_BALLOON_SLIME.get(), CreatureAttributeBuilder.creature().maxHealth(1).attackDamage(0).movementSpeed(0.0).build());
        event.put(MonsterEntities.ANGRY_TUMBLER.get(), CreatureAttributeBuilder.creature().maxHealth(26).armor(6).attackDamage(16).knockbackResistance(0.28).movementSpeed(0.25).followRange(32).build());
        event.put(MonsterEntities.SAND_SHARK.get(), CreatureAttributeBuilder.creature().maxHealth(188).armor(20).attackDamage(26).knockbackResistance(0.19).followRange(40).build());
        event.put(MonsterEntities.BONE_BITER.get(), CreatureAttributeBuilder.creature().maxHealth(198).armor(24).attackDamage(32).knockbackResistance(0.28).followRange(40).build());
        event.put(MonsterEntities.FLESH_REAVER.get(), CreatureAttributeBuilder.creature().maxHealth(208).armor(22).attackDamage(34).knockbackResistance(0.28).followRange(40).build());
        event.put(MonsterEntities.CRYSTAL_THRESHER.get(), CreatureAttributeBuilder.creature().maxHealth(234).armor(26).attackDamage(29).knockbackResistance(0.37).followRange(40).build());
        event.put(MonsterEntities.ANGRY_NIMBUS.get(), CreatureAttributeBuilder.creature().maxHealth(156).armor(24).attackDamage(26).knockbackResistance(0.73).movementSpeed(0.3).flyingSpeed(0.5).followRange(48).build());
        event.put(MonsterEntities.ANTLION_SWARMER.get(), CreatureAttributeBuilder.creature().maxHealth(32).armor(8).attackDamage(16).followRange(32).attackKnockback(1).knockbackResistance(0.55).build());
        event.put(MonsterEntities.ANTLION_CHARGER.get(), CreatureAttributeBuilder.creature().maxHealth(42).armor(10).attackDamage(13).movementSpeed(0.25).knockbackResistance(0.55).followRange(32).build());
        event.put(MonsterEntities.ANTLION.get(), CreatureAttributeBuilder.creature().maxHealth(24).armor(6).attackDamage(6).movementSpeed(0.0).knockbackResistance(1.0).followRange(24).build());
        event.put(MonsterEntities.ANTLION_LARVA.get(), CreatureAttributeBuilder.creature().maxHealth(16).armor(2).attackDamage(6).movementSpeed(0.3).knockbackResistance(0.33).followRange(24).build());
        event.put(MonsterEntities.GNOME.get(), CreatureAttributeBuilder.creature().maxHealth(13).armor(0).attackDamage(6).movementSpeed(0.3).followRange(24).knockbackResistance(0.1).build());
        event.put(MonsterEntities.DESERT_SPIRIT.get(), CreatureAttributeBuilder.creature().maxHealth(115).armor(20).attackDamage(21).knockbackResistance(1.0).followRange(32).build());
        event.put(MonsterEntities.GIANT_ANTLION_SWARMER.get(), CreatureAttributeBuilder.creature().maxHealth(47).armor(12).attackDamage(18).followRange(32).attackKnockback(1).knockbackResistance(0.73).build());
        ...
        event.put(MonsterEntities.WEREWOLF.get(), CreatureAttributeBuilder.creature().maxHealth(182).armor(38).attackDamage(37).followRange(32).attackKnockback(1).knockbackResistance(0.64).movementSpeed(0.3).build());
        event.put(MonsterEntities.CORRUPT_PENGUIN.get(), CreatureAttributeBuilder.creature().maxHealth(37).armor(4).attackDamage(11).followRange(32).attackKnockback(1).knockbackResistance(0.1).movementSpeed(0.25).build());
        event.put(MonsterEntities.VICIOUS_PENGUIN.get(), CreatureAttributeBuilder.creature().maxHealth(39).armor(5).attackDamage(11).followRange(32).attackKnockback(1).knockbackResistance(0.1).movementSpeed(0.25).build());
        event.put(MonsterEntities.MUMMY.get(), CreatureAttributeBuilder.creature().maxHealth(68).armor(16).attackDamage(26).followRange(48).attackKnockback(1).knockbackResistance(0.46).stepHeight(3.2).jumpStrength(0.5).build());
        event.put(MonsterEntities.DARK_MUMMY.get(), CreatureAttributeBuilder.creature().maxHealth(94).armor(18).attackDamage(32).followRange(48).attackKnockback(1).knockbackResistance(0.55).stepHeight(3.2).jumpStrength(0.5).build());
        event.put(MonsterEntities.BLOOD_MUMMY.get(), CreatureAttributeBuilder.creature().maxHealth(94).armor(18).attackDamage(32).followRange(48).attackKnockback(1).knockbackResistance(0.55).stepHeight(3.2).jumpStrength(0.5).build());
        event.put(MonsterEntities.LIGHT_MUMMY.get(), CreatureAttributeBuilder.creature().maxHealth(104).armor(18).attackDamage(29).followRange(48).attackKnockback(1).knockbackResistance(0.51).stepHeight(3.2).jumpStrength(0.5).build());
        event.put(MonsterEntities.DARK_LAMIA.get(), CreatureAttributeBuilder.creature().maxHealth(182).armor(28).attackDamage(28).followRange(48).attackKnockback(1).knockbackResistance(0.69).stepHeight(3.2).jumpStrength(0.5).build());
        event.put(MonsterEntities.LIGHT_LAMIA.get(), CreatureAttributeBuilder.creature().maxHealth(182).armor(28).attackDamage(28).followRange(48).attackKnockback(1).knockbackResistance(0.69).stepHeight(3.2).jumpStrength(0.5).build());
        event.put(MonsterEntities.GHOUL.get(), CreatureAttributeBuilder.creature().maxHealth(94).armor(26).attackDamage(26).followRange(64).attackKnockback(1).knockbackResistance(0.46).stepHeight(3.2).jumpStrength(0.7).build());
        event.put(MonsterEntities.BASILISK.get(), CreatureAttributeBuilder.creature().maxHealth(141).armor(34).attackDamage(34).followRange(32).movementSpeed(0.35).attackKnockback(1).knockbackResistance(0.73).build());
        event.put(MonsterEntities.TAINTED_GHOUL.get(), CreatureAttributeBuilder.creature().maxHealth(115).armor(32).attackDamage(34).followRange(64).attackKnockback(1).knockbackResistance(0.55).stepHeight(3.2).jumpStrength(0.7).build());
        event.put(MonsterEntities.VILE_GHOUL.get(), CreatureAttributeBuilder.creature().maxHealth(130).armor(30).attackDamage(32).followRange(64).attackKnockback(1).knockbackResistance(0.55).stepHeight(3.2).jumpStrength(0.7).build());
        event.put(MonsterEntities.DREAMER_GHOUL.get(), CreatureAttributeBuilder.creature().maxHealth(156).armor(32).attackDamage(29).followRange(64).attackKnockback(1).knockbackResistance(0.64).stepHeight(3.2).jumpStrength(0.7).build());
        ...
        event.put(MonsterEntities.CORRUPT_GOLDFISH.get(), CreatureAttributeBuilder.aquatic().maxHealth(52).armor(6).attackDamage(16).followRange(20).movementSpeed(1.2).attackKnockback(0.5).knockbackResistance(0.1).build());
        event.put(MonsterEntities.VICIOUS_GOLDFISH.get(), CreatureAttributeBuilder.aquatic().maxHealth(58).armor(7).attackDamage(17).followRange(20).movementSpeed(1.2).attackKnockback(0.5).knockbackResistance(0.1).build());
        event.put(MonsterEntities.ANGLER_FISH.get(), CreatureAttributeBuilder.aquatic().maxHealth(47).armor(22).attackDamage(42).followRange(24).movementSpeed(1.5).attackKnockback(0.5).knockbackResistance(0.1).build());
        ...
        event.put(MonsterEntities.BLOOD_JELLY.get(), CreatureAttributeBuilder.aquatic().maxHealth(78).armor(20).attackDamage(39).followRange(20).movementSpeed(1.2).attackKnockback(0.5).knockbackResistance(0.1).build());
        event.put(MonsterEntities.FUNGO_FISH.get(), CreatureAttributeBuilder.aquatic().maxHealth(73).armor(20).attackDamage(47).followRange(20).movementSpeed(1.2).attackKnockback(0.5).knockbackResistance(0.1).build());
        ...
        event.put(NpcEntities.STEAMPUNKER.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.CYBORG.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.GOLFER.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.NERDY_SLIME.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.COOL_SLIME.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.ELDER_SLIME.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.CLUMSY_SLIME.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.DIVA_SLIME.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.SURLY_SLIME.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.MYSTIC_SLIME.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.SQUIRE_SLIME.get(), CreatureAttributeBuilder.npc().build());
        event.put(NpcEntities.SKELETON_MERCHANT.get(), CreatureAttributeBuilder.npc().build());
