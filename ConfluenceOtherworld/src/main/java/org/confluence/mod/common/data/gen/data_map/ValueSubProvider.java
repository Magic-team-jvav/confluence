...
public final class ValueSubProvider {
    public static void gather(ModDataMapProvider.Appender<Builder> appender) {
        ...
        appender.create()
                ...
                .add(Items.DIAMOND_HELMET, wrap(30, 0) * 5)
                .add(Items.NETHERITE_HELMET, wrap(40, 0) * 5)
                .add(Items.IRON_CHESTPLATE, 150 * 8)
                .add(Items.GOLDEN_CHESTPLATE, 1200 * 8)
                .add(Items.DIAMOND_CHESTPLATE, wrap(30, 0) * 8)
                .add(Items.NETHERITE_CHESTPLATE, wrap(40, 0) * 8)
                .add(Items.IRON_LEGGINGS, 150 * 7)
                .add(Items.GOLDEN_LEGGINGS, 1200 * 7)
                .add(Items.DIAMOND_LEGGINGS, wrap(30, 0) * 7)
                .add(Items.NETHERITE_LEGGINGS, wrap(40, 0) * 7)
                .add(Items.IRON_BOOTS, 150 * 4)
                .add(Items.GOLDEN_BOOTS, 1200 * 4)
                .add(Items.DIAMOND_BOOTS, wrap(30, 0) * 4)
                .add(Items.NETHERITE_BOOTS, wrap(40, 0) * 4);
        appender.create()
        ...
        appender.create()
                ...
                .add(Items.IRON_SWORD, wrap(1, 80))
                .add(SwordItems.IRON_SHORT_SWORD, wrap(1, 40))
        ...
        appender.create()
                ...
                .add(Items.IRON_PICKAXE, wrap(2 ,0))
        ...
        appender.create()
                ...
                .add(HammerItems.IRON_HAMMER, wrap(1, 60))
        ...
        appender.create()
                ...
                .add(Items.IRON_SHOVEL, wrap(1, 20))
        ...
        appender.create()
                ...
                .add(TCItems.EXTENDO_GRIP, 20000)
                ...
                .add(TCItems.LIFE_FORM_ANALYZER, 10000)
                ...
                .add(TCItems.PORTABLE_CEMENT_MIXER, 20000)
                ...
                .add(TCItems.ROCKET_BOOTS, 10000)
        ...
        appender.create()
                ...
                .add(Items.IRON_HELMET, wrap(3, 0))
                .add(Items.IRON_CHESTPLATE, wrap(5, 0))
                .add(Items.IRON_LEGGINGS, wrap(4, 0))
                .add(Items.IRON_BOOTS, wrap(4, 0))
