...
public class HeavyWorkBenchProvider extends AbstractRecipeProvider {
    ...
    public HeavyWorkBenchProvider(PackOutput output) {
        super(output);
    }
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> writer) {
        ...
        // 基础钩爪
        baseHook(writer, Ingredient.of(MaterialItems.HOOK), Ingredient.of(Items.CHAIN), HookItems.GRAPPLING_HOOK.toStack());
        baseHook(writer, Ingredient.of(DecorativeBlocks.RUBY_BLOCK), Ingredient.of(DecorativeBlocks.RUBY_CHAIN), HookItems.RUBY_HOOK.toStack());
        baseHook(writer, Ingredient.of(DecorativeBlocks.AMBER_BLOCK), Ingredient.of(DecorativeBlocks.AMBER_CHAIN), HookItems.AMBER_HOOK.toStack());
        baseHook(writer, Ingredient.of(DecorativeBlocks.TOPAZ_BLOCK), Ingredient.of(DecorativeBlocks.TOPAZ_CHAIN), HookItems.TOPAZ_HOOK.toStack());
        baseHook(writer, Ingredient.of(DecorativeBlocks.JADE_BLOCK), Ingredient.of(DecorativeBlocks.JADE_CHAIN), HookItems.JADE_HOOK.toStack());
        baseHook(writer, Ingredient.of(Tags.Items.STORAGE_BLOCKS_DIAMOND), Ingredient.of(DecorativeBlocks.DIAMOND_CHAIN), HookItems.DIAMOND_HOOK.toStack());
        baseHook(writer, Ingredient.of(DecorativeBlocks.SAPPHIRE_BLOCK), Ingredient.of(DecorativeBlocks.SAPPHIRE_CHAIN), HookItems.SAPPHIRE_HOOK.toStack());
        baseHook(writer, Ingredient.of(DecorativeBlocks.AMETHYST_BLOCK), Ingredient.of(DecorativeBlocks.AMETHYST_CHAIN), HookItems.AMETHYST_HOOK.toStack());

        // 基础鞭子
        baseWhip(writer, AmountIngredient.of(4, Items.BAMBOO), Ingredient.of(Items.BAMBOO_FENCE), WhipItems.SLUB_WHIP.toStack());
        baseWhip(writer, AmountIngredient.of(4, Tags.Items.INGOTS_GOLD), Ingredient.of(DecorativeBlocks.RUBY_CHAIN), WhipItems.RUBY_WHIP.toStack());
        baseWhip(writer, AmountIngredient.of(4, MaterialItems.STURDY_FOSSIL), Ingredient.of(DecorativeBlocks.AMBER_CHAIN), WhipItems.AMBER_WHIP.toStack());
        baseWhip(writer, AmountIngredient.of(4, ModTags.Items.INGOTS_TIN), Ingredient.of(DecorativeBlocks.TOPAZ_CHAIN), WhipItems.TOPAZ_WHIP.toStack());
        baseWhip(writer, AmountIngredient.of(4, ModTags.Items.INGOTS_TUNGSTEN), Ingredient.of(DecorativeBlocks.JADE_CHAIN), WhipItems.JADE_WHIP.toStack());
        baseWhip(writer, AmountIngredient.of(4, ModTags.Items.INGOTS_PLATINUM), Ingredient.of(DecorativeBlocks.DIAMOND_CHAIN), WhipItems.DIAMOND_WHIP.toStack());
        baseWhip(writer, AmountIngredient.of(4, ModTags.Items.INGOTS_SILVER), Ingredient.of(DecorativeBlocks.SAPPHIRE_CHAIN), WhipItems.SAPPHIRE_WHIP.toStack());
        baseWhip(writer, AmountIngredient.of(4, Tags.Items.INGOTS_COPPER), Ingredient.of(DecorativeBlocks.AMETHYST_CHAIN), WhipItems.AMETHYST_WHIP.toStack());
        baseWhip(writer, AmountIngredient.of(4, MaterialItems.SPORE_ROOT), Ingredient.of(ModTags.Items.RAW_MATERIALS_GELSTONE), WhipItems.SWAMP_WHIP.toStack());

        // 基础法杖
        baseStaff(writer, AmountIngredient.of(5, Tags.Items.GEMS_DIAMOND), AmountIngredient.of(2, ModTags.Items.INGOTS_PLATINUM), ManaWeaponItems.DIAMOND_STAFF.toStack());
        baseStaff(writer, AmountIngredient.of(5, ModTags.Items.GEMS_RUBY), AmountIngredient.of(2, Tags.Items.INGOTS_GOLD), ManaWeaponItems.RUBY_STAFF.toStack());
        baseStaff(writer, AmountIngredient.of(5, ModTags.Items.GEMS_AMBER), AmountIngredient.of(2, MaterialItems.STURDY_FOSSIL), ManaWeaponItems.AMBER_STAFF.toStack());
        baseStaff(writer, AmountIngredient.of(5, ModTags.Items.GEMS_TOPAZ), AmountIngredient.of(2, ModTags.Items.INGOTS_TIN), ManaWeaponItems.TOPAZ_STAFF.toStack());
        baseStaff(writer, AmountIngredient.of(5, ModTags.Items.GEMS_JADE), AmountIngredient.of(2, ModTags.Items.INGOTS_TUNGSTEN), ManaWeaponItems.JADE_STAFF.toStack());
        baseStaff(writer, AmountIngredient.of(5, ModTags.Items.GEMS_SAPPHIRE), AmountIngredient.of(2, ModTags.Items.INGOTS_SILVER), ManaWeaponItems.SAPPHIRE_STAFF.toStack());
        baseStaff(writer, AmountIngredient.of(5, ModTags.Items.GEMS_AMETHYST), AmountIngredient.of(2, Tags.Items.INGOTS_COPPER), ManaWeaponItems.AMETHYST_STAFF.toStack());

        // 基础光剑
        basePhaseblade(writer, AmountIngredient.of(5, Tags.Items.GEMS_DIAMOND), AmountIngredient.of(5, MaterialItems.METEORITE_INGOT), SwordItems.WHITE_PHASEBLADE.toStack());
        basePhaseblade(writer, AmountIngredient.of(5, ModTags.Items.GEMS_RUBY), AmountIngredient.of(5, MaterialItems.METEORITE_INGOT), SwordItems.RED_PHASEBLADE.toStack());
        basePhaseblade(writer, AmountIngredient.of(5, ModTags.Items.GEMS_AMBER), AmountIngredient.of(5, MaterialItems.METEORITE_INGOT), SwordItems.ORANGE_PHASEBLADE.toStack());
        basePhaseblade(writer, AmountIngredient.of(5, ModTags.Items.GEMS_TOPAZ), AmountIngredient.of(5, MaterialItems.METEORITE_INGOT), SwordItems.YELLOW_PHASEBLADE.toStack());
        basePhaseblade(writer, AmountIngredient.of(5, ModTags.Items.GEMS_JADE), AmountIngredient.of(5, MaterialItems.METEORITE_INGOT), SwordItems.GREEN_PHASEBLADE.toStack());
        basePhaseblade(writer, AmountIngredient.of(5, ModTags.Items.GEMS_SAPPHIRE), AmountIngredient.of(5, MaterialItems.METEORITE_INGOT), SwordItems.BLUE_PHASEBLADE.toStack());
        basePhaseblade(writer, AmountIngredient.of(5, ModTags.Items.GEMS_AMETHYST), AmountIngredient.of(5, MaterialItems.METEORITE_INGOT), SwordItems.PURPLE_PHASEBLADE.toStack());
        ...
        shaped(writer, PortShapedRecipePattern.of(Map.of(
                ...
                'c', Ingredient.of(PortTags.Items.STONES)
        ), List.of(
                "bbb",
                "cac",
                "ccc"
        ...
        shapeless(writer, GunItems.HIGH_VELOCITY_BULLET.toStack(50), AmountIngredient.of(50, MaterialItems.EMPTY_BULLET), Ingredient.of(MaterialItems.COG));
        shapeless(writer, GunItems.PARTY_BULLET.toStack(50), AmountIngredient.of(50, MaterialItems.EMPTY_BULLET), Ingredient.of(MaterialItems.CONFETTI));
        shapeless(writer, GunItems.GOLDEN_BULLET.toStack(50), AmountIngredient.of(50, MaterialItems.EMPTY_BULLET), Ingredient.of(MaterialItems.GOLD_DUST));
        shapeless(writer, GunItems.NANO_BULLET.toStack(50), AmountIngredient.of(50, MaterialItems.EMPTY_BULLET), Ingredient.of(MaterialItems.NANITES));
        shapeless(writer, GunItems.EXPLODING_BULLET.toStack(50), AmountIngredient.of(50, MaterialItems.EMPTY_BULLET), Ingredient.of(MaterialItems.EXPLOSIVE_POWDER));
        shapeless(writer, GunItems.VENOM_BULLET.toStack(50), AmountIngredient.of(50, MaterialItems.EMPTY_BULLET), Ingredient.of(MaterialItems.VIAL_OF_VENOM));

        shapeless(writer, FunctionalBlocks.EXPLODE_BOULDER.toStack(), Ingredient.of(FunctionalBlocks.NORMAL_BOULDER), Ingredient.of(FunctionalBlocks.INSTANTANEOUS_EXPLOSION_TNT));
        shapeless(writer, FunctionalBlocks.FOLLOWER_BOULDER.toStack(), Ingredient.of(FunctionalBlocks.NORMAL_BOULDER), Ingredient.of(Items.OBSERVER));
        shapeless(writer, FunctionalBlocks.EVER_POWERED_RAIL.toStack(16), AmountIngredient.of(16, Items.POWERED_RAIL), Ingredient.of(Items.REDSTONE_TORCH));
        ...
        shapeless(writer, NatureBlocks.LIFE_CRYSTAL_BLOCK.toStack(), Ingredient.of(ConsumableItems.LIFE_CRYSTAL));

        shapeless(writer, ModItems.SCRYING_ORB.toStack(), Ingredient.of(TCItems.MAGIC_MIRROR, ToolItems.ICE_MIRROR), AmountIngredient.of(2, MaterialItems.LENS), AmountIngredient.of(4, PotionItems.WORMHOLE_POTION));


        shapeless(writer, FunctionalBlocks.BOUNCY_BOULDER.toStack(), Ingredient.of(FunctionalBlocks.NORMAL_BOULDER), AmountIngredient.of(5, MaterialItems.PINK_GEL));
        shapeless(writer, FunctionalBlocks.LAVA_BOULDER.toStack(), Ingredient.of(FunctionalBlocks.NORMAL_BOULDER), Ingredient.of(ConsumableItems.LAVA_BOMB));
        shapeless(writer, FunctionalBlocks.SPIDER_BOULDER.toStack(), Ingredient.of(FunctionalBlocks.NORMAL_BOULDER), AmountIngredient.of(200, Items.COBWEB));


        shapeless(writer, ConsumableItems.ABEEMINATION.toStack(), AmountIngredient.of(5, NatureBlocks.JUNGLE_HIVE_BLOCK), AmountIngredient.of(5, Items.HONEY_BLOCK), Ingredient.of(Items.HONEY_BOTTLE), Ingredient.of(MaterialItems.STINGER));
    }

    private void buildBaseStatues(Consumer<FinishedRecipe> writer) {
        PortShapedRecipePattern baseStatuePattern = PortShapedRecipePattern.of(Map.of(
        ...
        List<PortDeferredBlock<StatueBlock>> status = List.of(
    ...
    protected void shaped(Consumer<FinishedRecipe> writer, String suffix, PortShapedRecipePattern pattern, ItemStack result) {
        shaped(writer, suffix, pattern, result, EnvironmentLevelAccess.Matcher.EMPTY);
    }

    protected void shaped(Consumer<FinishedRecipe> writer, PortShapedRecipePattern pattern, ItemStack result) {
        shaped(writer, "", pattern, result, EnvironmentLevelAccess.Matcher.EMPTY);
    }

    protected void shaped(Consumer<FinishedRecipe> writer, String suffix, PortShapedRecipePattern pattern, ItemStack result, EnvironmentLevelAccess.Matcher environment) {
        ResourceLocation id = Confluence.asResource("heavy_work_bench/" + getItemName(result.getItem()) + suffix);
        writer.accept(new SimpleFinishedRecipe<>(id, new HeavyWorkBenchRecipe(result, pattern, environment)));
    }

    protected void shaped(Consumer<FinishedRecipe> writer, PortShapedRecipePattern pattern, ItemStack result, EnvironmentLevelAccess.Matcher environment) {
        shaped(writer, "", pattern, result, environment);
    }

    protected void shapeless(Consumer<FinishedRecipe> writer, ItemStack result, Ingredient... ingredients) {
        shapeless(writer, result, EnvironmentLevelAccess.Matcher.EMPTY, ingredients);
    }

    protected void shapeless(Consumer<FinishedRecipe> writer, ItemStack result, EnvironmentLevelAccess.Matcher environment, Ingredient... ingredients) {
        ...
        writer.accept(new SimpleFinishedRecipe<>(id, new HeavyWorkBenchRecipe(result, ingredientz, environment)));
    }

    protected void baseHook(Consumer<FinishedRecipe> writer, Ingredient hook, Ingredient chain, ItemStack result) {
        shaped(writer, PortShapedRecipePattern.of(Map.of(
                '#', hook,
                'a', chain
        ), baseHookPattern), result);
    }

    protected void baseWhip(Consumer<FinishedRecipe> writer, Ingredient handle, Ingredient strip, ItemStack result) {
        shaped(writer, PortShapedRecipePattern.of(Map.of(
                '#', handle,
                'a', strip
        ), baseWhipPattern), result);
    }

    protected void baseStaff(Consumer<FinishedRecipe> writer, Ingredient gem, Ingredient handle, ItemStack result) {
        shaped(writer, PortShapedRecipePattern.of(Map.of(
                '#', gem,
                'a', handle
        ), baseStaffPattern), result);
    }

    protected void basePhaseblade(Consumer<FinishedRecipe> writer, Ingredient gem, Ingredient handle, ItemStack result) {
        shaped(writer, PortShapedRecipePattern.of(Map.of(
                '#', gem,
                'a', handle
        ), basePhasebladePattern), result);
    }
}
