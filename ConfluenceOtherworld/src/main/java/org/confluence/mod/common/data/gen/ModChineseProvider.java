...
//        add("bestiary.entity.terra_entity.bunny_xmas.desc", "从装扮来看，圣诞老人今年似乎找了些兔子来当他的小帮手。");
        add("bestiary.entity.terra_entity.gold_bunny.desc", "罕见情况下，有些小动物会全身覆金！店主们愿意出高价收购，你也可以把它们关在笼子里炫耀！");
...
//        add("bestiary.entity.terra_entity.gold_goldfish.desc", "罕见情况下，有些小动物会全身覆金！店主们愿意出高价收购，你也可以把它们关在笼子里炫耀！");
        add("bestiary.entity.terra_entity.squirrel.desc", "松鼠是动作敏捷、行踪不定的林地动物，皮毛呈灰褐色。你有坚果吗？（它可等着呢）");
        add("bestiary.entity.terra_entity.red_squirrel.desc", "红松鼠是罕见的红毛啮齿动物，性子活泼好动，总在树林里窜来窜去。");
        add("bestiary.entity.terra_entity.gold_squirrel.desc", "罕见情况下，有些小动物会全身覆金！店主们愿意出高价收购，你也可以把它们关在笼子里炫耀！");
...
//        add("bestiary.entity.terra_entity.gold_frog.desc", "罕见情况下，有些小动物会全身覆金！店主们愿意出高价收购，你也可以把它们关在笼子里炫耀！");
        ...
        add("bestiary.entity.terra_entity.worm.desc", "蠕虫是光滑的管状无脊椎动物，常藏在岩石、泥土和草丛中，喜欢雨天。鱼儿尤其容易被它们吸引。");
        add("bestiary.entity.terra_entity.gold_worm.desc", "罕见情况下，有些小动物会全身覆金！店主们会出高价收购，而且鱼儿超爱金色的鱼饵！");
...
//        add("bestiary.entity.terra_entity.mallard_duck.desc", "野鸭是拥有漂亮羽毛的水禽，喜欢在最纯净的水中游动，还会欢快地嘎嘎叫。");
        add("bestiary.entity.terra_entity.duck.desc", "鸭子是白色羽毛的水禽，喜欢在纯净的水中游动，沐浴温暖的阳光。");
...
//        add("bestiary.entity.terra_entity.firefly.desc", "萤火虫夜晚会出现在安静的地方，用闪烁的绿光点亮夜空。鱼儿会被它们吸引。");
        add("bestiary.entity.terra_entity.enchanted_nightcrawler.desc", "附魔夜行者是注入了坠落之星魔法的蠕虫，散发着耀眼的光芒，对鱼儿有着极强的吸引力。");
...
//        add("bestiary.entity.terra_entity.rat.desc", "大鼠是长毛啮齿动物，会在腐烂的地方嗅来嗅去寻找食物。人们都躲着它们，生怕感染它们可能携带的疾病。");
        ...
        add("bestiary.entity.terra_entity.amethyst_squirrel.desc", "紫晶松鼠因迷途过深，被宝石中残留的诅咒能量所迷惑，身体变得闪闪发光。");
        add("bestiary.entity.terra_entity.topaz_squirrel.desc", "黄玉松鼠因迷途过深，被宝石中残留的诅咒能量所迷惑，身体变得闪闪发光。");
        add("bestiary.entity.terra_entity.sapphire_squirrel.desc", "蓝玉松鼠因迷途过深，被宝石中残留的诅咒能量所迷惑，身体变得闪闪发光。");
        add("bestiary.entity.terra_entity.emerald_squirrel.desc", "翡翠松鼠因迷途过深，被宝石中残留的诅咒能量所迷惑，身体变得闪闪发光。");
        add("bestiary.entity.terra_entity.ruby_squirrel.desc", "红玉松鼠因迷途过深，被宝石中残留的诅咒能量所迷惑，身体变得闪闪发光。");
        add("bestiary.entity.terra_entity.diamond_squirrel.desc", "钻石松鼠因迷途过深，被宝石中残留的诅咒能量所迷惑，身体变得闪闪发光。");
        add("bestiary.entity.terra_entity.amber_squirrel.desc", "琥珀松鼠因迷途过深，被宝石中残留的诅咒能量所迷惑，身体变得闪闪发光。");
        add("bestiary.entity.terra_entity.amethyst_bunny.desc", "紫晶兔兔躲得极深，接触到魔法宝石后，身体呈现出令人喜爱的闪亮模样。");
        add("bestiary.entity.terra_entity.topaz_bunny.desc", "黄玉兔兔躲得极深，接触到魔法宝石后，身体呈现出令人喜爱的闪亮模样。");
        add("bestiary.entity.terra_entity.sapphire_bunny.desc", "蓝玉兔兔躲得极深，接触到魔法宝石后，身体呈现出令人喜爱的闪亮模样。");
        add("bestiary.entity.terra_entity.emerald_bunny.desc", "翡翠兔兔躲得极深，接触到魔法宝石后，身体呈现出令人喜爱的闪亮模样。");
        add("bestiary.entity.terra_entity.ruby_bunny.desc", "红玉兔兔躲得极深，接触到魔法宝石后，身体呈现出令人喜爱的闪亮模样。");
        add("bestiary.entity.terra_entity.diamond_bunny.desc", "钻石兔兔躲得极深，接触到魔法宝石后，身体呈现出令人喜爱的闪亮模样。");
        add("bestiary.entity.terra_entity.amber_bunny.desc", "琥珀兔兔躲得极深，接触到魔法宝石后，身体呈现出令人喜爱的闪亮模样。");
