...
public class Bird extends BaseCritter implements VariantHolder<Bird.Variant> {
    private static final EntityDataAccessor<Integer> DATA_VARIANT = SynchedEntityData.defineId(Bird.class, EntityDataSerializers.INT);
    ...
    public enum Variant implements StringRepresentable {
        ...
        public ResourceLocation modelPath() { return Confluence.asResource("animal/bird"); }
        public ResourceLocation texturePath() { return Confluence.asResource("textures/entity/bird/" + getSerializedName() + ".png"); }
    }
}
