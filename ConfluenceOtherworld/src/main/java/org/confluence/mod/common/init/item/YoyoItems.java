...
public class YoyoItems {
    ...
    public static final PortDeferredItem<YoyoItem> CASCADE = ITEMS.register("cascade", () -> new CascadeYoyoItem(ModRarity.ORANGE, 11.5F, 14.6875F, 13 * 20, 4.3F, 2, 3, 1, 4));
    ...
    public static final PortDeferredItem<YoyoItem> CHIK = ITEMS.register("chik", () -> new ChikYoyoItem(ModRarity.LIGHT_RED, 19F, 17.1875F, 16 * 20, 3.3F, 3, 5, 2));
    ...
    public static final PortDeferredItem<YoyoItem> THE_EYE_OF_CTHULHU = ITEMS.register("the_eye_of_cthulhu", () -> new EyeOfCthulhuYoyoItem(ModRarity.YELLOW, 55F, 22.5F, 0, 3.5F, 7, 2));
    public static final PortDeferredItem<YoyoItem> KRAKEN = ITEMS.register("kraken", () -> new KrakenYoyoItem(ModRarity.YELLOW, 47, 23.75F, 0, 4.3F, 4, 3, 1.85, 0.75F, 0.1F));
    public static final PortDeferredItem<YoyoItem> TERRARIAN = ITEMS.register("terrarian", () -> new TerrarianYoyoItem(ModRarity.RED, 95F, 25, 0, 6.5F, 2, 4, 0.1F));
