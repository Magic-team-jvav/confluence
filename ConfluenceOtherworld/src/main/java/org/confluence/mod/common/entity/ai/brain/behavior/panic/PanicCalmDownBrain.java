package org.confluence.mod.common.entity.ai.brain.behavior.panic;
...
import org.confluence.mod.common.init.entity.ModAi;

/// 恐慌行为清除
public class PanicCalmDownBrain<T extends Mob> extends Behavior<T> {
    private final float chanceToCalmDown;
...
//            brain.updateActivityFromSchedule(level.getDayTime(), gameTimeIn);
            brain.setActiveActivityIfPossible(ModAi.Activities.RANGE_ATTACK.get());
