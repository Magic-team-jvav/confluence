...
public class ModFluidTagsProvider extends FluidTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(ModTags.Fluids.FISHING_ABLE_ALL).addTags(FluidTags.WATER, FluidTags.LAVA, PortTags.Fluids.HONEY);
        tag(ModTags.Fluids.FISHING_ABLE_NOT_LAVA).addTags(FluidTags.WATER, PortTags.Fluids.HONEY);
