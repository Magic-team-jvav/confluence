...
public class SlimeSpikeProjectileRenderer extends EntityRenderer<SlimeSpikeEntity> {
    ...
    public SlimeSpikeProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SlimeSpikeProjectileModel(context.bakeLayer(SlimeSpikeProjectileModel.LAYER_LOCATION));
    }
    ...
    @Override
    public void render(SlimeSpikeEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
