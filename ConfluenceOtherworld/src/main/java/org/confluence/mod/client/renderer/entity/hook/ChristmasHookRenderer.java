...
public class ChristmasHookRenderer extends AbstractHookRenderer<AbstractHookEntity.Impl> {
    ...
    public ChristmasHookRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
