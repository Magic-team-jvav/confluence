...
public final class BossEntities {
    ...
    public static final RegistryObject<EntityType<BossWormPart>> EATER_OF_WORLDS_SEGMENT = registerEntity("boss_worm_segment", EntityType.Builder.of(BossWormPart::new, MobCategory.MONSTER).sized(2.0F, 2.0F).clientTrackingRange(32).updateInterval(1).noSave());
    ...
    public static final RegistryObject<EntityType<SkeletronHand>> SKELETRON_HAND = registerEntity("skeletron_hand", EntityType.Builder.of(SkeletronHand::new, MobCategory.MONSTER).sized(2.0F, 2.0F).clientTrackingRange(10).updateInterval(1).noSave());
    ...
    public static final RegistryObject<EntityType<BossWormPart>> THE_DESTROYER_PART = registerEntity("the_destroyer_part", EntityType.Builder.of(BossWormPart::new, MobCategory.MONSTER).sized(3.0F, 3.0F).clientTrackingRange(32).updateInterval(1).noSave());
    ...
    public static final RegistryObject<EntityType<SkeletronPrimeArm>> SKELETRON_PRIME_PART = registerEntity("skeletron_prime_arm", EntityType.Builder.of(SkeletronPrimeArm::new, MobCategory.MONSTER).sized(2.6F, 2.6F).clientTrackingRange(10).updateInterval(1).noSave());
    ...
    public static final RegistryObject<EntityType<PlanteraHook>> PLANTERA_HOOK = registerEntity("plantera_hook", EntityType.Builder.of(PlanteraHook::new, MobCategory.MONSTER).sized(1.25F, 1.25F).clientTrackingRange(10).updateInterval(1).noSave());
    public static final RegistryObject<EntityType<PlanteraTentacle>> PLANTERA_TENTACLE = registerEntity("plantera_tentacle", EntityType.Builder.of(PlanteraTentacle::new, MobCategory.MONSTER).sized(2.0F, 2.0F).clientTrackingRange(10).updateInterval(1).noSave());
