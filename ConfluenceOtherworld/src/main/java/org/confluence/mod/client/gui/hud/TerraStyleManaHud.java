    ...
    public enum Mana implements TranslatableEnum {
        LEGACY {
            ...
            public void render(GuiGraphics guiGraphics, Minecraft minecraft) {
                int widthMana = (int) (guiGraphics.guiWidth() * (1 + ClientConfigs.manaPositionX * 0.01f)) - 21;
                int heightMana = 4 + (int) (guiGraphics.guiHeight() * ClientConfigs.manaPositionY * 0.01f);
        ...
        OVERLAY {
            ...
            public void render(GuiGraphics guiGraphics, Minecraft minecraft) {
                ...
                int widthMana = (int) (guiGraphics.guiWidth() * (0.5f + ClientConfigs.manaPositionX * 0.01f)) + 10;
                int heightMana = (int) (guiGraphics.guiHeight() * (1 + ClientConfigs.manaPositionY * 0.01f)) - minecraft.gui.rightHeight;
