...
public class TerraprismaModel extends EntityModel<Entity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(TerraEntity.space("terraprisma"), "main");
    ...
    @Override
    public void setupAnim(Entity swordProjectile, float v, float v1, float v2, float v3, float v4) {
