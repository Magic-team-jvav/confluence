...
public final class SpawnEggItems {
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> DUNGEON_SPIRIT_SPAWN_EGG = egg(MonsterEntities.DUNGEON_SPIRIT);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> WORLD_FEEDER_SPAWN_EGG = egg(MonsterEntities.WORLD_FEEDER);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> ANTLION_CHARGER_SPAWN_EGG = egg(MonsterEntities.ANTLION_CHARGER);
    public static final PortDeferredItem<ForgeSpawnEggItem> ANTLION_LARVA_SPAWN_EGG = egg(MonsterEntities.ANTLION_LARVA);
    public static final PortDeferredItem<ForgeSpawnEggItem> GNOME_SPAWN_EGG = egg(MonsterEntities.GNOME);
    public static final PortDeferredItem<ForgeSpawnEggItem> ANTLION_SPAWN_EGG = egg(MonsterEntities.ANTLION);
    public static final PortDeferredItem<ForgeSpawnEggItem> DESERT_SPIRIT_SPAWN_EGG = egg(MonsterEntities.DESERT_SPIRIT);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> BASILISK_SPAWN_EGG = egg(MonsterEntities.BASILISK);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> MOSS_HORNET_SPAWN_EGG = egg(MonsterEntities.MOSS_HORNET);
    public static final PortDeferredItem<ForgeSpawnEggItem> JUNGLE_CREEPER_SPAWN_EGG = egg(MonsterEntities.JUNGLE_CREEPER);
    public static final PortDeferredItem<ForgeSpawnEggItem> WALL_CREEPER_SPAWN_EGG = egg(MonsterEntities.WALL_CREEPER);
    public static final PortDeferredItem<ForgeSpawnEggItem> BLACK_RECLUSE_SPAWN_EGG = egg(MonsterEntities.BLACK_RECLUSE);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> FUNGI_BULB_SPAWN_EGG = egg(MonsterEntities.FUNGI_BULB);
    public static final PortDeferredItem<ForgeSpawnEggItem> GIANT_FUNGI_BULB_SPAWN_EGG = egg(MonsterEntities.GIANT_FUNGI_BULB);
    public static final PortDeferredItem<ForgeSpawnEggItem> CLINGER_SPAWN_EGG = egg(MonsterEntities.CLINGER);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> ICE_TORTOISE_SPAWN_EGG = egg(MonsterEntities.ICE_TORTOISE);
    public static final PortDeferredItem<ForgeSpawnEggItem> FIREFLY_SPAWN_EGG = egg(CritterEntities.FIREFLY);
    public static final PortDeferredItem<ForgeSpawnEggItem> LIGHTNING_BUG_SPAWN_EGG = egg(CritterEntities.LIGHTNING_BUG);
    public static final PortDeferredItem<ForgeSpawnEggItem> TRUFFLE_WORM_SPAWN_EGG = egg(CritterEntities.TRUFFLE_WORM);
    public static final PortDeferredItem<ForgeSpawnEggItem> ARMORED_VIKING_SPAWN_EGG = egg(MonsterEntities.ARMORED_VIKING);
    public static final PortDeferredItem<ForgeSpawnEggItem> ARMORED_SKELETON_SPAWN_EGG = egg(MonsterEntities.ARMORED_SKELETON);
    public static final PortDeferredItem<ForgeSpawnEggItem> ICE_ELEMENTAL_SPAWN_EGG = egg(MonsterEntities.ICE_ELEMENTAL);
    public static final PortDeferredItem<ForgeSpawnEggItem> ICY_MERMAN_SPAWN_EGG = egg(MonsterEntities.ICY_MERMAN);
    public static final PortDeferredItem<ForgeSpawnEggItem> ICE_GOLEM_SPAWN_EGG = egg(MonsterEntities.ICE_GOLEM);
    public static final PortDeferredItem<ForgeSpawnEggItem> ROCK_GOLEM_SPAWN_EGG = egg(MonsterEntities.ROCK_GOLEM);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> WEREWOLF_SPAWN_EGG = egg(MonsterEntities.WEREWOLF);
    public static final PortDeferredItem<ForgeSpawnEggItem> CORRUPT_PENGUIN_SPAWN_EGG = egg(MonsterEntities.CORRUPT_PENGUIN);
    public static final PortDeferredItem<ForgeSpawnEggItem> VICIOUS_PENGUIN_SPAWN_EGG = egg(MonsterEntities.VICIOUS_PENGUIN);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> GLOWING_MOOSHROOM_SPAWN_EGG = egg(CritterEntities.GLOWING_MOOSHROOM);
    public static final PortDeferredItem<ForgeSpawnEggItem> CLOUD_SHEEP_SPAWN_EGG = egg(CritterEntities.CLOUD_SHEEP);
    public static final PortDeferredItem<ForgeSpawnEggItem> CLUCKSHROOM_SPAWN_EGG = egg(CritterEntities.CLUCKSHROOM);
    public static final PortDeferredItem<ForgeSpawnEggItem> GLOWING_CLUCKSHROOM_SPAWN_EGG = egg(CritterEntities.GLOWING_CLUCKSHROOM);
    public static final PortDeferredItem<ForgeSpawnEggItem> BUNNY_SPAWN_EGG = egg(CritterEntities.BUNNY);
    public static final PortDeferredItem<ForgeSpawnEggItem> PENGUIN_SPAWN_EGG = egg(CritterEntities.PENGUIN);
    public static final PortDeferredItem<ForgeSpawnEggItem> MYSTIC_FROG_SPAWN_EGG = egg(CritterEntities.MYSTIC_FROG);
    public static final PortDeferredItem<ForgeSpawnEggItem> GOLDFISH_SPAWN_EGG = egg(CritterEntities.GOLDFISH);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> DIGGER_SPAWN_EGG = egg(MonsterEntities.DIGGER);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> GRANITE_GOLEM_SPAWN_EGG = egg(MonsterEntities.GRANITE_GOLEM);
    public static final PortDeferredItem<ForgeSpawnEggItem> HOPLITE_SPAWN_EGG = egg(MonsterEntities.HOPLITE);
    public static final PortDeferredItem<ForgeSpawnEggItem> ANGRY_DANDELION_SPAWN_EGG = egg(MonsterEntities.ANGRY_DANDELION);
    public static final PortDeferredItem<ForgeSpawnEggItem> ANGRY_TUMBLER_SPAWN_EGG = egg(MonsterEntities.ANGRY_TUMBLER);
    public static final PortDeferredItem<ForgeSpawnEggItem> SAND_SHARK_SPAWN_EGG = egg(MonsterEntities.SAND_SHARK);
    public static final PortDeferredItem<ForgeSpawnEggItem> BONE_BITER_SPAWN_EGG = egg(MonsterEntities.BONE_BITER);
    public static final PortDeferredItem<ForgeSpawnEggItem> FLESH_REAVER_SPAWN_EGG = egg(MonsterEntities.FLESH_REAVER);
    public static final PortDeferredItem<ForgeSpawnEggItem> CRYSTAL_THRESHER_SPAWN_EGG = egg(MonsterEntities.CRYSTAL_THRESHER);
    public static final PortDeferredItem<ForgeSpawnEggItem> ANGRY_NIMBUS_SPAWN_EGG = egg(MonsterEntities.ANGRY_NIMBUS);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> WATER_BOLT_MIMIC_SPAWN_EGG = egg(MonsterEntities.WATER_BOLT_MIMIC);
    public static final PortDeferredItem<ForgeSpawnEggItem> TIM_SPAWN_EGG = egg(MonsterEntities.TIM);
    public static final PortDeferredItem<ForgeSpawnEggItem> RUNE_WIZARD_SPAWN_EGG = egg(MonsterEntities.RUNE_WIZARD);
    public static final PortDeferredItem<ForgeSpawnEggItem> DOCTOR_BONES_SPAWN_EGG = egg(MonsterEntities.DOCTOR_BONES);
    public static final PortDeferredItem<ForgeSpawnEggItem> THE_GROOM_SPAWN_EGG = egg(MonsterEntities.THE_GROOM);
    public static final PortDeferredItem<ForgeSpawnEggItem> THE_BRIDE_SPAWN_EGG = egg(MonsterEntities.THE_BRIDE);
    public static final PortDeferredItem<ForgeSpawnEggItem> ZOMBIE_MERMAN_SPAWN_EGG = egg(MonsterEntities.ZOMBIE_MERMAN);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> LAVA_BAT_SPAWN_EGG = egg(MonsterEntities.LAVA_BAT);
    public static final PortDeferredItem<ForgeSpawnEggItem> RED_DEVIL_SPAWN_EGG = egg(MonsterEntities.RED_DEVIL);
    public static final PortDeferredItem<ForgeSpawnEggItem> ILLUMINANT_BAT_SPAWN_EGG = egg(MonsterEntities.ILLUMINANT_BAT);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> GOBLIN_WARLOCK_SPAWN_EGG = egg(MonsterEntities.GOBLIN_WARLOCK);
    public static final PortDeferredItem<ForgeSpawnEggItem> PIRATE_DECKHAND_SPAWN_EGG = egg(MonsterEntities.PIRATE_DECKHAND);
    public static final PortDeferredItem<ForgeSpawnEggItem> PIRATE_DEADEYE_SPAWN_EGG = egg(MonsterEntities.PIRATE_DEADEYE);
    public static final PortDeferredItem<ForgeSpawnEggItem> PIRATE_CROSSBOWER_SPAWN_EGG = egg(MonsterEntities.PIRATE_CROSSBOWER);
    public static final PortDeferredItem<ForgeSpawnEggItem> PIRATE_CORSAIR_SPAWN_EGG = egg(MonsterEntities.PIRATE_CORSAIR);
    public static final PortDeferredItem<ForgeSpawnEggItem> PIRATE_CAPTAIN_SPAWN_EGG = egg(MonsterEntities.PIRATE_CAPTAIN);
    public static final PortDeferredItem<ForgeSpawnEggItem> PIRATE_PARROT_SPAWN_EGG = egg(MonsterEntities.PIRATE_PARROT);
    public static final PortDeferredItem<ForgeSpawnEggItem> PIRATES_CURSE_SPAWN_EGG = egg(MonsterEntities.PIRATES_CURSE);
    public static final PortDeferredItem<ForgeSpawnEggItem> SHADOWFLAME_APPARITION_SPAWN_EGG = egg(MonsterEntities.SHADOWFLAME_APPARITION);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> CORRUPT_GOLDFISH_SPAWN_EGG = egg(MonsterEntities.CORRUPT_GOLDFISH);
    public static final PortDeferredItem<ForgeSpawnEggItem> VICIOUS_GOLDFISH_SPAWN_EGG = egg(MonsterEntities.VICIOUS_GOLDFISH);
    public static final PortDeferredItem<ForgeSpawnEggItem> ANGLER_FISH_SPAWN_EGG = egg(MonsterEntities.ANGLER_FISH);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> BLOOD_JELLY_SPAWN_EGG = egg(MonsterEntities.BLOOD_JELLY);
    public static final PortDeferredItem<ForgeSpawnEggItem> FUNGO_FISH_SPAWN_EGG = egg(MonsterEntities.FUNGO_FISH);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> STINKBUG_SPAWN_EGG = egg(CritterEntities.STINKBUG);
    public static final PortDeferredItem<ForgeSpawnEggItem> BUGGY_SPAWN_EGG = egg(CritterEntities.BUGGY);
    ...
    public static final PortDeferredItem<ForgeSpawnEggItem> STEAMPUNKER_SPAWN_EGG = egg(NpcEntities.STEAMPUNKER);
    public static final PortDeferredItem<ForgeSpawnEggItem> CYBORG_SPAWN_EGG = egg(NpcEntities.CYBORG);
    public static final PortDeferredItem<ForgeSpawnEggItem> GOLFER_SPAWN_EGG = egg(NpcEntities.GOLFER);
    public static final PortDeferredItem<ForgeSpawnEggItem> NERDY_SLIME_SPAWN_EGG = egg(NpcEntities.NERDY_SLIME);
    public static final PortDeferredItem<ForgeSpawnEggItem> COOL_SLIME_SPAWN_EGG = egg(NpcEntities.COOL_SLIME);
    public static final PortDeferredItem<ForgeSpawnEggItem> ELDER_SLIME_SPAWN_EGG = egg(NpcEntities.ELDER_SLIME);
    public static final PortDeferredItem<ForgeSpawnEggItem> CLUMSY_SLIME_SPAWN_EGG = egg(NpcEntities.CLUMSY_SLIME);
    public static final PortDeferredItem<ForgeSpawnEggItem> DIVA_SLIME_SPAWN_EGG = egg(NpcEntities.DIVA_SLIME);
    public static final PortDeferredItem<ForgeSpawnEggItem> SURLY_SLIME_SPAWN_EGG = egg(NpcEntities.SURLY_SLIME);
    public static final PortDeferredItem<ForgeSpawnEggItem> MYSTIC_SLIME_SPAWN_EGG = egg(NpcEntities.MYSTIC_SLIME);
    public static final PortDeferredItem<ForgeSpawnEggItem> SQUIRE_SLIME_SPAWN_EGG = egg(NpcEntities.SQUIRE_SLIME);
    public static final PortDeferredItem<ForgeSpawnEggItem> SKELETON_MERCHANT_SPAWN_EGG = egg(NpcEntities.SKELETON_MERCHANT);
