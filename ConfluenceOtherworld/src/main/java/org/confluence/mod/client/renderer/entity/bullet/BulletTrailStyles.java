...
final class BulletTrailStyles {
    ...
    private static final BulletTrailStyle ENERGY = style(
            "trace_05", "flare_01", 0.15F, 0.012F, 0.12F, 0.96F, 20, true);
    private static final BulletTrailStyle BEAM = style(
            "trace_07", "flare_01", 0.18F, 0.018F, 0.14F, 1.0F, 20, true);
    private static final BulletTrailStyle SPARK = style(
            "trace_05", "circle_05", 0.14F, 0.008F, 0.13F, 0.95F, 18, true);
    ...
    private static BulletTrailStyle style(
            String trail,
            String head,
            float headWidth,
            float tailWidth,
        ...
        return new BulletTrailStyle(
                Confluence.asResource("textures/vfx/trails/" + trail + ".png"),
                Confluence.asResource("textures/vfx/heads/" + head + ".png"),
                headWidth,
                tailWidth,
                headSize,
                opacity,
