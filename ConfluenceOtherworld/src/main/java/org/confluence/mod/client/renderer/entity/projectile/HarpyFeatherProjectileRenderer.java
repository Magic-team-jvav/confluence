...
public final class HarpyFeatherProjectileRenderer
    ...
    private static final ResourceLocation TEXTURE = Confluence.asResource(
            "textures/entity/model/harpy_feather_projectile.png");
    ...
    public HarpyFeatherProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new HarpyFeatherProjectileModel(
                context.bakeLayer(HarpyFeatherProjectileModel.LAYER_LOCATION));
    }
    ...
    public void render(
        ...
        if (velocity.lengthSqr() > 1.0E-7) {
            ...
            float pitch = (float) Math.atan2(
                    velocity.y,
                    Math.sqrt(velocity.x * velocity.x
