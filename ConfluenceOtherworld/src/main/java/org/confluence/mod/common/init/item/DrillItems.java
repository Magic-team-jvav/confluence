...
public class DrillItems {
    ...
    public static final DeferredItem<DrillItem> ORICHALCUM_DRILL = ITEMS.registerItem("orichlcum_drill", properties -> new DrillItem(ModTiers.ORICHALCUM, 17, 2.5F, unbreakable(), attributes(-1, 0.05), ModRarity.LIGHT_RED));
