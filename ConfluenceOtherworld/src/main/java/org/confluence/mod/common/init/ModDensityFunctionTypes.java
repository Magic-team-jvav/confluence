...
public final class ModDensityFunctionTypes {
    ...
    public static final RegistryObject,MapCodec<AboveYAddConstantDensityFunction>>ABOVE_Y_ADD_CONSTANT =TYPES.register("above_y_add_constant",()->AboveYAddConstantDensityFunction.DATA_CODEC);
}
