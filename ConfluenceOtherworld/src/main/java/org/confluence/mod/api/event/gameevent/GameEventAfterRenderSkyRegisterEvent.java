...
public class GameEventAfterRenderSkyRegisterEvent extends Event implements IModBusEvent {
    private final Map<ResourceKey<? extends GameEvent>, ClientGameEventSystem.AfterRenderSky> map;

    public GameEventAfterRenderSkyRegisterEvent(Map<ResourceKey<? extends GameEvent>, ClientGameEventSystem.AfterRenderSky> map) {
        this.map = map;
    }

    public <E extends GameEvent> void register(ResourceKey<E> key, ClientGameEventSystem.AfterRenderSky afterRenderSky) {
