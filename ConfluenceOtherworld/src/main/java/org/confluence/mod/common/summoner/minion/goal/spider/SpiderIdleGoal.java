...
public class SpiderIdleGoal extends AttachmentEntityGoal<SpiderMinion> {

    public SpiderIdleGoal(SpiderMinion minion) {
        super(minion);
    }
    ...
    public void tick() {
        ...
        double lateral = (minion.getOrder() - (minion.getSameSize() - 1) * 0.5) * 1.2;
