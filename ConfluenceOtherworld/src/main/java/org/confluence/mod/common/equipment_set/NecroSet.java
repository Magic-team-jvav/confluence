...
public class NecroSet extends EquipmentSet {
    ...
    protected void init(HookMap.Builder hook, EquippableGroup.Builder equippableGroup) {
        equippableGroup.addEquippableSet("helmet", rangedDamageBonus(VanillaEquippable.HEAD, ArmorItems.NECRO_HELMET, 4));
        equippableGroup.addEquippableSet("chestplate", rangedDamageBonus(VanillaEquippable.CHEST, ArmorItems.NECRO_CHESTPLATE, 4));
