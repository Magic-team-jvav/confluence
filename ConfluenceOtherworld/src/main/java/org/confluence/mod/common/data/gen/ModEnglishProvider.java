...
public class ModEnglishProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        // Bestiary
        add("bestiary.terra_entity.guide.desc", "The Guide always offers useful advice and crafting recipes. His origins and unusual connections to this world remain a mystery.");
        add("bestiary.terra_entity.merchant.desc", "The Merchant acts as a simple general store of sorts, providing useful starter tools and supplies needed for exploration.");
        add("bestiary.terra_entity.nurse.desc", "The Nurse's snarky attitude and poor bedside manner may be scary, but for a price, she will cure all that ails a wounded Terrarian.");
        add("bestiary.terra_entity.demolitionist.desc", "Tread carefully around this dwarf. The Demolitionist is an explosive fanatic and sells dangerous things that go 'Boom!'");
        add("bestiary.terra_entity.angler.desc", "The Angler, a rude fishing genius, sends others to find weird, rare fish. He rewards random items, entertained by any misfortunes.");
        add("bestiary.terra_entity.dryad.desc", "The Dryad is the last of her kind. She is connected with nature and can analyze its purity worldwide. She sells seeds, too!");
        add("bestiary.terra_entity.arms_dealer.desc", "The Arms Dealer has everything anyone could need to shoot things dead, from little round bullets to guns made from sharks.");
        add("bestiary.terra_entity.dye_trader.desc", "Eccentric and rather snobby to a fault, the Dye Trader has expensive tastes. He is passionate about the materials used in the dyes he sells.");
        add("bestiary.terra_entity.painter.desc", "The Painter can talk about all the different shades of colors with which one can paint the walls. He'll sell but a handful of them!");
//        add("bestiary.terra_entity.stylist.desc", "The Stylist loves style, gossip, and hair. Aside from performing a miracle makeover, she sells some hair product as well.");
        add("bestiary.terra_entity.zoologist.desc", "The Zoologist, resident lycanthrope, adores animals. Her fox-like biology resulted from a cursed animal bite.");
//        add("bestiary.terra_entity.tavernkeep.desc", "The Tavern Keep once managed a bar in another universe. He's here to help stop the Old One's Army from conquering this world.");
//        add("bestiary.terra_entity.golfer.desc", "The Golfer is a wise, middle-aged man who sells all sorts of golfing equipment. He's got game and knows how to score.");
        add("bestiary.terra_entity.goblin_tinkerer.desc", "Exiled from the rest of goblinkind for being an intelligent pacifist, the Tinkerer sells tools for combining accessories into stronger versions.");
        add("bestiary.terra_entity.witch_doctor.desc", "It's unusual for a Lihzahrd to be outside the Temple. Even more unusual are the voodoo things he sells. He prefers his jungle digs.");
        add("bestiary.terra_entity.mechanic.desc", "The Mechanic was imprisoned for her aptitude in engineering. She sells wiring and tools for putting together anything imaginable.");
        add("bestiary.terra_entity.clothier.desc", "Once trapped under a curse, the Clothier is the master of thread. If it's fashion that's desired, he's the man! He talks in a familiar way.");
//        add("bestiary.terra_entity.wizard.desc", "The Wizard is an absent-minded, demented old man who dabbles in the arcane arts. He sells magical trinkets to train new apprentices.");
//        add("bestiary.terra_entity.steampunker.desc", "The Steampunker has a particular taste for steam-fueled machinery and gadgets. She sells her gizmos with an endearing accent.");
//        add("bestiary.terra_entity.pirate.desc", "Ahoy! The only good Pirate Captain is... one that sells cannons and weapons to take out all competing Pirate Captains!");
        add("bestiary.terra_entity.truffle.desc", "Harnessing the hidden power of the glowing mushroom, the Truffle forges weapons and tools exclusively in his mushroom home.");
//        add("bestiary.terra_entity.tax_collector.desc", "This grumpy Tax Collector has literally been to hell and back. Greedy to a fault, he's truly only concerned with money.");
//        add("bestiary.terra_entity.cyborg.desc", "The Cyborg was built with the combined efforts of the Mechanic and the Steampunker to aid in rocket science and world defense.");
        add("bestiary.terra_entity.party_girl.desc", "Positive beyond comprehension, the Party Girl will use any excuse to celebrate. She sells party favors and flashy things.");
//        add("bestiary.terra_entity.princess.desc", "Shy and innocent, this happy young lady sees the positive in everything, and everybody. She appreciates all of her subjects, from all walks of life.");
//        add("bestiary.terra_entity.santa_claus.desc", "Only present during a specific time of year, Santa Claus makes a big entrance and an even bigger, rather explosive exit. Ho! Ho! Ho!");
//        add("bestiary.terra_entity.town_cat.desc", "Lazy, devious, might bring presents. Presents might have once been breathing.");
//        add("bestiary.terra_entity.town_dog.desc", "A loyal companion to many. Excitable and always ready for action.");
//        add("bestiary.terra_entity.town_bunny.desc", "Guaranteed to keep the vegetable supplies in check. Might possibly become a hat.");
//        add("bestiary.terra_entity.nerdy_slime.desc", "Just a smidge cleverer than other slimes, this slime discovered how to coexist with humans. The secret: accessorizing!");
//        add("bestiary.terra_entity.cool_slime.desc", "Easily the coolest slime around, no question. You can tell from the backwards hat and indecipherable slang.");
//        add("bestiary.terra_entity.elder_slime.desc", "Older, though not necessarily wiser, the other slimes look up to the Elder Slime. If it survived this long, it must know something!");
//        add("bestiary.terra_entity.clumsy_slime.desc", "This slime was a little confused when the other slimes started putting on hats and accessories. But it did its best.");
//        add("bestiary.terra_entity.diva_slime.desc", "Born of the combined energies of Shimmer and the Queen Slime, this slime is full of boundless energy and enthusiasm! And so fancy!");
//        add("bestiary.terra_entity.surly_slime.desc", "Irascible and insufferable, this grumpy slime is probably up to no good. Probably. It's the thought that counts, really.");
//        add("bestiary.terra_entity.mystic_slime.desc", "This slime knows that great witches wear impressive hats, but it only found a droopy one. Might explain the backfired polymorph!");
//        add("bestiary.terra_entity.squire_slime.desc", "A hero amongst slimes, it wields the greatest arms and armor known to its kind. It doesn't actually know how to use them, but it's a start.");
        add("bestiary.terra_entity.traveling_merchant.desc", "The flamboyantly-dressed Traveling Merchant travels far and wide to bring unique, cultural wares from time to time.");
//        add("bestiary.terra_entity.skeleton_merchant.desc", "Most skeletons are out for blood, but not the Skeleton Merchant. He just wants to sell supplies, such as rare torches and yo-yo gear.");
        add("bestiary.terra_entity.old_man.desc", "This hapless Old Man carries the burden of a heavy curse. It's said at night he transforms into a horrific demon which guards the Dungeon.");
//        add("bestiary.terra_entity.mystic_frog.desc", "A curious frog with a funny hat, surrounded by potent magic! Perhaps something can break its curse... you probably shouldn't kiss it!");
        add("bestiary.terra_entity.bunny.desc", "Fuzzy wuzzy creatures that prefer safe, friendly locations.");
//        add("bestiary.terra_entity.bunny_with_a_hat.desc", "Someone put a party hat on a bunny. It must be a real party animal.");
        add("bestiary.terra_entity.explosive_bunny.desc", "Not the typical garden-variety bunny. This one has been tampered with, and has an explosive temper as a result.");
//        add("bestiary.terra_entity.bunny_slime.desc", "Is it a bunny in a slime costume? Or is it a slime in a bunny costume? Halloween can be very confusing sometimes.");
//        add("bestiary.terra_entity.bunny_xmas.desc", "Judging by the outfit, Santa appears to have recruited some bunnies to be his little helpers this year.");
        add("bestiary.terra_entity.gold_bunny.desc", "Rarely, critters are found coated entirely in gold! Shopkeepers will pay handsomely for these, or you can show them off in cages!");
        add("bestiary.terra_entity.bird.desc", "A simple white bird which enjoys a calm sunny day.");
        add("bestiary.terra_entity.blue_jay.desc", "This little blue bird came looking for worms.");
        add("bestiary.terra_entity.cardinal.desc", "A rare, red-crested friend of the forest.");
//        add("bestiary.terra_entity.scarlet_macaw.desc", "A lovely tropical bird with plumage that reminds one of a beautiful sunset over the jungle canopy.");
//        add("bestiary.terra_entity.blue_macaw.desc", "Evoking visions of a bright summer sky over crystal blue waters, this tropical bird can be found foraging for seeds in the trees of the jungle.");
//        add("bestiary.terra_entity.toucan.desc", "You can often find this brightly-plumed and large-beaked bird looping around high in the trees in search of delicious fruit.");
//        add("bestiary.terra_entity.yellow_cockatiel.desc", "The distinct plumage of this bird's crest is a tell-tale sign of its emotional state, often raised when it is excited.");
        add("bestiary.terra_entity.gray_cockatiel.desc", "A very social animal by nature, these close cousins of parrots can often be taught to say simple phrases.");
        add("bestiary.terra_entity.gold_bird.desc", "Rarely, critters are found coated entirely in gold! Shopkeepers will pay handsomely for these, or you can show them off in cages!");
        add("bestiary.terra_entity.goldfish.desc", "A seemingly ordinary goldfish, until it decides to rain.");
        add("bestiary.terra_entity.gold_goldfish.desc", "Rarely, critters are found coated entirely in gold! Shopkeepers will pay handsomely for these, or you can show them off in cages!");
        add("bestiary.terra_entity.squirrel.desc", "Fast moving and erratic woodland creatures with grayish-brown fur. Got nuts?");
        add("bestiary.terra_entity.red_squirrel.desc", "Rare, red-furred hyperactive rodents which scurry about the woods.");
        add("bestiary.terra_entity.gold_squirrel.desc", "Rarely, critters are found coated entirely in gold! Shopkeepers will pay handsomely for these, or you can show them off in cages!");
        add("bestiary.terra_entity.mouse.desc", "Mice squeak around harmlessly, looking for small insects in damp underground locations.");
//        add("bestiary.terra_entity.gold_mouse.desc", "Rarely, critters are found coated entirely in gold! Shopkeepers will pay handsomely for these, or you can show them off in cages!");
//        add("bestiary.terra_entity.frog.desc", "Prefers bodies of water filled with thick growth. Perfectly content both on land and underwater.");
//        add("bestiary.terra_entity.gold_frog.desc", "Rarely, critters are found coated entirely in gold! Shopkeepers will pay handsomely for these, or you can show them off in cages!");
//        add("bestiary.terra_entity.grasshopper.desc", "It leaps tall blades of grass in a single bound. Fish are fairly attracted to these.");
        add("bestiary.terra_entity.gold_grasshopper.desc", "Rarely, critters are found coated entirely in gold! They are worth great coin to shopkeepers and fish absolutely love golden bait!");
        add("bestiary.terra_entity.butterfly.desc", "Beautiful fluttering insects that love sunrises. Fish are attracted to these based on their color variety.");
//        add("bestiary.terra_entity.gold_butterfly.desc", "Rarely, critters are found coated entirely in gold! They are worth great coin to shopkeepers and fish absolutely love golden bait!");
        add("bestiary.terra_entity.worm.desc", "A slick, tubular invertebrate found hiding in rocks, dirt, and grass. Loves the rain. Fish are especially attracted to these.");
//        add("bestiary.terra_entity.gold_worm.desc", "Rarely, critters are found coated entirely in gold! They are worth great coin to shopkeepers and fish absolutely love golden bait!");
        add("bestiary.terra_entity.dragonfly.desc", "A swift-flying insect which hunts mosquitoes. Comes in a variety of colors. Fish are somewhat attracted to these.");
//        add("bestiary.terra_entity.gold_dragonfly.desc", "Rarely, critters are found coated entirely in gold! They are worth great coin to shopkeepers and fish absolutely love golden bait!");
//        add("bestiary.terra_entity.seahorse.desc", "A gentle critter which swims harmlessly in the ocean depths.");
//        add("bestiary.terra_entity.gold_seahorse.desc", "Rarely, critters are found coated entirely in gold! Shopkeepers will pay handsomely for these, or you can show them off in cages!");
        add("bestiary.terra_entity.water_strider.desc", "Glides elegantly along the surface of calm bodies of water searching for smaller bugs. Fish are occasionally attracted to these.");
        add("bestiary.terra_entity.gold_water_strider.desc", "Rarely, critters are found coated entirely in gold! They are worth great coin to shopkeepers and fish absolutely love golden bait!");
        add("bestiary.terra_entity.ladybug.desc", "A brilliant red insect often associated with luck. Fishing with these as bait may result in unwanted karma.");
        add("bestiary.terra_entity.gold_ladybug.desc", "Rarely, critters are found coated entirely in gold! They are worth great coin to shopkeepers and fish absolutely love golden bait!");
//        add("bestiary.terra_entity.stinkbug.desc", "These sneaky pests have a knack for invading even the most airtight of homes, projecting their cilantro-like stench everywhere if disturbed.");
        add("bestiary.terra_entity.faeling.desc", "These scintillating fairy-like creatures are born when animals wander into the glowing depths of a Shimmer pond.");
        add("bestiary.terra_entity.mallard_duck.desc", "A water fowl with beautiful plumage. Swims in the purest of water, quacking happily.");
        add("bestiary.terra_entity.duck.desc", "A white feathered waterfowl that swims in pure water and basks in the warm sun.");
        add("bestiary.terra_entity.turtle.desc", "These slow, stoic creatures travel between lakes and dry land, carrying a hard shell on their backs for protection.");
        add("bestiary.terra_entity.owl.desc", "A large, wise predatory bird which hunts nocturnally from the tree tops.");
        add("bestiary.terra_entity.firefly.desc", "Appears at night in calm locations, illuminating the sky with strobing green light. Fish are fairly attracted to these.");
        add("bestiary.terra_entity.enchanted_nightcrawler.desc", "Worms infused with fallen star magic glow with a glittering light. Fish are extremely attracted to these.");
        add("bestiary.terra_entity.pink_fairy.desc", "Glowing winged humanoid creatures the size of a butterfly. Attuned to the world around them, they excel at finding shiny things.");
        add("bestiary.terra_entity.green_fairy.desc", "Glowing winged humanoid creatures the size of a butterfly. Attuned to the world around them, they excel at finding shiny things.");
        add("bestiary.terra_entity.blue_fairy.desc", "Glowing winged humanoid creatures the size of a butterfly. Attuned to the world around them, they excel at finding shiny things.");
        add("bestiary.terra_entity.rat.desc", "These fuzzy rodents sniff about in putrid locations scavenging for food. They are avoided in fear of diseases they may carry.");
        add("bestiary.terra_entity.maggot.desc", "An unsavory larval bug which feasts on dead, rotting matter. Fish are somewhat attracted to these.");
        add("bestiary.terra_entity.amethyst_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.terra_entity.topaz_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.terra_entity.sapphire_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.terra_entity.emerald_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.terra_entity.ruby_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.terra_entity.diamond_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.terra_entity.amber_squirrel.desc", "Glistening squirrels who strayed too deep become ensorcelled with residual cursed energy retained in gemstones.");
        add("bestiary.terra_entity.amethyst_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.terra_entity.topaz_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.terra_entity.sapphire_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.terra_entity.emerald_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.terra_entity.ruby_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.terra_entity.diamond_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.terra_entity.amber_bunny.desc", "These colorful rabbits made their way so deep, their reaction to magicked gems resulted in a coveted sparkling appearance.");
        add("bestiary.terra_entity.snail.desc", "A slimy mollusk that thrives in damp, dark places. Fish are barely attracted to these.");
//        add("bestiary.terra_entity.truffle_worm.desc", "An extremely rare, difficult to catch glowworm. A specific, powerful sea creature is insatiably attracted to these.");
//        add("bestiary.terra_entity.penguin.desc", "Penguins make their home in the coldest regions of the world, waddling around looking for tasty fish.");
//        add("bestiary.terra_entity.penguin_black.desc", "Penguins make their home in the coldest regions of the world, waddling around looking for tasty fish.");
        add("bestiary.terra_entity.scorpion.desc", "Harmlessly scuttles around the desert looking for food. Fish are barely attracted to these.");
        add("bestiary.terra_entity.black_scorpion.desc", "Despite its menacing appearance, it is quite docile unless threatened or facing smaller prey. Fish are occasionally attracted to these.");
//        add("bestiary.terra_entity.grebe.desc", "An exotic waterfowl that thrives in the desert oasis.");
//        add("bestiary.terra_entity.pupfish.desc", "These fish prefer isolated, extreme climates where competition is scarce, such as the lakebeds of a desert oasis.");
//        add("bestiary.terra_entity.seagull.desc", "A larger bird that inhabits coastal areas. Watch out for droppings!");
        add("bestiary.terra_entity.sea_turtle.desc", "A soft-shelled reptile that prefers saltwater and marine prey.");
        add("bestiary.terra_entity.dolphin.desc", "A playful sea mammal whose intelligence rivals that of humanity.");
//        add("bestiary.terra_entity.jungle_turtle.desc", "Their hard shells camouflage them from vicious predators by blending in with the thick, jungly environment in which they reside.");
        add("bestiary.terra_entity.grubby.desc", "Slimy, yet satisfying! Fish are somewhat attracted to these.");
        add("bestiary.terra_entity.sluggy.desc", "Slow and covered in a slick mucus. Fish are especially attracted to these.");
//        add("bestiary.terra_entity.buggy.desc", "A vibrant beetle-like bug. Fish are extremely attracted to these.");
//        add("bestiary.terra_entity.lavafly.desc", "A variation of firefly which adapted to the intense conditions of the world's infernal core. It mimics sparking embers.");
        add("bestiary.terra_entity.hell_butterfly.desc", "A solemn butterfly seeking blooms rooted in hell. Its wings glimmer with fiery veins.");
        add("bestiary.terra_entity.magma_snail.desc", "A unique species of snail which withstands extreme heat. Its boiling slime trail melts down most weaker surfaces.");
//        add("bestiary.terra_entity.lightning_bug.desc", "Appears at night in blessed locations, filling the sky with flashing cyan light. Fish are especially attracted to these.");
        add("bestiary.terra_entity.prismatic_lacewing.desc", "Should one of these luminescent beings perish in the chaos of night, a sleeping tyrant is rumored to violently awaken.");
        add("bestiary.terra_entity.glowing_snail.desc", "A snail that has mutated to adapt to the glowing mushroom environment. Fish are significantly attracted to these.");
//        add("bestiary.terra_entity.gnome.desc", "A tiny long-bearded sneak who resides in oversized trees. Becomes a lawn ornament when exposed to sunlight.");
        add("bestiary.terra_entity.goblin_scout.desc", "The Goblin Army sends lone soldiers out from the beaches to seek out colonies to conquer. They give warning with a tattered sigil.");
        add("bestiary.terra_entity.green_slime.desc", "A simple, gelatinous creature that swallows anything and everything whole! It takes a long time to digest anything.");
        add("bestiary.terra_entity.blue_slime.desc", "A simple, gelatinous creature that swallows anything and everything whole! It takes a long time to digest anything.");
        add("bestiary.terra_entity.purple_slime.desc", "A simple, gelatinous creature that swallows anything and everything whole! It takes a long time to digest anything.");
        add("bestiary.terra_entity.pinky.desc", "The smallest slime ever recorded, their extreme cellular density makes them incredibly durable for their small size. They eat money.");
//        add("bestiary.terra_entity.windy_balloon.desc", "Some enterprising slimes ride wind currents with balloons in an effort to find food. Pop their balloons to bring them back down to earth.");
//        add("bestiary.terra_entity.angry_dandelion.desc", "All this wind can make just about anyone angry. Evidently, this includes otherwise harmless dandelions and their deadly seeds.");
//        add("bestiary.terra_entity.umbrella_slime.desc", "The previous owner of this umbrella learned the hard way: umbrellas are good protection against rain, but not against slime.");
        add("bestiary.terra_entity.flying_fish.desc", "Certain species of fish gain the most peculiar abilities when it rains. They only like one thing about land-dwellers: their flesh.");
//        add("bestiary.terra_entity.angry_nimbus.desc", "When severe storms roll through, it is said that the skies are angry. This cloud in particular is especially livid!");
        add("bestiary.terra_entity.demon_eye_dilated.desc", "That suspicious feeling of being watched may very well come true in the dark of night, when Cthulhu's minions roam the skies.");
        add("bestiary.terra_entity.demon_eye_sleepy.desc", "That suspicious feeling of being watched may very well come true in the dark of night, when Cthulhu's minions roam the skies.");
        add("bestiary.terra_entity.demon_eye_purple.desc", "That suspicious feeling of being watched may very well come true in the dark of night, when Cthulhu's minions roam the skies.");
        add("bestiary.terra_entity.demon_eye.desc", "That suspicious feeling of being watched may very well come true in the dark of night, when Cthulhu's minions roam the skies.");
        add("bestiary.terra_entity.demon_eye_green.desc", "That suspicious feeling of being watched may very well come true in the dark of night, when Cthulhu's minions roam the skies.");
        add("bestiary.terra_entity.demon_eye_cataract.desc", "That suspicious feeling of being watched may very well come true in the dark of night, when Cthulhu's minions roam the skies.");
        add("bestiary.terra_entity.wandering_eye.desc", "That suspicious feeling of being watched may very well come true in the dark of night, when Cthulhu's minions roam the skies.");
        add("bestiary.terra_entity.zombie_female.desc", "Leaving doors open may be an invitation for shambling brain-eaters to enter the home, and nobody likes that.");
        add("bestiary.terra_entity.zombie_slimed.desc", "Sometimes, a slime's victim will turn into a zombie mid-digestion. Walking around like that is quite awkward for both parties.");
        add("bestiary.terra_entity.zombie_bald.desc", "Leaving doors open may be an invitation for shambling brain-eaters to enter the home, and nobody likes that.");
        add("bestiary.terra_entity.zombie.desc", "Leaving doors open may be an invitation for shambling brain-eaters to enter the home, and nobody likes that.");
        add("bestiary.terra_entity.zombie_twiggy.desc", "Leaving doors open may be an invitation for shambling brain-eaters to enter the home, and nobody likes that.");
        add("bestiary.terra_entity.zombie_torch.desc", "In life, this torch-wielding zombie joined an angry mob to hunt the undead. In death, it joined an undead mob to hunt the living.");
        add("bestiary.terra_entity.zombie_swamp.desc", "Leaving doors open may be an invitation for shambling brain-eaters to enter the home, and nobody likes that.");
        add("bestiary.terra_entity.zombie_pincushion.desc", "Leaving doors open may be an invitation for shambling brain-eaters to enter the home, and nobody likes that.");
        add("bestiary.terra_entity.raincoat_zombie.desc", "Some zombies never leave home without their trusty raincoat. Comfy and dry, they pursue human flesh no matter the weather.");
        add("bestiary.terra_entity.possessed_armor.desc", "Whatever possessed this suit of armor to suddenly walk about and start killing everyone? It lacks a corporeal body.");
//        add("bestiary.terra_entity.werewolf.desc", "Cursed by the moonlight, these menacing lupines were once human. Now, they feast on their loved ones instinctively.");
        add("bestiary.terra_entity.wraith.desc", "Souls belonging to the darkest of hearts were once sealed in the world's core. Now, they roam the night to add to their kind.");
//        add("bestiary.terra_entity.corrupt_bunny.desc", "Bunnies are pure beings that normally resist all forms of Corruption, but will succumb under the effects of a Blood Moon.");
//        add("bestiary.terra_entity.corrupt_penguin.desc", "During a Blood Moon, the normally docile penguins fall under the hostile influence of the Corruption.");
//        add("bestiary.terra_entity.vicious_bunny.desc", "Bunnies are pure beings that normally cannot be afflicted by Crimson, but will succumb under the effects of a Blood Moon.");
//        add("bestiary.terra_entity.vicious_penguin.desc", "During a Blood Moon, the normally docile penguins become infested with the contagious growth of the Crimson.");
        add("bestiary.terra_entity.blood_zombie.desc", "With enough exposure to a Blood Moon, zombies become twisted and cursed with everflowing blood pouring out from their rotten flesh.");
//        add("bestiary.terra_entity.the_groom.desc", "Tall, handsome, and dead. This unlucky fellow did not survive his wedding and is ready to take it out on everyone.");
        add("bestiary.terra_entity.the_bride.desc", "It's uncertain if the bride was wed before or after her death, but the story ends tragically for anyone who crosses her path.");
//        add("bestiary.terra_entity.zombie_merman.desc", "Mermen may be rare and exotic demi-humans, but they can still die... and still come back from that a changed merman.");
//        add("bestiary.terra_entity.clown.desc", "His origins unknown, this creepy fiend balances himself on a ball while hurling explosive destruction at everything around him.");
//        add("bestiary.terra_entity.blood_squid.desc", "Summoned in small groups by the Nautilus to aid their master in battle. Thick are the streams of blood squirted from their bodies.");
//        add("bestiary.terra_entity.blood_eel.desc", "A large, worm-like demon, dripping with blood - both its own, and its victim's. It's a bloody nightmare of a fiend!");
//        add("bestiary.terra_entity.corrupt_goldfish.desc", "Goldfish mutate and become violent when exposed to a Blood Moon, allowing the Corruption to take hold of them.");
//        add("bestiary.terra_entity.vicious_goldfish.desc", "Goldfish become grotesque, blood-sucking fiends of the Crimson when exposed to a Blood Moon.");
        add("bestiary.terra_entity.drippler.desc", "Demon eyes become erratic under a Blood Moon, sometimes twisting together into a dripping cluster of cursed blood and eyeballs.");
//        add("bestiary.terra_entity.chattering_teeth_bomb.desc", "A playful prank gone wrong, clowns will unleash these explosive chompers on their enemies. Also great for parties!");
        add("bestiary.terra_entity.wandering_eye_fish.desc", "For mysterious reasons, fish are known to mutate with other living things or even man-made objects. This one is especially violent.");
//        add("bestiary.terra_entity.hemogoblin_shark.desc", "Half-shark, half-goblin, completely murderous! One of the numerous reasons to just stay home during a Blood Moon.");
//        add("bestiary.terra_entity.dreadnautilus.desc", "An enormous shelled water demon which feeds off the negative energy of a Blood Moon. Brutally responds to being pestered.");
//        add("bestiary.terra_entity.hoppin_jack.desc", "This particular pumpkin seeks revenge for being carved. His hearty leaps become quicker the more he is carved into.");
//        add("bestiary.terra_entity.maggot_zombie.desc", "Wanders aimlessly to infest the living with undeath, unaware of its own maggoty infestation.");
//        add("bestiary.terra_entity.raven.desc", "Nevermore. Nevermore. Nevermore. Nevermore. Nevermore. Nevermore. Nevermore. Nevermore.");
        add("bestiary.terra_entity.ghost.desc", "During the most harrowing times, these apparitions float aimlessly through the depths to steal the life from those they envy.");
        add("bestiary.terra_entity.red_slime.desc", "A simple, gelatinous creature that swallows anything and everything whole! It takes a long time to digest anything.");
        add("bestiary.terra_entity.yellow_slime.desc", "A simple, gelatinous creature that swallows anything and everything whole! It takes a long time to digest anything.");
//        add("bestiary.terra_entity.toxic_sludge.desc", "Distantly related to the common slime, the Toxic Sludge takes down its prey with potent toxins and a disarmingly toothy smile.");
        add("bestiary.terra_entity.giant_worm.desc", "These itty bitty diggy dawgs dig through the earth and take focused spelunkers by surprise, causing unwanted distress.");
//        add("bestiary.terra_entity.digger.desc", "Exposure to the effects of ancient magicks flowing throughout the cracks of the world causes unusual rapid growths in giant worms.");
//        add("bestiary.terra_entity.baby_slime.desc", "Clinging tightly to their parents and rarely seen, these miniature slimes will swarm anyone who harms their mother.");
        add("bestiary.terra_entity.black_slime.desc", "A simple, gelatinous creature that swallows anything and everything whole! It takes a long time to digest anything.");
//        add("bestiary.terra_entity.shimmer_slime.desc", "After a quick swim in the Shimmer, this prismatic slime has been infused with the powers of the mysterious fluid.");
        add("bestiary.terra_entity.mother_slime.desc", "Critical to the lifecycle of the slime species, these oversized jiggling masses are often found carrying their young deep underground.");
//        add("bestiary.terra_entity.cochineal_beetle.desc", "Found in deep, dark caverns, these large beetles are sought out for the deep, blood-red secretions stored in their scaly exoskeleton.");
//        add("bestiary.terra_entity.skeleton_misassembled.desc", "Who needs muscles, skin, or even eyeballs? Skeletons get by with just the bones on their back, just as deadly as more fleshy foes.");
//        add("bestiary.terra_entity.skeleton.desc", "Who needs muscles, skin, or even eyeballs? Skeletons get by with just the bones on their back, just as deadly as more fleshy foes.");
//        add("bestiary.terra_entity.salamander.desc", "An unusual amphibious bipedal lizard which inhabits the dark caverns. When threatened, it spews a highly corrosive acid everywhere.");
//        add("bestiary.terra_entity.skeleton_headache.desc", "Who needs muscles, skin, or even eyeballs? Skeletons get by with just the bones on their back, just as deadly as more fleshy foes.");
//        add("bestiary.terra_entity.skeleton_pantless.desc", "Who needs muscles, skin, or even eyeballs? Skeletons get by with just the bones on their back, just as deadly as more fleshy foes.");
//        add("bestiary.terra_entity.crawdad.desc", "A subterranean form of crayfish which scuttles along the cavern floors, searching for prey to clip apart with its powerful pincers.");
//        add("bestiary.terra_entity.undead_miner.desc", "There's evidence of spelunkers having explored the caverns in the past... as well as evidence of them having died doing so.");
//        add("bestiary.terra_entity.skeleton_archer.desc", "Skeleton Archers have a keen eye, despite the general lack of eyes. Distance offers little protection from their blazing arrows.");
        add("bestiary.terra_entity.nymph.desc", "Masterfully deceives explorers by posing as a lost girl, then attacks with ferocious might, blood-lust in her eyes.");
        add("bestiary.terra_entity.armored_skeleton.desc", "Remnants of a long lost expeditionary force, these stout warriors mindlessly patrol the caves in which they died.");
//        add("bestiary.terra_entity.rock_golem.desc", "Dense-minded living stone formation. Awaits weary cavern dwellers to pound them into juicy rubble.");
//        add("bestiary.terra_entity.tim.desc", "An enchanter in life, this funny fellow won't give up his robe or wizard hat without a fight. He prefers warmer caverns.");
//        add("bestiary.terra_entity.rune_wizard.desc", "Tim's more powerful and much better-looking older brother. He, too, prefers the heat, but not excessively.");
        add("bestiary.terra_entity.cave_bat.desc", "They are small, hard to see, and swiftly flap about in unpredictable ways. They often carry diseases, such as rabies.");
//        add("bestiary.terra_entity.giant_bat.desc", "The oversized cousins of Cave Bats, these bats are more dangerous and can confuse their enemies with their bite.");
        add("bestiary.terra_entity.blue_jellyfish.desc", "That strange tingling sensation in the water may be the unwelcome surging of electrical death from a brainless jellyfish. Swim with care.");
        add("bestiary.terra_entity.green_jellyfish.desc", "That strange tingling sensation in the water may be the unwelcome surging of electrical death from a brainless jellyfish. Swim with care.");
//        add("bestiary.terra_entity.mimic.desc", "Talking to a chest doesn't cause craziness, but if the chest answers back, it may cause death! It still contains rare treasure, regardless!");
        add("bestiary.terra_entity.giant_shelly.desc", "To overcome their slow speed, shellies have developed the ability to hide inside their spiked shell and hurl themselves at their foes.");
        add("bestiary.terra_entity.lost_girl.desc", "Naked and afraid, this girl stands still, deep in the world, as if waiting for someone to rescue her and lead her to the surface.");
//        add("bestiary.terra_entity.granite_golem.desc", "Strong are the magicked spirits which inhabit the granite masses deep below, this type in particular taking on a humanoid shape.");
        add("bestiary.terra_entity.granite_elemental.desc", "Earth elementals manifest through many forms by taking on the properties of different materials, such as this hardy granite.");
//        add("bestiary.terra_entity.hoplite.desc", "In the ruins of an ancient civilization now deeply buried, some of its spear-hurling soldiers still walk its marble-adorned paths.");
//        add("bestiary.terra_entity.medusa.desc", "An ancient monster with a petrifying gaze. The snakes which grow from her scalp like hair grant her these powers.");
        add("bestiary.terra_entity.spore_skeleton.desc", "Skeletons meandering through more moist caverns become hosts for glowing fungal growth, greatly empowering them.");
        add("bestiary.terra_entity.spore_bat.desc", "The tables have turned on a variety of rabid bats, themselves enwrought with a deadly fungal infection.");
//        add("bestiary.terra_entity.wall_creeper.desc", "They have eight legs, eight eyes, and eight ways to cocoon and feast upon an unsuspecting victim.");
//        add("bestiary.terra_entity.black_recluse.desc", "They have eight legs, eight eyes, and eight ways to cocoon and feast upon an unsuspecting victim.");
        add("bestiary.terra_entity.ice_slime.desc", "Slimes that spent too long in arctic temperatures may begin to partially freeze, developing a shifting layer of ice on their surface.");
//        add("bestiary.terra_entity.frozen_zombie.desc", "Zombies found in snow biomes are often found bundled up in winter clothing. It doesn't help them any, they are still dead cold!");
//        add("bestiary.terra_entity.ice_golem.desc", "Sub-zero temperatures, blinding snow flurries, and being blasted apart by an icy construct are some of the dangers of blizzards.");
//        add("bestiary.terra_entity.wolf.desc", "Living in the harshest of climates, these savage lupines hunt in the dark of night desperately for sustenance.");
//        add("bestiary.terra_entity.spiked_ice_slime.desc", "This Ice Slime has large ice shards in its mass from excessive exposure to the cold. Somehow, it is able to launch these at its prey.");
//        add("bestiary.terra_entity.cyan_beetle.desc", "Hardy to extremely cold temperatures, these beetles contain a desired bluish fluid which can be used to dye textiles.");
        add("bestiary.terra_entity.undead_viking.desc", "Long before there were pirates, stories tell of powerful vikings who raged the seas. Their remains roam the icy caverns below.");
        add("bestiary.terra_entity.snow_flinx.desc", "A strange, round furry mammal with an unusually large, protruding nose. They are extremely lightweight.");
//        add("bestiary.terra_entity.armored_viking.desc", "The most elite vikings were worthy of the strongest armor. It seems that it wasn't terribly effective, given their state now.");
//        add("bestiary.terra_entity.icy_merman.desc", "Mermen rarely stray far from the ocean. Those that do can become lost, wander into cold caverns, and become icy undead fish men.");
        add("bestiary.terra_entity.ice_bat.desc", "As if bats weren't enough of a nuisance already, Ice Bats can freeze flesh solid with a touch, leaving their prey defenseless.");
//        add("bestiary.terra_entity.ice_elemental.desc", "Water elementals become icy when dense strong magicks accumulate in the coldest places. Their frosty shards freeze all.");
//        add("bestiary.terra_entity.ice_mimic.desc", "Talking to a chest doesn't cause craziness, but if the chest answers back, it may cause death! It still contains rare treasure, regardless!");
//        add("bestiary.terra_entity.ice_tortoise.desc", "Like their jungle cousins, ice tortoises are an unexpectedly serious threat, possessing surprising speed and mobility.");
//        add("bestiary.terra_entity.vulture.desc", "Built to survive the desert heat, avian scavengers such as these will peck apart those who come near their carrion.");
        add("bestiary.terra_entity.sand_slime.desc", "Deserts are very dry, but the Sand Slime seems to have successfully adapted to the harsh conditions by becoming a pile of living sand.");
//        add("bestiary.terra_entity.antlion_larva.desc", "Freshly hatched from their eggs, larval antlions should not be underestimated. Though young, they are still very aggressive.");
//        add("bestiary.terra_entity.giant_antlion_charger.desc", "The soldiers of the antlion species, Antlion Chargers ferociously chase after intruders with a surprising speed.");
//        add("bestiary.terra_entity.mummy.desc", "With the sands transmogrified by outside forces, those put to rest in the desert, whether good or evil, now rise to maim and kill.");
//        add("bestiary.terra_entity.ghoul.desc", "Wandering the dark caverns below the desert dunes, ghouls are the dessicated husks of zombies preserved by the arid environment.");
//        add("bestiary.terra_entity.basilisk.desc", "Sturdy as a rock, these lizard-like beasts roam the desert in search of food. Their hardened bodies make them formidable threats.");
        add("bestiary.terra_entity.tomb_crawler.desc", "The desert is home to one of the largest varieties of worms across the land. It has a voracious appetite for careless explorers.");
//        add("bestiary.terra_entity.antlion.desc", "When antlions are nesting, they hide in the surface. To defend their eggs, they projectile vomit hard globs of sand at trespassers.");
//        add("bestiary.terra_entity.sand_poacher.desc", "These unnaturally large scorpions have adapted to swiftly pursuing their prey along the walls with their sharp, venomous tails.");
        add("bestiary.terra_entity.giant_antlion_swarmer.desc", "Antlion Swarmers patrol their nests with a watchful eye. Should anyone threaten their eggs, they will defend them fiercely.");
//        add("bestiary.terra_entity.antlion_charger.desc", "The soldiers of the antlion species, Antlion Chargers ferociously chase after intruders with a surprising speed.");
//        add("bestiary.terra_entity.dune_splicer.desc", "The world's largest, most deadly worm. Strengthened by ancient magicks, it can devour a spicy Terrarian quicker than they realize.");
//        add("bestiary.terra_entity.angry_tumbler.desc", "Powerful winds have blown this tumbleweed around the desert, and it is none too pleased. They roll faster with the wind than against it.");
        add("bestiary.terra_entity.antlion_swarmer.desc", "Antlion Swarmers patrol their nests with a watchful eye. Should anyone threaten their eggs, they will defend them fiercely.");
//        add("bestiary.terra_entity.sand_elemental.desc", "The most intense sandstorms draw forth powerful earth elementals. With this feminine form, her tornadoes tear all asunder.");
//        add("bestiary.terra_entity.sand_shark.desc", "In ancient times, a saltwater river once ran through the desert. These powerful creatures evolved to survive in the now dry sand.");
        add("bestiary.terra_entity.crab.desc", "This hard shelled coastal creature could snip the toes right off a man, among other things. They are not to be trifled with.");
//        add("bestiary.terra_entity.sea_snail.desc", "This unusually large snail makes its home deep in the ocean. Its mucus can be manufactured into a purple dye.");
//        add("bestiary.terra_entity.shark.desc", "Once these ocean predators catch a whiff of blood, they become relentless and unstoppable in their ravenous pursuit.");
//        add("bestiary.terra_entity.squid.desc", "A betentacled marine creature which discharges a thick, black ink when threatened. The ink is collected for aesthetic purposes.");
//        add("bestiary.terra_entity.pink_jellyfish.desc", "That strange tingling sensation in the water may be the unwelcome surging of electrical death from a brainless jellyfish. Swim with care.");
        add("bestiary.terra_entity.jungle_slime.desc", "A simple, gelatinous creature that swallows anything and everything whole! It takes a long time to digest anything.");
        add("bestiary.terra_entity.snatcher.desc", "A sharp-toothed plant with a taste for human flesh. It has the ability to hide inside the mud and reach over great distances.");
//        add("bestiary.terra_entity.giant_flying_fox.desc", "An oversized cousin of the bat found only in the Jungle, giant flying foxes hunt the night skies looking for prey.");
//        add("bestiary.terra_entity.derpling.desc", "These large, sapphire-shelled fleas leap around incessantly. They can drain the blood content of one man within seconds.");
//        add("bestiary.terra_entity.spiked_jungle_slime.desc", "Frequent consumption of the Jungle's toxins and thorns has resulted in a slime covered in venomous spikes.");
//        add("bestiary.terra_entity.lac_beetle.desc", "These scaly insects thrive in thick subterranean foliage. Their secretions stain many materials in a beautiful violet color.");
//        add("bestiary.terra_entity.doctor_bones.desc", "This particular zombie has a knack for finding historical artifacts, but has a terrible disdain towards snakes.");
//        add("bestiary.terra_entity.bee.desc", "Found in hives and nests all throughout the jungle, these tiny pests will swarm an adventurer at every turn.");
//        add("bestiary.terra_entity.bee_larger.desc", "Found in hives and nests all throughout the jungle, these tiny pests will swarm an adventurer at every turn.");
        add("bestiary.terra_entity.hornet_stingy.desc", "Aggressive flying insects which swarm the jungle depths. Their venomous barbs discharge over great distances at high velocity.");
        add("bestiary.terra_entity.hornet_spikey.desc", "Aggressive flying insects which swarm the jungle depths. Their venomous barbs discharge over great distances at high velocity.");
        add("bestiary.terra_entity.hornet.desc", "Aggressive flying insects which swarm the jungle depths. Their venomous barbs discharge over great distances at high velocity.");
        add("bestiary.terra_entity.hornet_fatty.desc", "Aggressive flying insects which swarm the jungle depths. Their venomous barbs discharge over great distances at high velocity.");
        add("bestiary.terra_entity.hornet_honey.desc", "Aggressive flying insects which swarm the jungle depths. Their venomous barbs discharge over great distances at high velocity.");
        add("bestiary.terra_entity.hornet_leafy.desc", "Aggressive flying insects which swarm the jungle depths. Their venomous barbs discharge over great distances at high velocity.");
//        add("bestiary.terra_entity.moss_hornet.desc", "The empowered flora of the Jungle has merged with these species of Hornet, strengthening their exoskeletons and stingers.");
//        add("bestiary.terra_entity.moth.desc", "Rarely, exposure to jungle toxins causes certain moths to mutate to enormous size. They release a valuable dust on death.");
        add("bestiary.terra_entity.man_eater.desc", "A sharp-toothed plant with a taste for human flesh. It has the ability to hide inside the mud and reach over great distances.");
//        add("bestiary.terra_entity.angry_trapper.desc", "When a Man Eater consumes enough human flesh, it undergoes a cocoon-like metamorphosis into a far deadlier form.");
        add("bestiary.terra_entity.jungle_bat.desc", "These small, annoying creatures aren't to be underestimated. A deadly end awaits for those swarmed by these fangy rodents.");
        add("bestiary.terra_entity.piranha.desc", "Just one of these sharp-toothed fish can easily end a life. Luckily, they tend to swarm their victims in large groups! Life is grand.");
//        add("bestiary.terra_entity.angler_fish.desc", "Some angler fish are content to lie in wait for their prey, but these are perfectly happy to aggressively chase down an underwater meal.");
//        add("bestiary.terra_entity.arapaima.desc", "These enormous fish thrive in the jungle waters near veins of unstable magicks, which make them unusually strong and hostile.");
//        add("bestiary.terra_entity.giant_tortoise.desc", "No one takes the giant tortoises seriously. Not until they come hurtling through the air, a spinning, spiky ball of death.");
//        add("bestiary.terra_entity.jungle_creeper.desc", "The itsy bitsy spider climbed up a jungle vine, down came a hapless explorer and the spider got to dine. The End.");
//        add("bestiary.terra_entity.meteor_head.desc", "When meteorites strike the surface, their fragments lay scattered for the taking. Some pieces are alive, and will attack.");
        add("bestiary.terra_entity.dungeon_slime.desc", "Slimes in the Dungeon became powerful by feeding off the cursed energy throughout the place. They seem particularly attracted to keys.");
        add("bestiary.terra_entity.angry_bones.desc", "Cursed with undeath, the former inhabitants of the Dungeon roam endlessly through its halls, seeking a victim for their unending fury.");
        add("bestiary.terra_entity.angry_bones_big.desc", "Cursed with undeath, the former inhabitants of the Dungeon roam endlessly through its halls, seeking a victim for their unending fury.");
        add("bestiary.terra_entity.angry_bones_big_muscle.desc", "Cursed with undeath, the former inhabitants of the Dungeon roam endlessly through its halls, seeking a victim for their unending fury.");
        add("bestiary.terra_entity.angry_bones_big_helmet.desc", "Cursed with undeath, the former inhabitants of the Dungeon roam endlessly through its halls, seeking a victim for their unending fury.");
//        add("bestiary.terra_entity.blue_armored_bones_mace.desc", "Disciplined and relentless, the Marching Bones unceasingly pursue their goals, sundering anything, or anyone, in their way.");
//        add("bestiary.terra_entity.skeleton_sniper.desc", "These eagle-eyed sharpshooters let nothing escape their crosshairs. Part of an elite military unit in their past lives.");
//        add("bestiary.terra_entity.tactical_skeleton.desc", "With thick armor and mighty boomsticks, it's clear these bones are prepared for a siege. Part of an elite military unit in their past lives.");
//        add("bestiary.terra_entity.skeleton_commando.desc", "Rocket-powered and fueled with rage, these cursed skeletons prefer the nuclear option. Part of an elite military unit in their past lives.");
//        add("bestiary.terra_entity.hell_armored_bones.desc", "The fiery glow of the Molten Legion is unmistakable. With their red-hot armaments in hand, they blaze a trail through all those in their way.");
//        add("bestiary.terra_entity.rusty_armored_bones_sword_no_armor.desc", "Through use and neglect, the Rusted Company's weapons are jagged and rough, inflicting terrible bleeding wounds upon their foes.");
//        add("bestiary.terra_entity.rusty_armored_bones_flail.desc", "Through use and neglect, the Rusted Company's weapons are jagged and rough, inflicting terrible bleeding wounds upon their foes.");
//        add("bestiary.terra_entity.hell_armored_bones_mace.desc", "The fiery glow of the Molten Legion is unmistakable. With their red-hot armaments in hand, they blaze a trail through all those in their way.");
//        add("bestiary.terra_entity.blue_armored_bones.desc", "Disciplined and relentless, the Marching Bones unceasingly pursue their goals, sundering anything, or anyone, in their way.");
//        add("bestiary.terra_entity.rusty_armored_bones_sword.desc", "Through use and neglect, the Rusted Company's weapons are jagged and rough, inflicting terrible bleeding wounds upon their foes.");
//        add("bestiary.terra_entity.hell_armored_bones_spike_shield.desc", "The fiery glow of the Molten Legion is unmistakable. With their red-hot armaments in hand, they blaze a trail through all those in their way.");
//        add("bestiary.terra_entity.blue_armored_bones_no_pants.desc", "Disciplined and relentless, the Marching Bones unceasingly pursue their goals, sundering anything, or anyone, in their way.");
//        add("bestiary.terra_entity.hell_armored_bones_sword.desc", "The fiery glow of the Molten Legion is unmistakable. With their red-hot armaments in hand, they blaze a trail through all those in their way.");
//        add("bestiary.terra_entity.rusty_armored_bones_axe.desc", "Through use and neglect, the Rusted Company's weapons are jagged and rough, inflicting terrible bleeding wounds upon their foes.");
//        add("bestiary.terra_entity.blue_armored_bones_sword.desc", "Disciplined and relentless, the Marching Bones unceasingly pursue their goals, sundering anything, or anyone, in their way.");
//        add("bestiary.terra_entity.bone_lee.desc", "It's said that centuries ago, there was once a clan of ninjas that hid in the shadows of the world. It seems they are long dead now.");
//        add("bestiary.terra_entity.paladin.desc", "In distant history, these mighty undead knights once guarded a prosperous city before a massive curse befell them.");
        add("bestiary.terra_entity.dark_caster.desc", "Doomed to watch over the Dungeon, these mages teleport to confuse their prey, before striking them down with a blast of water.");
//        add("bestiary.terra_entity.diabolist_red.desc", "The undead who bear the Diabolic Sigil wield flames as intense as any in the underworld, consuming all in a scorching inferno.");
//        add("bestiary.terra_entity.diabolist_white.desc", "The undead who bear the Diabolic Sigil wield flames as intense as any in the underworld, consuming all in a scorching inferno.");
//        add("bestiary.terra_entity.necromancer.desc", "In life, these sorcerers bore the Necromantic Sign of their order, and they shall continue to do so forever . . . even in death.");
//        add("bestiary.terra_entity.ragged_caster.desc", "With their cursed magic, the members of the Ragged Brotherhood leave their victims helplessly lost in utter darkness.");
//        add("bestiary.terra_entity.necromancer_armored.desc", "In life, these sorcerers bore the Necromantic Sign of their order, and they shall continue to do so forever . . . even in death.");
//        add("bestiary.terra_entity.ragged_caster_open_coat.desc", "With their cursed magic, the members of the Ragged Brotherhood leave their victims helplessly lost in utter darkness.");
        add("bestiary.terra_entity.cursed_skull.desc", "Exposed to dark rituals, this skull has begun floating around on its own, chasing the living. Its touch leaves its victims defenseless.");
//        add("bestiary.terra_entity.giant_cursed_skull.desc", "No one knows where these giant skulls came from, but like their smaller cousins, they seek out and curse the living with their magic.");
        add("bestiary.terra_entity.dungeon_guardian.desc", "A lethal sentry that stands watch over the Dungeon's gates. Those who are deemed unworthy to enter shall not pass!");
//        add("bestiary.terra_entity.dungeon_spirit.desc", "Sometimes, highly concentrated ectoplasm gathers inside the more powerful of the cursed inhabitants of the Dungeon.");
        add("bestiary.terra_entity.lava_slime.desc", "Due to the heat of the underworld, these slimes have taken on the properties of lava. Slaying them is difficult and dangerous.");
//        add("bestiary.terra_entity.tortured_soul.desc", "Sentenced to an eternity of punishment for his lifelong greedy ambitions, this man has long been corrupted into a demonic state.");
//        add("bestiary.terra_entity.bone_serpent.desc", "Mighty serpentine dragons once ruled hell, but long ago shed their obsidian scales. A skeletal husk is all that remains.");
        add("bestiary.terra_entity.fire_imp.desc", "A lesser demon imbued with hell magic. Capable of teleporting and hurling phantom fireballs towards their foes.");
        add("bestiary.terra_entity.hellbat.desc", "What's worse than a rabid, fast-flying, and annoying flying rodent? One that is on fire, of course!");
        add("bestiary.terra_entity.demon.desc", "Demons are the infantry of the underworld. Unlike their lesser brothers, they cast shadow magic rather than hell magic.");
        add("bestiary.terra_entity.voodoo_demon.desc", "Higher ranking demons can possess a voodoo doll of the chosen one, whose soul is linked with the world's guardian himself.");
        add("bestiary.terra_entity.lava_bat.desc", "What's worse than a rabid, fast-flying, and annoying flying rodent? One that is on fire, of course!");
//        add("bestiary.terra_entity.red_devil.desc", "Conjuring potent spears of dark magic, these elite demons are a serious threat to any who dare enter their abode.");
        add("bestiary.terra_entity.wyvern.desc", "A colossal dragon-like creature unleashed along with the ancient spirits. It rules the skies with its unrivaled might.");
        add("bestiary.terra_entity.harpy.desc", "Winged, demi-human women defend their territory against invaders by impaling them with their razor-sharp feathers.");
//        add("bestiary.terra_entity.martian_probe.desc", "Sensing growing power on the planet, otherworldly beings send space-age technology to scan for advanced lifeforms.");
//        add("bestiary.terra_entity.slimeling.desc", "The still-animate severed pieces of an injured Corrupt Slime, Slimelings can still put up a fight, and have strength in numbers.");
        add("bestiary.terra_entity.corrupt_slime.desc", "Steeped in the power of Corruption, these slimes can survive being cut apart into smaller pieces, unlike their untainted brethren.");
        add("bestiary.terra_entity.eater_of_souls.desc", "Birthed from the Corruption as a being of pure malice, its sole instincts are to pursue, punish, and kill.");
//        add("bestiary.terra_entity.corruptor.desc", "Like a cancer, the putrid creatures born from the Corruption mutate and grow into bigger, more deadly forms which discharge acids.");
        add("bestiary.terra_entity.devourer.desc", "Worm-like monstrosities are the Corruption's most favored creatures, tunneling underneath unsuspecting victims.");
//        add("bestiary.terra_entity.world_feeder.desc", "Ancient magicks have unleashed the dark influences that gave birth to the Eater of Worlds, producing smaller, but just as deadly worms.");
//        add("bestiary.terra_entity.clinger.desc", "In the depths of the darkest corruption lies cursed-fire belching, betentacled nightmares stretching from the very walls themselves.");
//        add("bestiary.terra_entity.slimer.desc", "The Slimer has become airborne with wings of unknown origin. The wings are easily knocked off with force, depriving it of its flight.");
//        add("bestiary.terra_entity.cursed_hammer.desc", "Magicked through the pure hatred of the Corruption, this weapon flails about attempting to smash anything that breathes.");
//        add("bestiary.terra_entity.corrupt_mimic.desc", "Mimics which fall to Corruption grow larger and more powerful as a result. They can be birthed from ordinary chests by force.");
//        add("bestiary.terra_entity.pigron_corrupt.desc", "This elusive dragon-pig hybrid has excellent stealth capabilities despite its rotund figure. It is uncertain how they came to exist.");
//        add("bestiary.terra_entity.bone_biter.desc", "In ancient times, a saltwater river once ran through the desert. These powerful creatures evolved to survive in the now dry sand.");
//        add("bestiary.terra_entity.dark_mummy.desc", "With the sands transmogrified by outside forces, those put to rest in the desert, whether good or evil, now rise to maim and kill.");
//        add("bestiary.terra_entity.vile_ghoul.desc", "Ghouls twisted by the Corruption ooze a nasty green bile that ignites on contact with skin, scorching their prey with cursed flames.");
        add("bestiary.terra_entity.crimslime.desc", "Taking on the consistency of congealed blood and flesh, Crimslimes seek out and digest more raw material for the Crimson.");
        add("bestiary.terra_entity.face_monster.desc", "It would be unwise to face off with one of these unfeeling, hungry mutations. Their mouths are large enough to devour all things.");
        add("bestiary.terra_entity.crimera.desc", "The most common horror to be born from the Crimson, it seeks to consume pure things with unrelenting hunger.");
//        add("bestiary.terra_entity.blood_feeder.desc", "Like the piranha, these swarming fish thirst for blood. Birthed from tainted blood themselves, their hunger is truly intense.");
//        add("bestiary.terra_entity.blood_jelly.desc", "Jellyfish swimming in the bloody waters of the Crimson become infected, converting them to its all-consuming cause.");
//        add("bestiary.terra_entity.floaty_gross.desc", "These buoyant terrors of the darkest crimson depths most definitely, without question, are both floaty and gross.");
//        add("bestiary.terra_entity.ichor_sticker.desc", "Filled to the brim with powerful ichor, these squid-like abominations spew their corrosive bio-fluid at their prey.");
//        add("bestiary.terra_entity.crimson_axe.desc", "Ensorcelled by the Crimson collective, this weapon moves about and chops its enemies by its own will.");
        add("bestiary.terra_entity.blood_crawler.desc", "Most spiders operate independently, but ones touched by the Crimson hive coordinate together to consume life.");
//        add("bestiary.terra_entity.herpling.desc", "These hyper, demented, slug-like fiends serve the crimson horde with an unstoppable appetite for blood and flesh.");
//        add("bestiary.terra_entity.crimson_mimic.desc", "Mimics which are enthralled by the Crimson are empowered dramatically. They can be birthed from ordinary chests by force.");
//        add("bestiary.terra_entity.pigron_crimson.desc", "This elusive dragon-pig hybrid has excellent stealth capabilities despite its rotund figure. It is uncertain how they came to exist.");
//        add("bestiary.terra_entity.flesh_reaver.desc", "In ancient times, a saltwater river once ran through the desert. These powerful creatures evolved to survive in the now dry sand.");
//        add("bestiary.terra_entity.blood_mummy.desc", "The blood-dripping organic matter in these mummies display far better preservation than the rest of their ilk.");
//        add("bestiary.terra_entity.tainted_ghoul.desc", "Ghouls infested by the Crimson leak vile ichor from their mouths, weakening the defenses of their foes with every bite.");
//        add("bestiary.terra_entity.lamia.desc", "By the time glowing red eyes appear in the darkness of the desert caves, it is already too late. The lamias have found their prey.");
//        add("bestiary.terra_entity.desert_spirit.desc", "Ancient magicks corrupted the minds of the once friendly desert djinns, releasing them full of hostility from their lamps.");
//        add("bestiary.terra_entity.rainbow_slime.desc", "These blessing-infused gelatin menaces glow vibrantly in a rainbow of hues. As a result, they require a constant liquid intake.");
        add("bestiary.terra_entity.pixie.desc", "A larger, more luminous form of fairy. Pixies provide the Hallow with more blessed light and aid in the cleansing of the land.");
//        add("bestiary.terra_entity.gastropod.desc", "Touched by the blessing, these nocturnal slimes evolved into a levitating snail-like creature which spits powerful beams of light.");
//        add("bestiary.terra_entity.unicorn.desc", "These majestic single-horned equines storm angrily through the hallowed land in search of lowly intrusions needing to be cleansed away.");
        add("bestiary.terra_entity.illuminant_slime.desc", "Slimes exposed to the light of the Hallow's crystals begin to emit that very same light, glowing brightly in the darkness.");
//        add("bestiary.terra_entity.chaos_elemental.desc", "Once living beings infused by the blessing, they erratically make chase with an uncontrollable surge of luminous power.");
//        add("bestiary.terra_entity.illuminant_bat.desc", "Blessed with the prismatic light of the Hallow, the Illuminant Bats are a vibrant pink blur arcing across the darkness of the Underground.");
//        add("bestiary.terra_entity.enchanted_sword.desc", "Animated by the blessed light of the crystals, it will slice through anything to cleanse the world's evils.");
//        add("bestiary.terra_entity.hallowed_mimic.desc", "Mimics struck with the blessing surge with energy and become powerful. They can be birthed from ordinary chests by force.");
//        add("bestiary.terra_entity.pigron.desc", "This elusive dragon-pig hybrid has excellent stealth capabilities despite its rotund figure. It is uncertain how they came to exist.");
//        add("bestiary.terra_entity.crystal_thresher.desc", "In ancient times, a saltwater river once ran through the desert. These powerful creatures evolved to survive in the now dry sand.");
//        add("bestiary.terra_entity.light_mummy.desc", "With the sands transmogrified by outside forces, those put to rest in the desert, whether good or evil, now rise to maim and kill.");
//        add("bestiary.terra_entity.dreamer_ghoul.desc", "Ghouls cleansed by the Hallow possess a psychedelic saliva that renders their victims confused and distracted by visions and mirages.");
//        add("bestiary.terra_entity.lamia_underground_desert.desc", "By the time glowing red eyes appear in the darkness of the desert caves, it is already too late. The lamias have found their prey.");
        add("bestiary.terra_entity.spore_zombie_mushroom.desc", "The fungus controlling the minds of these zombies wants only one thing: brains! This is very convenient for the zombie.");
        add("bestiary.terra_entity.spore_zombie_hat_mushroom.desc", "The fungus controlling the minds of these zombies wants only one thing: brains! This is very convenient for the zombie.");
//        add("bestiary.terra_entity.anomura_fungus.desc", "These crab-like creatures scuttle about in glowing mushroom fields, heavily infested by the fungal spores.");
//        add("bestiary.terra_entity.mushi_ladybug.desc", "This aggressive species of ladybug is quite at home near glowing mushrooms, living symbiotically with the fungus.");
//        add("bestiary.terra_entity.fungi_bulb.desc", "When the glowing fungus is ready to spread, these bulbs will sprout to spread its spores to other locations and hosts.");
//        add("bestiary.terra_entity.shadowflame_apparition.desc", "The shadowflame magicks are powerful spiritual remnants of twisted goblin ancestors, wrought from powerful summoning.");
//        add("bestiary.terra_entity.old_ones_skeleton.desc", "Small armies of these skeletons are summoned from the ground by Dark Mages, loyally serving their master's will.");
//        add("bestiary.terra_entity.etherian_goblin.desc", "A unique goblin species from Etheria, they are not related Terrarian goblins. The ferocious footsoldiers of the Old One's Army.");
//        add("bestiary.terra_entity.etherian_goblin_bomber.desc", "Hurling bombs with reckless abandon, these sappers serve the Old One's Army with maniacal passion.");
//        add("bestiary.terra_entity.kobold.desc", "Rigged with an explosive payload, Kobolds have no regard for safety. They eagerly blow themselves up, hoping to take their foes with them.");
//        add("bestiary.terra_entity.etherian_javelin_thrower.desc", "These bulky brutes are awkward and ungainly, but their javelins are still razor sharp, and their aim is deadly.");
//        add("bestiary.terra_entity.wither_beast.desc", "Wither beasts emit a defense-sapping aura from the crystals on their back. While rooted in place, they heal rapidly.");
//        add("bestiary.terra_entity.drakin.desc", "Etherian reptiles in service of the Old One's Army. Powerful beasts, they are capable of spewing deadly purple flames.");
//        add("bestiary.terra_entity.ogre.desc", "A tall, hulking demi-human from the Old One's Army with unfathomable strength and vitality. He carries a big stick.");
//        add("bestiary.terra_entity.kobold_glider.desc", "Taking the explosive approach to a whole new level, Kobold Gliders soar the skies, seeking to bring death from above.");
//        add("bestiary.terra_entity.etherian_wyvern.desc", "Etherian Wyverns come in a variety of shapes and sizes, and behave more like bats than the majestic Wyverns of this world.");
//        add("bestiary.terra_entity.dark_mage.desc", "A small, levitating sorcerer from Etheria who wields dark magic and can even raise fresh minions for the Old One's Army.");
//        add("bestiary.terra_entity.betsy.desc", "A vicious Etherian dragon who leads the minions of the Old One's Army that found their way to this world.");
//        add("bestiary.terra_entity.etherian_lightning_bug.desc", "Lightning Bugs from Etheria aren't just named that for their pretty lights! These ones blast their foes with shocking bolts of electricity.");
//        add("bestiary.terra_entity.pirate_deadeye.desc", "Nobody knows if 'Dead Eye' refers to their precise aim, or the fact that one of their eyes is indeed 'dead'... like their targets.");
//        add("bestiary.terra_entity.pirate_deckhand.desc", "They are either washing the deck of their ship of seaweed and ale, or wiping the dirt with the faces of unsuspecting Terrarians.");
//        add("bestiary.terra_entity.pirate_crossbower.desc", "Some wee lasses aren't content staying at port waiting for their men to return from a raid, so they join in on the deadly fun!");
//        add("bestiary.terra_entity.pirate_corsair.desc", "Once mercenaries from a distant land, Corsairs brandish deadly scimitars with unyielding skill and a cut-throat agenda.");
//        add("bestiary.terra_entity.pirate_captain.desc", "A pirate captain's love for riches is only rivaled by his obsession with heavy gunpowder and large, rampart-shattering cannons!");
//        add("bestiary.terra_entity.parrot.desc", "A pirate's best friend, the parrot, will tear the eyes out of any greasy landlubber with its sharp, pointy talons.");
//        add("bestiary.terra_entity.flying_dutchman.desc", "When the pirates face strong opposition in their pillaging raids, they bring their majestic floating galleon as backup. Cannons away!");
//        add("bestiary.terra_entity.brain_scrambler.desc", "These Martian soldiers brandish crude laser weaponry that releases dangerous short-range radiation, hence the protective helmets.");
//        add("bestiary.terra_entity.ray_gunner.desc", "The elite specialists in the Martian Invasion Force are equipped with more precise and deadly laser rifles; effectively snipers.");
//        add("bestiary.terra_entity.martian_engineer.desc", "Martian soldiers who lack combat ability may instead be deployed for their mechanical aptitude, constructing turrets on the field.");
//        add("bestiary.terra_entity.martian_officer.desc", "Lacking offensive weaponry, officers in the Martian forces favor defensive measures to focus on relaying tactics to the soldiers.");
//        add("bestiary.terra_entity.gigazapper.desc", "Martians who show great potential in close combat are equipped with powerful energy spears that can atomize anything.");
//        add("bestiary.terra_entity.scutlix.desc", "Native to the Martian homeworld, these creatures function similarly to horses. That is, if horses could fire lasers from their eyes.");
//        add("bestiary.terra_entity.gray_grunt.desc", "Martians are conscripted into military service, and those who do not make the cut are sent out unarmed to distract the enemy as fodder.");
//        add("bestiary.terra_entity.martian_walker.desc", "A wonder of Martian technology constructed from the strongest metals and infused with biological components.");
//        add("bestiary.terra_entity.tesla_turret.desc", "Named after a historic Terrarian, these turrets are built by Martian engineers and rain devastating energy upon anyone nearby.");
//        add("bestiary.terra_entity.martian_drone.desc", "The data collected from these drones are sent back to the motherships moments before they self-destruct onto their foes.");
//        add("bestiary.terra_entity.scutlix_gunner.desc", "Elite Ray Gunners often ride these powerful alien creatures into battle as cavalry. If their mount dies, they will pursue on foot.");
//        add("bestiary.terra_entity.fritz.desc", "Rumors speak of a small-minded hunchback who assisted in mad science. This small fellow reacts unpredictably when approached.");
//        add("bestiary.terra_entity.frankenstein.desc", "Built from parts of deceased Terrarians, this stout monster resulted from a crazy man's desire to create life with his own hands.");
//        add("bestiary.terra_entity.creature_from_the_deep.desc", "Said to have emerged from the blackest lagoons, these fish-men lash at their victims with unmatched submerged mobility.");
//        add("bestiary.terra_entity.swamp_thing.desc", "Creeping from the depths of the darkest swamps, this algae-dripped beast desires to drown away anyone in his path.");
//        add("bestiary.terra_entity.dr_man_fly.desc", "Part man, part fly, all doctor. He's brought his most volatile and dangerous chemicals, and he's buzzing to try them out.");
//        add("bestiary.terra_entity.the_possessed.desc", "A Terrarian girl possessed by the most evil of spirits, she gains superhuman abilities and behaves both arbitrarily and violently.");
//        add("bestiary.terra_entity.psycho.desc", "This masked killer's quiet demeanor and cunning ability to hunt allows him to ambush his victims without being detected.");
//        add("bestiary.terra_entity.butcher.desc", "Soulless and cruel, this pig-masked psychotic killer brandishes a powerful chainsaw in which to dismember every living thing.");
//        add("bestiary.terra_entity.vampire.desc", "Whether he is a man who turns into a bat, or a bat who turns into a man, one thing is for sure: he's out for blood!");
//        add("bestiary.terra_entity.eyezor.desc", "A powerful zombie-like creature whose eye can see for miles, and blow away opponents with powerful lasers.");
//        add("bestiary.terra_entity.nailhead.desc", "An intelligent being who seeks out souls to steal, utilizing nails from his own body both as a weapon and as defensive measures.");
//        add("bestiary.terra_entity.reaper.desc", "The reaper's list stretches endlessly with the names of those who will soon depart this world. His sickle will make sure of that.");
//        add("bestiary.terra_entity.deadly_sphere.desc", "By means unknown, this silvery metamorphic sphere levitates about on its own. It moves about quickly, often producing spikes.");
//        add("bestiary.terra_entity.mothron.desc", "A behemoth of an insect attracted to the eerie anti-glow of a solar eclipse. With a rapid gestation period, it multiplies quickly.");
//        add("bestiary.terra_entity.baby_mothron.desc", "The creatures which burst from the eggs laid by mothron can be as deadly and as relentless as their daunting mothers.");
//        add("bestiary.terra_entity.scarecrow_cloth_face_stick.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.scarecrow_cloth_face.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.scarecrow_guy_fawkes_stick.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.scarecrow_guy_fawkes.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.scarecrow_cloth_hat_stick.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.scarecrow_cloth_hat.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.scarecrow_pumpkin_hat_stick.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.scarecrow_pumpkin_hat.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.scarecrow_pumpkin_head_stick.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.scarecrow_pumpkin_head.desc", "Possessed by vengeful spirits of the harvest, these scarecrows are out to cause mischief and mayhem galore.");
//        add("bestiary.terra_entity.splinterling.desc", "Mourning Woods reproduce by snapping cuttings from their bodies and thrusting them into the soil. Splinterlings are the result.");
//        add("bestiary.terra_entity.poltergeist.desc", "The intense hateful energies emanating from these spirits grant them the ability to move objects, truly for the purpose of killing.");
//        add("bestiary.terra_entity.hellhound.desc", "Most certainly not a good boy, this vicious demon dog is more than eager to guide living beings to the underworld with every bite.");
//        add("bestiary.terra_entity.headless_horseman.desc", "This menacing nightmare rides out into the night to harvest living souls on his seeing-eye horse, for he has no head of his own.");
//        add("bestiary.terra_entity.mourning_wood.desc", "These enormous murder trees nightmarishly stomp about, prepared to shower endless fiery destruction upon all life.");
//        add("bestiary.terra_entity.pumpking.desc", "A pumpkin has many faces. A pumpkin will murder all with many sharp blades. A pumpkin is king of the harvest.");
//        add("bestiary.terra_entity.zombie_elf_girl.desc", "Elves that used to work for Santa, but have since been zombified. They don't complain much, so they are still pretty good helpers.");
//        add("bestiary.terra_entity.zombie_elf.desc", "Elves that used to work for Santa, but have since been zombified. They don't complain much, so they are still pretty good helpers.");
//        add("bestiary.terra_entity.zombie_elf_beard.desc", "Elves that used to work for Santa, but have since been zombified. They don't complain much, so they are still pretty good helpers.");
//        add("bestiary.terra_entity.gingerbread_man.desc", "A gingerbread man seeking vengeance for his long-eaten brethren. He may look yummy, but this is one tough cookie.");
//        add("bestiary.terra_entity.elf_archer.desc", "These aren't your typical elven archers. Tinkering all year long, they are excited to gift you with the hottest new arrows this season.");
//        add("bestiary.terra_entity.nutcracker.desc", "Bringing his massive chompers to bear, the Nutcracker frolics through the wintery night. Nuts aren't the only thing he can crack.");
//        add("bestiary.terra_entity.krampus.desc", "Every year, Krampus is tasked to punish all of the naughty children, but he's taken the day off to participate in this mayhem instead!");
//        add("bestiary.terra_entity.yeti.desc", "An ill-tempered ape from cold, snowy regions to the north. They do not appreciate festivity, so they've come to spoil all the fun.");
//        add("bestiary.terra_entity.present_mimic.desc", "Surprise! The most unexpected gift this holiday season, the Present Mimic is a nicely gift-wrapped box of teeth and death.");
//        add("bestiary.terra_entity.everscream.desc", "If trees could scream, this evil evergreen would do so constantly. Deadly are the ornaments hurled from its branches.");
//        add("bestiary.terra_entity.ice_queen.desc", "If this icy towering monstrosity wishes for someone's soul, they'll surely let it go... right from their cold, dead hands.");
//        add("bestiary.terra_entity.santa_nk1.desc", "This jolly bad boy wants to stuff everyone's stockings with the gift of their entrails. This cranky Kringle's gone postal.");
//        add("bestiary.terra_entity.elf_copter.desc", "The elves aren't just flying toy helicopters, these are fully combat ready. All that inventing finally paid off!");
//        add("bestiary.terra_entity.flocko.desc", "These ferocious flakes are the frozen minions of the Ice Queen. Where this sinister snow falls, so shall her icy judgment.");
//        add("bestiary.terra_entity.slime_bunny_mask.desc", "Is it a slime in a bunny costume? Or is it a bunny in a slime costume? Halloween can be very confusing sometimes.");
        add("bestiary.terra_entity.demon_eye_spaceship.desc", "No one knows who dressed these demon eyes up in cute costumes, but the whole process hasn't made them any friendlier.");
        add("bestiary.terra_entity.demon_eye_owl_mask.desc", "No one knows who dressed these demon eyes up in cute costumes, but the whole process hasn't made them any friendlier.");
//        add("bestiary.terra_entity.zombie_doctor.desc", "Wearing costumes isn't fooling anyone; these zombies are clearly way too old to be trick or treating.");
//        add("bestiary.terra_entity.zombie_superman.desc", "Wearing costumes isn't fooling anyone; these zombies are clearly way too old to be trick or treating.");
//        add("bestiary.terra_entity.zombie_pixie.desc", "Wearing costumes isn't fooling anyone; these zombies are clearly way too old to be trick or treating.");
//        add("bestiary.terra_entity.skeleton_astronaut.desc", "Skeletons need to wear very elaborate costumes during Halloween, or else people think they are dressing up as skeletons.");
//        add("bestiary.terra_entity.skeleton_alien.desc", "Skeletons need to wear very elaborate costumes during Halloween, or else people think they are dressing up as skeletons.");
//        add("bestiary.terra_entity.skeleton_top_hat.desc", "Skeletons need to wear very elaborate costumes during Halloween, or else people think they are dressing up as skeletons.");
//        add("bestiary.terra_entity.slime_red_present_slime.desc", "A perfectly gift wrapped bundle of slime. A wonderfully deadly present for any festive occasion.");
//        add("bestiary.terra_entity.slime_yellow_present_slime.desc", "A perfectly gift wrapped bundle of slime. A wonderfully deadly present for any festive occasion.");
//        add("bestiary.terra_entity.slime_white_present_slime.desc", "A perfectly gift wrapped bundle of slime. A wonderfully deadly present for any festive occasion.");
//        add("bestiary.terra_entity.slime_green_present_slime.desc", "A perfectly gift wrapped bundle of slime. A wonderfully deadly present for any festive occasion.");
//        add("bestiary.terra_entity.zombie_xmas.desc", "Even zombies can celebrate the holidays. Their festive outfits are just right, but their holiday spirit could use some work.");
//        add("bestiary.terra_entity.zombie_sweater.desc", "Even zombies can celebrate the holidays. Their festive outfits are just right, but their holiday spirit could use some work.");
//        add("bestiary.terra_entity.snowman_gangsta.desc", "While the world's inhabitants celebrate festivities, gangster snowmen party by slaying everyone with their tommy guns.");
//        add("bestiary.terra_entity.snow_balla.desc", "Nobody underestimates the throwing arm on this disturbed member of the snowman mafioso. He's a real slugger!");
//        add("bestiary.terra_entity.mister_stabby.desc", "This stone-cold, yet maniacal gangster never snuffs the celebrating do-gooders without bringing along his 'Lil' Pokey'.");
//        add("bestiary.terra_entity.predictor.desc", "The cosmic power held by these humanoid warriors grant them psychic abilities, in which they use to accurately shoot down foes.");
//        add("bestiary.terra_entity.evolution_beast.desc", "Celestial power fuels the aggression of these violent beasts, allowing them to run down those who trespass the pillar's area.");
//        add("bestiary.terra_entity.brain_suckler.desc", "These psionic, squid-like beasts levitate with celestial energy and latch onto the head of their prey, disrupting brain functions.");
//        add("bestiary.terra_entity.nebula_floater.desc", "These brain-like celestial beings have psionic capabilities, phasing through space and summoning powerful optical minions.");
//        add("bestiary.terra_entity.drakomire.desc", "These celestial beasts harness the power of the sun, releasing violent flares towards any intruders nearing the pillar.");
//        add("bestiary.terra_entity.selenian.desc", "These acrobatic celestial warriors can deflect incoming threats whilst spinning with their solar-infused blades.");
//        add("bestiary.terra_entity.drakanian.desc", "These highly aggressive celestial soldiers carry a large, fiery spear that can melt nearly anything it penetrates.");
//        add("bestiary.terra_entity.crawltipede.desc", "Wrapped in celestial energy, this worm-like creature seems invincible. Having no eyes, it seeks vibrations throughout the air.");
//        add("bestiary.terra_entity.sroller.desc", "These humanoid celestial monsters assault their foes by rolling up into a ball and charging them with their sharp, fiery spikes.");
//        add("bestiary.terra_entity.corite.desc", "Resembling a large, sentient meteorite, Corites are infused with celestial energy and will charge at anything that moves.");
//        add("bestiary.terra_entity.drakomire_rider.desc", "Many drakanians ride the beastly Drakomires as a form of battle steed. Should the Drakomire be slain, they will pursue on foot.");
//        add("bestiary.terra_entity.alien_larva.desc", "The larval stage of the alien hornets. They may seem weak and harmless, but if ignored they will evolve into powerful beings.");
//        add("bestiary.terra_entity.alien_hornet.desc", "These flying insectoids utilize wormholes to ambush intruders near the celestial pillars. They hunt in pairs and may swiftly evolve.");
//        add("bestiary.terra_entity.vortexian.desc", "The cosmic energy surging through these warriors builds up until their untimely demise, resulting in an explosion of lightning.");
//        add("bestiary.terra_entity.storm_diver.desc", "These alien soldiers carry a versatile arsenal of celestial rifles and cosmic accessories that allow them to defy gravity.");
//        add("bestiary.terra_entity.alien_queen.desc", "The final evolutionary stage of the alien hornet. They fire powerful disruptive energy at their prey, and give birth to many larvae.");
//        add("bestiary.terra_entity.stargazer.desc", "This slow-moving celestial soldier fires cosmic rays at unsuspecting invaders, defending the pillar without hesitation.");
//        add("bestiary.terra_entity.twinkle_popper.desc", "This beastly celestial arachnid rapidly spawns swift and relentless offspring to distract its prey as it prepares to devour them.");
//        add("bestiary.terra_entity.milkyway_weaver.desc", "The celestial energies of which this worm is born give its body and tail near unstoppable power as it twists through the skies.");
//        add("bestiary.terra_entity.star_cell.desc", "A biological single-celled organism that divides and multiplies rapidly with the limitless power of celestial energy.");
//        add("bestiary.terra_entity.mini_star_cell.desc", "A biological single-celled organism that divides and multiplies rapidly with the limitless power of celestial energy.");
//        add("bestiary.terra_entity.flow_invader.desc", "A cosmic jellyfish-type creature infused with abundant celestial energies which summons smaller minions to serve as its weaponry.");
//        add("bestiary.terra_entity.martian_saucer.desc", "An advanced flying saucer from somewhere well beyond this world. The destruction from its weaponry is unimaginable.");
//        add("bestiary.terra_entity.the_torch_god.desc", "An unseen deity responsible for a torch's eternal flicker, however easily angered by the unsightly, ungrateful abuse of torch placement.");
        add("bestiary.terra_entity.eye_of_cthulhu.desc", "A piece of Cthulhu ripped from his body centuries ago in a bloody war. It wanders the night seeking its host body... and revenge!");
        add("bestiary.terra_entity.servant_of_cthulhu.desc", "Young Demon Eyes newly birthed from the Eye of Cthulhu, brought forth to protect their master by any means necessary.");
        add("bestiary.terra_entity.king_slime.desc", "Slimes normally aren't intelligent, but occasionally they merge together to become a powerful force to swallow all things.");
        add("bestiary.terra_entity.eater_of_worlds.desc", "Conceived from the bottomless malice of the Corruption, this mighty abyssal worm tunnels wildly to devour all in its path.");
        add("bestiary.terra_entity.brain_of_cthulhu.desc", "A piece of Cthulhu torn asunder, this vile mastermind pulses with agony and aids the Crimson in an attempt to avenge its master.");
        add("bestiary.terra_entity.visual_neuron.desc", "Manipulated through the hive mind of the Crimson, Visual Neuron serve as the brain's eyes and orbit around it for defense in numbers.");
        add("bestiary.terra_entity.skeletron.desc", "The disembodied bones of a former tyrant pulsed with a hatred so strong, it left behind a mighty curse which guards the Dungeon.");
        add("bestiary.terra_entity.queen_bee.desc", "This highly aggressive monstrosity responds violently when her larva is disturbed; the honey-laden hives are her home turf.");
        add("bestiary.terra_entity.wall_of_flesh.desc", "Serving as the world's core and guardian, the towering demon lord exists to keep powerful ancient spirits sealed away.");
        add("bestiary.terra_entity.leech.desc", "A worm-like parasite spit forth from the Wall of Flesh, filled with the lifeblood of its host. This blood has healing properties.");
        add("bestiary.terra_entity.the_hungry_attached.desc", "The Wall of Flesh's many mouths, attached by bloody veins. As a last resort, they can tear away and hungrily chase down threats.");
        add("bestiary.terra_entity.the_hungry_flying.desc", "The Wall of Flesh's many mouths, attached by bloody veins. As a last resort, they can tear away and hungrily chase down threats.");
//        add("bestiary.terra_entity.queen_slime.desc", "Hallowed slimes consolidated into a haughty, crushing force adorned in dazzling crystals. She is rumored to grow wings.");
//        add("bestiary.terra_entity.crystal_slime.desc", "The blue-spectrumed crystal slimes specialize in growing and ejecting pointed crystal shards from their gelatinous bodies.");
//        add("bestiary.terra_entity.bouncy_slime.desc", "On the pink side of the crystal spectrum, these crystal slimes pop off tumor-like gel growths to assault their enemies.");
//        add("bestiary.terra_entity.heavenly_slime.desc", "Crystal slimes on the purple spectrum grow wings much like their royal creator, becoming aerial threats.");
//        add("bestiary.terra_entity.retinazer.desc", "Belonging to a pair of mechanically recreated Eyes of Cthulhu, this one focuses its energy into firing powerful lasers.");
//        add("bestiary.terra_entity.spazmatism.desc", "Belonging to a pair of mechanically recreated Eyes of Cthulhu, this one chases at high speed, exhaling cursed flames.");
//        add("bestiary.terra_entity.the_destroyer.desc", "A mechanical simulacrum of Cthulhu's spine decorated in laser-armed probes, which detach from its body when damaged.");
//        add("bestiary.terra_entity.probe.desc", "A singular probe detached from the Destroyer's body serves as a remote laser battery, often in a swarm of other probes.");
//        add("bestiary.terra_entity.skeletron_prime.desc", "Mechanically reconstructed for reviving Cthulhu, this Skeletron has more arms than ever before, and a variety of fierce weapons.");
//        add("bestiary.terra_entity.plantera.desc", "A dormant, yet powerful floral guardian awoken by the fallout of Cthulhu's destroyed machinations. Its reach spans the entire jungle.");
//        add("bestiary.terra_entity.empress_of_light.desc", "Beneath the Hallow's cleansing blanket lies a vengeful fae goddess bent on scrubbing the land of any and all impurity.");
//        add("bestiary.terra_entity.golem.desc", "A remarkable display of ingenuity constructed by the Lihzahrd clan. Powered by solar energy cells, it is ready to guard the Temple.");
//        add("bestiary.terra_entity.duke_fishron.desc", "An aquatic pigron mutation from the depths of the ocean who surfaces in search of a rare, savory type of worm.");
//        add("bestiary.terra_entity.sharkron.desc", "Duke Fishron's nature as a form of chimera causes his offspring to emerge more shark-like, which he uses as minions in battle.");
//        add("bestiary.terra_entity.lunatic_cultist.desc", "A fanatical leader hell-bent on bringing about the apocalypse by reviving the great Cthulhu through behind-the-scenes scheming.");
//        add("bestiary.terra_entity.lunatic_devotee.desc", "Utterly devoted, Lunatic Devotees unfailingly worship their deity, even when threatened with death. Fear only makes them worship harder.");
//        add("bestiary.terra_entity.blue_cultist_archer.desc", "Sworn to protect the cultist's ritual, these robed archers will fight to the death defending the lunatic devotees.");
//        add("bestiary.terra_entity.ancient_vision.desc", "A vision of a deadly omen wrought forth by a powerful cultist, often appears with reckless cosmic summoning of wyvern spirits.");
//        add("bestiary.terra_entity.phantasm_dragon.desc", "Wyvern souls are entwined in the atmosphere of the world. Powerful magicks can summon them through the veil with physical form.");
//        add("bestiary.terra_entity.nebula_pillar.desc", "Representing a stormy celestial body known as 'nebula', this tower holds the seal locking away a terrifying tyrant.");
//        add("bestiary.terra_entity.solar_pillar.desc", "Representing a flaming celestial event known as 'solar flares', this tower holds the seal locking away a terrifying tyrant.");
//        add("bestiary.terra_entity.vortex_pillar.desc", "Representing a deep celestial void known as 'vortex', this tower holds the seal locking away a terrifying tyrant.");
//        add("bestiary.terra_entity.stardust_pillar.desc", "Representing a glittering celestial remnant known as 'stardust', this tower holds the seal locking away a terrifying tyrant.");
//        add("bestiary.terra_entity.moon_lord.desc", "The mastermind behind all terrors which befall the world, freed from his lunar prison. Practically a god, his power knows no limits.");
