...
public class StreamstrikeHalberdItem extends AbstractSpearItem {
    public StreamstrikeHalberdItem() {
        super(new Properties().attributes(PortItemAttributeModifiers.builder()
                .add(IPortAttributesExtension.entityInteractionRange(), new PortAttributeModifier(ModItems.BASE_ENTITY_INTERACTION_RANGE_ID, 6, PortAttributeModifier.Operation.ADD_VALUE), PortEquipmentSlotGroup.MAINHAND)
                ...
                .add(IPortAttributesExtension.swimSpeed(), new PortAttributeModifier(Confluence.asResource("base_swim_speed"), 0.5, PortAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL), PortEquipmentSlotGroup.MAINHAND)
