...
public class HoneyBombEntityRenderer extends BombEntityRenderer<LiquidBombEntity> {
    ...
    public HoneyBombEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new HoneyBombEntityModel(pContext.bakeLayer(HoneyBombEntityModel.LAYER_LOCATION));
    }
