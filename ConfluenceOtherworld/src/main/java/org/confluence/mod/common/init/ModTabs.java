    ...
    public static final RegistryObject<CreativeModeTab> ENTITY = TABS.register("entity",
            () -> CreativeModeTab.builder().icon(IconItems.ENTITY_ICON::toStack)
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(SpawnEggItems.GNOME_SPAWN_EGG.get());
                        ...
                        water.accept(SpawnEggItems.GOLDFISH_SPAWN_EGG.get());
                        water.accept(SpawnEggItems.MYSTIC_FROG_SPAWN_EGG.get());
                        water.accept(SpawnEggItems.CORRUPT_GOLDFISH_SPAWN_EGG.get());
                        water.accept(SpawnEggItems.VICIOUS_GOLDFISH_SPAWN_EGG.get());
                        water.accept(SpawnEggItems.ANGLER_FISH_SPAWN_EGG.get());
                        ...
                        water.accept(SpawnEggItems.BLOOD_JELLY_SPAWN_EGG.get());
                        water.accept(SpawnEggItems.FUNGO_FISH_SPAWN_EGG.get());
                        ...
                        misc.accept(SpawnEggItems.THE_GROOM_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.THE_BRIDE_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.ZOMBIE_MERMAN_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.GRANITE_ELEMENTAL_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.GRANITE_GOLEM_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.HOPLITE_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.ANGRY_DANDELION_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.ANGRY_TUMBLER_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.SAND_SHARK_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.BONE_BITER_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.FLESH_REAVER_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.CRYSTAL_THRESHER_SPAWN_EGG.get());
                        misc.accept(SpawnEggItems.ANGRY_NIMBUS_SPAWN_EGG.get());
