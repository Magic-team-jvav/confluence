...
public class FossilSet extends EquipmentSet {
    ...
    protected void init(HookMap.Builder hook, EquippableGroup.Builder equippableGroup) {
        equippableGroup.addEquippableSet("helmet", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaWearable.HEAD, ArmorItems.FOSSIL_HELMET)
        ...
        equippableGroup.addEquippableSet("chestplate", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaWearable.CHEST, ArmorItems.FOSSIL_CHESTPLATE)
        ...
        equippableGroup.addEquippableSet("leggings", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaWearable.LEGS, ArmorItems.FOSSIL_LEGGINGS)
        ...
        equippableGroup.addEquippableSet("boots", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaWearable.FEET, ArmorItems.FOSSIL_BOOTS)
        ...
        equippableGroup.addEquippableSet("full_set", new EquipmentSetBranch.Builder()
                .addEquippable(
                        VanillaWearable.HEAD, ArmorItems.FOSSIL_HELMET,
                        VanillaWearable.CHEST, ArmorItems.FOSSIL_CHESTPLATE,
                        VanillaWearable.LEGS, ArmorItems.FOSSIL_LEGGINGS,
                        VanillaWearable.FEET, ArmorItems.FOSSIL_BOOTS
                )
