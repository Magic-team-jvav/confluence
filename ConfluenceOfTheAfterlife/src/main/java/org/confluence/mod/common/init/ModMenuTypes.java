...
public final class ModMenuTypes {
    ...
    public static final Supplier<MenuType<FletchingTableMenu>> FLETCHING = TYPES.register("fletching", () -> new MenuType<>(FletchingTableMenu::new, FeatureFlags.VANILLA_SET));
}
