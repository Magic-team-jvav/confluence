...
public class BestiaryEntry {
    public static final Codec<BestiaryEntry> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Coins.CODEC.fieldOf("coins").forGetter(BestiaryEntry::getCoins)
    ...
    public static final StreamCodec<ByteBuf, BestiaryEntry> STREAM_CODEC = LibStreamCodecUtils.composite(
            ...
            Coins.STREAM_CODEC, BestiaryEntry::getCoins,
            BestiaryEntry::new
    );
    ...
    private BestiaryEntry(EntityType<?> type, int killedByCount, float maxHealth, float knockbackResistance, float attackDamage, float armor, Coins coins) {
        this.type = type;
