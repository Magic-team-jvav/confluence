...
public record ChestSubProvider(HolderLookup.Provider registries) implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        output.accept(Confluence.asResourceKey(Registries.LOOT_TABLE, "chests/frozen_chests"), LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool()
                        .add(LootItem.lootTableItem(ToolItems.ICE_MIRROR).setWeight(1))
        ...
        output.accept(Confluence.asResourceKey(Registries.LOOT_TABLE, "chests/initial_world_underground_chest"), LootTable.lootTable()
                ...
                // 缺天使雕像
                .withPool(LootPool.lootPool()
                        .add(LootItem.lootTableItem(ModBlocks.ROPE).apply(SetItemCountFunction.setCount(UniformGenerator.between(50, 100))).setWeight(1))
                        .add(EmptyLootItem.emptyItem().setWeight(4))
                )
                .withPool(LootPool.lootPool()
                .add(LootItem.lootTableItem(MaterialItems.LEAD_INGOT).apply(SetItemCountFunction.setCount(UniformGenerator.between(4, 7))).setWeight(1))
                .add(LootItem.lootTableItem(MaterialItems.SILVER_INGOT).apply(SetItemCountFunction.setCount(UniformGenerator.between(4, 7))).setWeight(1))
                .add(LootItem.lootTableItem(MaterialItems.TUNGSTEN_INGOT).apply(SetItemCountFunction.setCount(UniformGenerator.between(4, 7))).setWeight(1))
                .add(LootItem.lootTableItem(Items.IRON_INGOT).apply(SetItemCountFunction.setCount(UniformGenerator.between(4, 7))).setWeight(1))
                .add(EmptyLootItem.emptyItem().setWeight(4))
                )
                .withPool(LootPool.lootPool()
                        .add(LootItem.lootTableItem(ConsumableItems.SHURIKEN).apply(SetItemCountFunction.setCount(UniformGenerator.between(25, 49))).setWeight(1))
                        .add(LootItem.lootTableItem(Items.ARROW).apply(SetItemCountFunction.setCount(UniformGenerator.between(25, 49))).setWeight(1))
                        .add(EmptyLootItem.emptyItem().setWeight(2))
                )
                .withPool(LootPool.lootPool()
                        .add(LootItem.lootTableItem(PotionItems.LESSER_HEALING_POTION).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 5))).setWeight(1))
                ...
                .withPool(LootPool.lootPool()
                       .add(LootItem.lootTableItem(Items.TORCH).apply(SetItemCountFunction.setCount(UniformGenerator.between(10, 20))).setWeight(1))
                        .add(EmptyLootItem.emptyItem().setWeight(1))
                )
                .withPool(LootPool.lootPool()
                ...
                .withPool(LootPool.lootPool()
                        .add(LootItem.lootTableItem(ModItems.SILVER_COIN).apply(SetItemCountFunction.setCount(UniformGenerator.between(50, 89))).setWeight(1))
                        .add(EmptyLootItem.emptyItem().setWeight(1))
                )
        );
    }
