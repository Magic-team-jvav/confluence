...
/// 花之力发射的直线花瓣。
public final class FlowerPowerPetalProjectile extends FlailAuxiliaryProjectile {
    public FlowerPowerPetalProjectile(EntityType<? extends FlowerPowerPetalProjectile> type, Level level) {
        super(type, level);
        setNoGravity(true);
    }
