    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        output.accept(Confluence.asResourceKey(Registries.LOOT_TABLE, "gameplay/slime_carry"), LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(ModItems.GOLDEN_COIN).setWeight(56).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2))))
        ...
        output.accept(Confluence.asResourceKey(Registries.LOOT_TABLE, "gameplay/extract/with_gravel"), LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool()
                        .add(LootItem.lootTableItem(ModItems.SILVER_COIN).apply(count1To4).setWeight(13534))
