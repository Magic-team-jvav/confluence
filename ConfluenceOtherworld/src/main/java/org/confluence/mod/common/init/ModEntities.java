...
public final class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<RainbowProjectile>> RAINBOW_PROJECTILE = ENTITIES.register("rainbow_projectile", id -> EntityType.Builder.<RainbowProjectile>of(RainbowProjectile::new, MobCategory.MISC).sized(0.5F, 0.5F).updateInterval(1).build(id.toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<SkyFractureProjectile>> SKY_FRACTURE_PROJECTILE = ENTITIES.register("sky_fracture_projectile", id -> EntityType.Builder.<SkyFractureProjectile>of(SkyFractureProjectile::new, MobCategory.MISC).sized(0.5F, 0.5F).build(id.toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<CrystalChargeProjectile>> CRYSTAL_CHARGE_1_PROJECTILE = ENTITIES.register("crystal_charge_1_projectile", id -> EntityType.Builder.<CrystalChargeProjectile>of(CrystalChargeProjectile::new, MobCategory.MISC).sized(0.5F, 0.5F).build(id.toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<CrystalChargeProjectile>> CRYSTAL_CHARGE_2_PROJECTILE = ENTITIES.register("crystal_charge_2_projectile", id -> EntityType.Builder.<CrystalChargeProjectile>of(CrystalChargeProjectile::new, MobCategory.MISC).sized(0.25F, 0.25F).build(id.toString()));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SporeCloudProjectile>> SPORE_CLOUD_PROJECTILE = ENTITIES.register("spore_cloud_projectile", id -> EntityType.Builder.of(SporeCloudProjectile::new, MobCategory.MISC).sized(0.75F, 0.75F).clientTrackingRange(64).updateInterval(1).build(id.toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<NorthPoleProjectile>> NORTH_POLE_PROJECTILE = ENTITIES.register("north_pole_projectile", id -> EntityType.Builder.of(NorthPoleProjectile::new, MobCategory.MISC).sized(0.75F, 0.75F).clientTrackingRange(6).fireImmune().build(id.toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<NorthPoleSubProjectile>> NORTH_POLE_SUB_PROJECTILE = ENTITIES.register("north_pole_sub_projectile", id -> EntityType.Builder.of(NorthPoleSubProjectile::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(64).updateInterval(1).build(id.toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<MushroomProjectile>> MUSHROOM_PROJECTILE = ENTITIES.register("mushroom_projectile", id -> EntityType.Builder.of(MushroomProjectile::new, MobCategory.MISC).sized(0.75F, 0.75F).clientTrackingRange(6).fireImmune().build(id.toString()));
    public static final DeferredHolder<EntityType<?>, EntityType<GhastlyProjectile>> GHASTLY_PROJECTILE = ENTITIES.register("ghastly_projectile", id -> EntityType.Builder.of(GhastlyProjectile::new, MobCategory.MISC).sized(2.5F, 2.5F).clientTrackingRange(6).fireImmune().build(id.toString()));
