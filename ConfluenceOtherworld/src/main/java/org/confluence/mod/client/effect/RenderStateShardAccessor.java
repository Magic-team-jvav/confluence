...
public class RenderStateShardAccessor extends RenderStateShard {
    ...
    public static RenderType getEntityTranslucentEmissive() {
        return RenderType.create("entity_translucent_emissive", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS, 1536, true, false,
                RenderType.CompositeState.builder()
