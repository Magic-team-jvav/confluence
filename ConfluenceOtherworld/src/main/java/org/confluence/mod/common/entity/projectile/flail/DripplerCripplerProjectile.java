 ...
 */
public final class DripplerCripplerProjectile
    ...
    public DripplerCripplerProjectile(
            EntityType<? extends DripplerCripplerProjectile> type,
            Level level
    ) {
        super(type, level);
    }
    ...
    protected boolean onHitBlockAndContinue(BlockHitResult hit) {
        ...
        setPos(hit.getLocation().add(
                Vec3.atLowerCornerOf(direction.getNormal()).scale(0.05)));
        return true;
    }
