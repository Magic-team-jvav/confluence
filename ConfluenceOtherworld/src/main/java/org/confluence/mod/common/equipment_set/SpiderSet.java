...
public class SpiderSet extends EquipmentSet {
    ...
    protected void init(HookMap.Builder hook, EquippableGroup.Builder equippableGroup) {
        equippableGroup.addEquippableSet("helmet", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaWearable.HEAD, ArmorItems.SPIDER_HELMET)
        ...
        equippableGroup.addEquippableSet("chestplate", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaWearable.CHEST, ArmorItems.SPIDER_CHESTPLATE)
                .bindHook(builder -> builder
        ...
        equippableGroup.addEquippableSet("leggings", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaWearable.LEGS, ArmorItems.SPIDER_LEGGINGS)
        ...
        equippableGroup.addEquippableSet("boots", new EquipmentSetBranch.Builder()
                .addEquippable(VanillaWearable.FEET, ArmorItems.SPIDER_BOOTS)
        ...
        equippableGroup.addEquippableSet("full_set", new EquipmentSetBranch.Builder()
                .addEquippable(
                        VanillaWearable.HEAD, ArmorItems.SPIDER_HELMET,
                        VanillaWearable.CHEST, ArmorItems.SPIDER_CHESTPLATE,
                        VanillaWearable.LEGS, ArmorItems.SPIDER_LEGGINGS,
                        VanillaWearable.FEET, ArmorItems.SPIDER_BOOTS
                )
