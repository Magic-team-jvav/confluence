...
public class ModRecipeProvider extends AbstractRecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> writer, HolderLookup.Provider provider) {
        ...
        workshop(writer, AccessoryItems.SHINY_PIPETTE.toStack(), Ingredient.of(AccessoryItems.EXPERIENCE_PIPETTE), Ingredient.of(AccessoryItems.TINSEL)); // 闪亮吸管 = 经验吸管 + 金箔
        ...
        fletchingTable(writer, ArrowItems.FROSTBURN_ARROW.toStack(64), Ingredient.of(), AmountIngredient.of(64, Items.ARROW), Ingredient.of(MaterialItems.WINTER_MARROW));
