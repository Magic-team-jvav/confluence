...
// 杂项
        ...
        add("itemGroup.confluence.boss_summons", "Boss 召唤物");
        add("itemGroup.confluence.environment_items", "环境物品");
        add("itemGroup.confluence.stat_boosters", "属性提升");
        add("itemGroup.confluence.loot_gifts", "战利品与礼物");
        add("itemGroup.confluence.consumable_special", "特殊消耗品");
        add("itemGroup.confluence.books_accessories", "书籍与饰品");
// 工具
        add("itemGroup.confluence.rope", "绳索");
        ...
        add("itemGroup.confluence.nets_ropes", "网与绳索");
        add("itemGroup.confluence.sponges", "海绵");
        add("itemGroup.confluence.utility_tools", "实用工具");
        add("itemGroup.confluence.guide_books", "指南书籍");
        ...
        add("itemGroup.confluence.robe_misc_wear", "长袍与杂项装束");
        add("itemGroup.confluence.dead_mans_sweater", "死者毛衣");
        add("itemGroup.confluence.robe_vanity", "虚荣长袍");
        add("itemGroup.confluence.top_hat_set", "礼帽套装");
        add("itemGroup.confluence.tuxedo_set", "燕尾服套装");
        add("itemGroup.confluence.summer_hat", "夏日帽子");
        add("itemGroup.confluence.bunny_hood", "兔子兜帽");
        ...
        add("itemGroup.confluence.clothiers_set", "裁缝套装");
        add("itemGroup.confluence.robot_hat", "机器人帽子");
        add("itemGroup.confluence.familiar_set", "幽灵套装");
        add("itemGroup.confluence.mime_mask", "默剧面具");
        ...
        add("itemGroup.confluence.gold_crown", "金皇冠");
        add("itemGroup.confluence.platinum_crown", "铂皇冠");
        add("itemGroup.confluence.all_dyes", "所有染料");
