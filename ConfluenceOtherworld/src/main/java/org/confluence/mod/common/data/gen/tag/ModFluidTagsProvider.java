...
public class ModFluidTagsProvider extends FluidTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(PortTags.Fluids.HONEY).add(ModFluids.HONEY.fluid().get(), ModFluids.HONEY.flowing().get());
        tag(ModTags.Fluids.SHIMMER).add(ModFluids.SHIMMER.fluid().get(), ModFluids.SHIMMER.flowing().get());

        // 钓鱼判定接受水、熔岩、蜂蜜和微光；not_lava 则明确排除熔岩。
        tag(ModTags.Fluids.FISHING_ABLE).addTags(FluidTags.WATER, FluidTags.LAVA, PortTags.Fluids.HONEY, ModTags.Fluids.SHIMMER);
        tag(ModTags.Fluids.NOT_LAVA).addTags(FluidTags.WATER, PortTags.Fluids.HONEY, ModTags.Fluids.SHIMMER);
