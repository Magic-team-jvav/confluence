...
public abstract class GrenadeEntityRenderer<E extends BaseGrenadeEntity> extends EntityRenderer<E> {
    public GrenadeEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
