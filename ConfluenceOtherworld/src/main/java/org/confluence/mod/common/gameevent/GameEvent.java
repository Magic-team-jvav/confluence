...
public interface GameEvent {
    ...
    PortStreamCodec<ByteBuf, ResourceKey<? extends GameEvent>> KEY_STREAM_CODEC = (PortStreamCodec<ByteBuf, ResourceKey<? extends GameEvent>>) (PortStreamCodec) IPortResourceKeyExtension.streamCodec(REGISTRY_KEY);
