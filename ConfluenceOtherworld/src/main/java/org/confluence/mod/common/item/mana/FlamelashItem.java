...
public class FlamelashItem extends ManaStaffItem<FlamelashProjectile> {
    ...
    @Override
    protected void beforeShoot(ServerPlayer player, ItemStack itemStack, FlamelashProjectile projectile) {
    ...
    @Override
    protected void afterShoot(ServerPlayer player, ItemStack itemStack, FlamelashProjectile projectile) {
        player.level().playSound(null, player.getX(), player.getEyeY(), player.getZ(), getShootSound(), SoundSource.PLAYERS, 1.0F, 1.0F);
    }

    @Override
    protected void rayTrace(ServerPlayer player, ItemStack itemStack, FlamelashProjectile projectile) {}
