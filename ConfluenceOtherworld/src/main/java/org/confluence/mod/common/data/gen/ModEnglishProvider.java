...
public class ModEnglishProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addPotion(PotionItems.ALE.get(), "Increases melee ability, decreases defense");
        ...
        addPotion(PotionItems.GRAVITATION_POTION.get(), "Allows gravity control");
        addPotion(PotionItems.SHINE_POTION.get(), "Emits an aura");
        ...
        addPotion(PotionItems.BUILDER_POTION.get(), "Increases placement speed and expands placement range");
        addPotion(PotionItems.ENDURANCE_POTION.get(), "Reduces damage taken by 10%");
        addPotion(PotionItems.INFERNO_POTION.get(), "Ignites nearby enemies");
        addPotion(PotionItems.LIFEFORCE_POTION.get(), "Increases maximum health by 20%");
        addPotion(PotionItems.FISHING_POTION.get(), "Increases fishing power by 15");
        addPotion(PotionItems.RAGE_POTION.get(), "Increases critical strike chance by 10%");
        addPotion(PotionItems.MANA_REGENERATION_POTION.get(), "Increases mana regeneration speed");
        addPotion(PotionItems.THORNS_POTION.get(), "Attacker also takes damage");
        addPotion(PotionItems.MAGIC_POWER_POTION.get(), "Increases magic damage by 20%");
        addPotion(PotionItems.OBSIDIAN_SKIN_POTION.get(), "Immune to lava");
        addPotion(PotionItems.LESSER_LUCK_POTION.get(), "Increases the user's luck");
        addPotion(PotionItems.LUCK_POTION.get(), "Increases the user's luck");
        addPotion(PotionItems.GREATER_LUCK_POTION.get(), "Increases the user's luck");
        addPotion(PotionItems.LOVE_POTION.get(), "Throwing this makes people fall in love (or enables animal breeding)");
        addPotion(PotionItems.SWIFTNESS_POTION.get(), "Increases movement speed by 25%");
        addPotion(PotionItems.REGENERATION_POTION.get(), "Provides health regeneration");
        addPotion(PotionItems.FLIPPER_POTION.get(), "Allows fast movement in liquids");
        addPotion(PotionItems.ARCHERY_POTION.get(), "Increases bow damage by 10% and arrow speed by 20%");
        addPotion(PotionItems.HEART_REACH_POTION.get(), "Expands the pickup range of health hearts");
        addPotion(PotionItems.GILLS_POTION.get(), "Allows breathing underwater");
        addPotion(PotionItems.INVISIBILITY_POTION.get(), "Grants invisibility");
        addPotion(PotionItems.WORMHOLE_POTION.get(), "Teleports the player to a teammate's location when clicking the teammate's icon on the map.");
        addPotion(PotionItems.MINING_POTION.get(), "Increases mining speed by 25%");
        addPotion(PotionItems.RECALL_POTION.get(), "Teleports the player to their spawn point.");
        addPotion(PotionItems.NIGHT_OWL_POTION.get(), "Grants night vision");
        addPotion(PotionItems.WATER_WALKING_POTION.get(), "Allows walking on water");
        addPotion(PotionItems.FEATHERFALL_POTION.get(), "Slows falling speed");
        addPotion(PotionItems.RANDOM_TELEPORT_POTION.get(), "Teleports the player to a random location in the world.");
        addPotion(PotionItems.SPELUNKER_POTION.get(), "Reveals the location of treasures and ores; press Tab for detailed information");
        addPotion(PotionItems.DANGERSENSE_POTION.get(), "Reveals nearby danger sources; press Tab for detailed information");
        addPotion(PotionItems.HUNTER_POTION.get(), "Reveals enemy locations");
        addPotion(PotionItems.CRATE_POTION.get(), "Increases the chance of obtaining crates");
        addPotion(PotionItems.CHAOS_POTION.get(), "Grants random effects");
        addPotion(PotionItems.STINK_POTION.get(), "Throwing this makes people smell disgusting");
        addPotion(PotionItems.AMMO_RESERVATION_POTION.get(), "20% chance to save ammo");
        addPotion(PotionItems.SUMMONING_POTION.get(), "Increases maximum minion count by 1");
        ...
        addPotion(PotionItems.FLASK_OF_FIRE.get(), "Melee and whip attacks ignite enemies");
        ...
        addEffect(ModEffects.MANA_SICKNESS.get(), "Decreases magic damage");
        addEffect(ModEffects.SHINE.get(), "Emits an aura");
        ...
        addEffect(ModEffects.ENDURANCE.get(), "Reduces damage taken by 10%");
        addEffect(ModEffects.INFERNO.get(), "Nearby enemies are ignited");
        addEffect(ModEffects.LIFE_FORCE.get(), "Increases maximum health by 20%");
        addEffect(ModEffects.THORNS.get(), "Attacker also takes damage");
        addEffect(ModEffects.TITAN.get(), "Increases knockback");
        addEffect(ModEffects.WRATH.get(), "Increases damage by 10%");
        addEffect(ModEffects.BUILDER.get(), "Increases placement speed and expands placement range");
        addEffect(ModEffects.BLEEDING.get(), "Prevents health regeneration");
        addEffect(ModEffects.SILENCED.get(), "Cannot use mana-consuming items");
        addEffect(ModEffects.CURSED.get(), "Cannot use any items");
        addEffect(ModEffects.WITHERED_ARMOR.get(), "Your armor is degraded! Defense reduced by half");
        addEffect(ModEffects.ICHOR.get(), "Decreases defense");
        addEffect(ModEffects.POTION_SICKNESS.get(), "Cannot use healing items");
        addEffect(ModEffects.BLOOD_BUTCHERED.get(), "Continuous health loss");
        addEffect(ModEffects.TENTACLE_SPIKES.get(), "Continuous health loss");
        addEffect(ModEffects.BROKEN_ARMOR.get(), "Defense reduced by half");
        addEffect(ModEffects.STONED.get(), "You are completely petrified!");
        addEffect(ModEffects.CRATE.get(), "Higher chance of catching crates while fishing");
        addEffect(ModEffects.ACID_VENOM.get(), "Slow health loss; prevents health regeneration");
        addEffect(ModEffects.CURSED_INFERNO.get(), "Continuous health loss");
        addEffect(ModEffects.RAGE.get(), "Increases critical strike chance by 10%");
        addEffect(ModEffects.FISHING.get(), "Increases fishing power");
        addEffect(ModEffects.LUCK_EFFECT.get(), "You feel lucky");
        addEffect(ModEffects.MANA_REGENERATION.get(), "Increases mana regeneration speed");
        addEffect(ModEffects.WATER_WALKING.get(), "Can walk on liquids.");
        addEffect(ModEffects.MAGIC_POWER.get(), "Increases magic damage by 20%");
        addEffect(ModEffects.FLIPPER.get(), "Move normally in water");
        addEffect(ModEffects.SPELUNKER.get(), "Reveals the location of treasures and ores");
        addEffect(ModEffects.HUNTER.get(), "Reveals enemy locations");
        addEffect(ModEffects.DANGER_SENSE.get(), "You can see nearby dangers");
        addEffect(ModEffects.FROZEN.get(), "Decreases movement speed");
        addEffect(ModEffects.STINKY.get(), "You smell terrible");
        addEffect(ModEffects.THE_BAST_DEFENSE.get(), "Increases defense by 5");
        addEffect(ModEffects.SHARPENED.get(), "Melee weapons gain armor penetration");
        addEffect(ModEffects.AMMO_BOX.get(), "20% chance to save ammo");
        addEffect(ModEffects.ARCHERY.get(), "Increases bow damage by 10% and arrow speed by 20%");
        addEffect(ModEffects.HEART_REACH.get(), "Expands the pickup range of health hearts");
        addEffect(ModEffects.OBSIDIAN_SKIN.get(), "Immune to lava");
        addEffect(ModEffects.COZY_FIRE.get(), "Slightly increases health regeneration speed");
        addEffect(ModEffects.BEWITCHED.get(), "Increases maximum minion count");
        ...
        addEffect(ModEffects.MIDAS.get(), "Drops more money upon death");
        addEffect(ModEffects.TIPSY.get(), "Increases melee ability, decreases defense");
        addEffect(ModEffects.CLAIRVOYANCE.get(), "Increases magic ability");
        ...
        addEffect(ModEffects.WEAPON_IMBUE_FIRE.get(), "Melee attacks ignite enemies");
        addEffect(ModEffects.WEAPON_IMBUE_GOLD.get(), "Melee attacks make enemies drop more gold");
        addEffect(ModEffects.FROSTBITE.get(), "Continuous health loss");
        addEffect(ModEffects.SHADOWFLAME.get(), "Continuous health loss");

        addEffect(TCEffects.CEREBRAL_MINDTRICK.get(), "Increases critical strike chance");
        addEffect(TCEffects.HONEY.get(), "Increases health regeneration speed");
        addEffect(TCEffects.CONFUSED.get(), "Movement directions reversed");
        addEffect(TCEffects.GRAVITATION.get(), "Press Space to reverse gravity");
        addEffect(TCEffects.PALADINS_SHIELD.get(), "25% of damage taken is transferred to another player");
        ...
        addEffect(TEEffects.HELLFIRE.get(), "Continuous health loss");
        addEffect(TEEffects.FROST_BURN.get(), "Slow health loss; prevents health regeneration");
        addEffect(TEEffects.CRIMSON_STORM.get(), "You are trapped in the storm, no escape.");
        addEffect(TEEffects.HORRIFIED.get(), "You have seen filth, no escape.");
        addEffect(TEEffects.THE_TONGUE.get(), "You are being pulled into a mouth");
