...
//        add(ConsumableItems.FALLEN_SOUL_CORE.get(), "堕魂星核");
    ...
    private void addYoyoTranslations() {
        ...
        add("tooltip.confluence.yoyo.crystals", "连击蓄能，强化命中并散射五枚水晶碎片");
        add("tooltip.confluence.yoyo.critical", "额外 20% 暴击率，暴击造成 2.5 倍伤害");
        add("tooltip.confluence.yoyo.waves", "漩涡扩大攻击范围，连击蓄能后发射三道穿透波浪");
        add("tooltip.confluence.yoyo.afterimage", "连击蓄能，强化命中并发射无法暴击的穿透残影");
        add("tooltip.confluence.yoyo.terrarian", "持续向附近敌人发射能量弹");
        add("tooltip.confluence.yoyo.cascade", "命中有 1/3 概率点燃，连击蓄能后发射爆裂弹；脱手时不产生爆裂弹");
