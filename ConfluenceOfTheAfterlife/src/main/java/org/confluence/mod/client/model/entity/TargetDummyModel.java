...
public class TargetDummyModel extends GeoModel<TargetDummyEntity> {
    private static final ResourceLocation MODEL = TerraEntity.space("geo/entity/target_dummy.geo.json");
    private static final ResourceLocation TEXTURE = Confluence.asResource("textures/entity/target_dummy.png");
    private static final ResourceLocation ANIMATION = TerraEntity.space("animations/entity/target_dummy.animation.json");
