...
- When you pull the project, confirm whether the sub-project files are pulled. If the folder is empty, you can run the following sequence of terminal commands:
  ~~~cmd
    git submodule init
