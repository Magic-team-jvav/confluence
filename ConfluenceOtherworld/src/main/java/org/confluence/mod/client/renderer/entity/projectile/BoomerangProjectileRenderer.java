 ...
 */
public class BoomerangProjectileRenderer
        extends EntityRenderer<BoomerangProjectile> {
    ...
    public void render(
        ...
        poseStack.mulPose(Axis.XN.rotationDegrees(
                (float) (90.0F - 20.0F * Math.cos(animation / 10.0F))));
