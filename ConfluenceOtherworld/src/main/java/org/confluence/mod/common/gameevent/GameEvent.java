...
public interface GameEvent {
    ...
    PortStreamCodec<ByteBuf, ResourceKey<? extends GameEvent>> KEY_STREAM_CODEC = (PortStreamCodec<ByteBuf, ResourceKey<? extends GameEvent>>) (PortStreamCodec) PortResourceKeyExtension.streamCodec(REGISTRY_KEY);
