...
public class RainbowSheepFurModel extends QuadrupedModel<RainbowSheep> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Confluence.asResource("rainbow_sheep_fur"), "main");
    private float headXRot;

    public RainbowSheepFurModel(ModelPart root) {
