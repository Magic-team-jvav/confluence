...
public class ModDamageTypeTagsProvider extends DamageTypeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(TCTags.HARMFUL_EFFECT).addOptional(LibDamageTypes.ACID_VENOM.location())
                .addOptional(LibDamageTypes.CURSED_INFERNO.location()).addOptional(LibDamageTypes.FROST_BURN.location());
    }
}
