...
public class PotionItems {
    ...
    public static final DeferredItem<AbstractPotionItem> LESSER_HEALING_POTION = ITEMS.register("lesser_healing_potion", () -> new HealingPotionItem(10, ModRarity.WHITE, 1200));
    public static final DeferredItem<AbstractPotionItem> EGGNOG = ITEMS.register("eggnog", () -> new HealingPotionItem(16, ModRarity.WHITE, 900));
    public static final DeferredItem<AbstractPotionItem> RESTORATION_POTION = ITEMS.register("restoration_potion", () -> new HealingPotionItem(18, ModRarity.BLUE, 1200));
    public static final DeferredItem<AbstractPotionItem> HEALING_POTION = ITEMS.register("healing_potion", () -> new HealingPotionItem(20, ModRarity.BLUE, 1200));
    public static final DeferredItem<AbstractPotionItem> GREATER_HEALING_POTION = ITEMS.register("greater_healing_potion", () -> new HealingPotionItem(40, ModRarity.ORANGE, 1200));
    public static final DeferredItem<AbstractPotionItem> SUPER_HEALING_POTION = ITEMS.register("super_healing_potion", () -> new HealingPotionItem(60, ModRarity.LIME, 1200));
