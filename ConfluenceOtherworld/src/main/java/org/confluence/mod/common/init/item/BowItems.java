...
public class BowItems {
    ...
    public static final RegistryObject<ShortBowItem> LEAD_SHORT_BOW = ITEMS.register("lead_short_bow", () -> new ShortBowItem(5.0F, 1024));
    public static final RegistryObject<ShortBowItem> SILVER_SHORT_BOW = ITEMS.register("silver_short_bow", () -> new ShortBowItem(5.5F, 1152));
    public static final RegistryObject<ShortBowItem> TUNGSTEN_SHORT_BOW = ITEMS.register("tungsten_short_bow", () -> new ShortBowItem(5.5F, 1280));
    public static final RegistryObject<ShortBowItem> GOLDEN_SHORT_BOW = ITEMS.register("golden_short_bow", () -> new ShortBowItem(6.0F, 1408));
    public static final RegistryObject<ShortBowItem> PLATINUM_SHORT_BOW = ITEMS.register("platinum_short_bow", () -> new ShortBowItem(6.0F, 1536));


    // 无效果蓄力弓
    public static final RegistryObject<BaseTerraBowItem> EBONWOOD_BOW = register("ebonwood_bow", 3.0F, 404);
    public static final RegistryObject<BaseTerraBowItem> SHADEWOOD_BOW = register("shadewood_bow", 3.1F, 424);
    public static final RegistryObject<BaseTerraBowItem> ASH_WOOD_BOW = register("ash_wood_bow", 3.2F, 444);
    public static final RegistryObject<BaseTerraBowItem> PEARLWOOD_BOW = register("pearlwood_bow", 3.5F, 1000);
    public static final RegistryObject<BaseTerraBowItem> COPPER_BOW = register("copper_bow", 3.0F, 640);
    public static final RegistryObject<BaseTerraBowItem> TIN_BOW = register("tin_bow", 3.0F, 768);
    public static final RegistryObject<BaseTerraBowItem> IRON_BOW = register("iron_bow", 3.5F, 896);
    public static final RegistryObject<BaseTerraBowItem> LEAD_BOW = register("lead_bow", 3.5F, 1024);
    public static final RegistryObject<BaseTerraBowItem> SILVER_BOW = register("silver_bow", 4.0F, 1152);
    public static final RegistryObject<BaseTerraBowItem> TUNGSTEN_BOW = register("tungsten_bow", 4.0F, 1280);
    public static final RegistryObject<BaseTerraBowItem> GOLDEN_BOW = register("golden_bow", 4.5F, 1408);
    ...
    public static final RegistryObject<BaseTerraBowItem> HUNTING_BOW = register("hunting_bow", 3.5F, m -> m
            .setRarity(ModRarity.BLUE)
            .setOnHitEffect(TEEffectStrategies.Components.HUNTING_RIFLE_EFFECT.get())
    );
    public static final RegistryObject<BaseTerraBowItem> DEMON_BOW = register("demon_bow", 4.9F, m -> m
            .setRarity(ModRarity.BLUE)
            .setFullPullHitEffect(ModEffectStrategies.Components.LIGHTS_BANE_EFFECT.get())
    );
    public static final RegistryObject<BaseTerraBowItem> TENDON_BOW = register("tendon_bow", 5.2F, m -> m
            .setRarity(ModRarity.BLUE)
            .setFullPullHitEffect(ModEffectStrategies.Components.BLOOD_BUTCHERED_EFFECT.get())
    );
    public static final RegistryObject<BaseTerraBowItem> MOLTEN_FURY = register("molten_fury", 5.8F, m -> m
            .setRarity(ModRarity.ORANGE)
            .setArrowTransform(ArrowItems.HELLFIRE_ARROW.get())
    );
    public static final RegistryObject<BaseTerraBowItem> THE_BEES_KNEES = register("the_bees_knees", 6.7F, m -> m
    ...
    public static final RegistryObject<BaseTerraBowItem> HELLWING_BOW = register("hellwing_bow", 7.5f, m -> m
    ...
    public static final RegistryObject<BaseTerraBowItem> SCAREBOW = register("scarebow", 3.5F, m -> m
            .setRarity(ModRarity.BLUE)
            .setEntityTransform(BaseTerraArrowItem.EntityTransform.create(ModEntities.DRIVE_AWAY_ARROW.get(), DriveAwayArrow::create))
    );

    // 代达罗斯风暴弓
    public static final RegistryObject<BaseTerraBowItem> DAEDALUS_STORM_BOW = register("daedalus_storm_bow", () -> new DaedalusStormbow(12f, ModRarity.PURPLE));
    ...
    public static RegistryObject<BaseTerraBowItem> register(String name, Supplier<BaseTerraBowItem> supplier) {
     ...
     * 注册效果修饰的有耐久弓
     */
    public static RegistryObject<BaseTerraBowItem> register(String name, float damage, int durability) {
     ...
     * 注册带有效果修饰的无耐久弓
     */
    public static RegistryObject<BaseTerraBowItem> register(String name, float damage, Function<BaseTerraArrowItem.ModifyArrowBuilder, BaseTerraArrowItem.ModifyArrowBuilder> modifier) {
