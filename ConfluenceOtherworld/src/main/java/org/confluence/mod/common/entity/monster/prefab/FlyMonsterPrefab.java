...
import static org.confluence.mod.common.entity.monster.prefab.AttributeBuilder.copyFrom;
...
public class FlyMonsterPrefab extends AbstractPrefab {
    ...
    public static final Supplier<AttributeBuilder> DRIPPLER_BUILDER  =
            ()->new FlyMonsterPrefab().getPrefab()
                    .setSpawnWithoutLight()
                    .setHurtSound(ModSoundEvents.DRIPPLER_HURT)
                    .setDeathSound(ModSoundEvents.DRIPPLER_DEATH)
                    .addGoal((g,e)->{
    ...
    public static Supplier<AttributeBuilder> CAVE_BAT_BUILDER  =
            ...
            ()->new FlyMonsterPrefab().getPrefab()
                    .setHurtSound(ModSoundEvents.ROUTINE_HURT)
                    .setDeathSound(ModSoundEvents.BAT_DEATH)
                    .addGoal((g,e)->{
