...
public class DecorativeBlocks {
    ...
    public static final Supplier<CrackedBrickBlock> CRACKED_BLUE_BRICK = registerWithItem("cracked_blue_brick", () -> new CrackedBrickBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS).strength(0).mapColor(DyeColor.BLUE)));
    public static final Supplier<CrackedBrickBlock> CRACKED_GREEN_BRICK = registerWithItem("cracked_green_brick", () -> new CrackedBrickBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS).strength(0).mapColor(DyeColor.GREEN)));
    public static final Supplier<CrackedBrickBlock> CRACKED_PINK_BRICK = registerWithItem("cracked_pink_brick", () -> new CrackedBrickBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS).strength(0).mapColor(DyeColor.PINK)));
